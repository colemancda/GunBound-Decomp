...
LAB_004d67e1:
    ...
    if (param_2 == 0x201) {
      ...
      TextEntry_SetSelection(0,(int)pcVar8 - (int)(acStack_80 + 1),
                   (int)pcVar8 - (int)(acStack_80 + 1),(int)g_sharedTextInputControl);
LAB_004d6626:
      if ((char)param_1[0x133] != '\0') {
        return;
      }
      iVar5 = FindItemGridCell(param_4 & 0xffff,param_4 >> 0x10);
      if (iVar5 == -1) {
        return;
      }
      ...
      uVar3 = g_awItemIconTable[param_1[iVar5 + 0x146]];
    ...
    if (((param_2 == 0x204) &&
       ...
       (((char)param_1[0x186] != '\0' &&
        (((cVar4 = IsWidgetEnabled(0,0,(int)&g_activeObjectRegistry,1), cVar4 != '\0' && (iVar5 = FindItemGridCell(param_4 & 0xffff,param_4 >> 0x10), iVar5 != -1)) &&
