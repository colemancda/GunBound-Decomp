  ...
  if (param_2 == 0x100) {
    if ((param_3 == 0xd) && (DAT_007933b8 == '\x01')) {
      ...
      if (cVar4 == '\0') {
        FUN_0040c880();
        if ((acStack_80[0] != '\0') &&
           (cVar4 = FUN_004218c0(DAT_005b3484,acStack_80), cVar4 == '\0')) {
...
LAB_004d67e1:
    ...
    if (param_2 == 0x201) {
      ...
      if (((0x16c < param_4) && (param_4 < 0x18b)) && ((char)param_1[0x133] == '\0')) {
        ...
        do {
          if ((iVar5 <= (int)uVar10) && ((int)uVar10 <= iVar5 + 0x23)) {
            iVar6 = FUN_004dc0f0();
            if (iVar6 == -1) break;
            cVar4 = PacketChecksumEquals(iVar6 * 0x224 + 0x39f30 + DAT_005b3484,0xff);
            if (cVar4 != '\0') {
      ...
      while ((((iVar6 = (int)*(char *)(iVar5 + 0x4a0 + (int)param_1),
               *(char *)(DAT_005b3484 + 0x45914 + iVar5) == '\0' ||
      ...
      FUN_0040c880();
      pcVar8 = (char *)(iVar5 * 0xd + 0x457f1 + DAT_005b3484);
      pcVar7 = pcVar8;
      do {
        cVar4 = *pcVar7;
        pcVar7 = pcVar7 + 1;
...
LAB_004d6626:
    ...
    if (((param_2 == 0x204) &&
        (cVar4 = FUN_0040b3d0(DAT_005b3484 + 0x3b49c,DAT_005b3484 + 0x3b6c4), cVar4 == '\0')) &&
      ...
      FUN_004da460(param_1,0,0);
      iVar5 = DAT_005b3484;
      *(undefined4 *)((int)param_1 + 0x25d) = *(undefined4 *)(DAT_005b3484 + 0x457a1);
