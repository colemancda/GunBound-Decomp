...

{
  ...
  if (param_2 != 0) {
    if (param_2 == 10) {
      pcVar4 = (char *)GetWidgetChildText(0,0x186a0,(int)&g_activeObjectRegistry2,0);
  ...
  if (0x48 < param_4) {
    ...
    if (param_4 < 0x72) {
      ...
      if (((int)*(char *)(g_clientContext + 0x458fc + iVar10 * 2) == param_4 - 100) ||
        ...
        uVar3 = SetWidgetReadyState(0,0,1,(int)&g_activeObjectRegistry,param_4);
        return uVar3;
      }
  ...
  case 1:
    ...
    *(int *)(iVar10 + 0x44d0) = *(int *)(iVar10 + 0x44d0) + 4;
    ...
    if (cVar2 != '\0') {
      ...
      uVar3 = SendOutgoingPacket(iVar8);
      return uVar3;
    }
    uVar3 = SendOutgoingPacket(iVar10);
    return uVar3;
