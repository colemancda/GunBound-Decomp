    ...
    if (0x112 < param_2) {
      ...
      if (*(char *)((int)param_1 + 0x92) != '\0') {
        ...
        *psVar1 = *(short *)(&g_nCameraX + g_clientContext) + (short)param_4 + -400;
        ...
        if (iVar13 == 1) {
          iVar13 = _rand();
          (&g_abBroadcastEventBuffer)[g_dwBroadcastEventCursor] = (char)(iVar13 % 6) + '\x02';
        }
        else {
          uVar5 = PeekChecksumStateUnderLock(&DAT_006a64c4 + g_clientContext);
      ...
      if (*(char *)((int)param_1 + 0x93) != '\0') {
        ...
        if (cVar4 == '\0') {
          ...
          *(short *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) = sVar6 + 4;
          ...
          sVar6 = PeekChecksumStateUnderLock(g_clientContext + 0xeba98);
          *(short *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) = sVar6 + 2;
        }
        iVar13 = g_dwBroadcastEventCursor;
        g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 2;
        ...
        *(short *)(&DAT_00e9aace + iVar13) =
        ...
        if (uVar14 < 10) {
          *(undefined4 *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) = 10;
          ...
          iVar13 = CommitTurnDelay(0,*(int *)(g_clientContext + 0x621e0));
      ...
      if (iVar10 != -1) {
        ...
        iVar15 = PeekChecksumStateUnderLock(iVar10 * 0x448 + 0x477ec + g_clientContext);
...
LAB_004b9bb0:
    ...
    if (param_2 != 0x100) {
      ...
      CreateButtonWidget(&g_activeObjectRegistry,0,uVar20,uVar21,pcVar22,uVar23,0x232,0x23,0x22,1,0);
    ...
    if (((char)param_1[0x474] != '\0') && (cVar4 = IsWidgetEnabled(0,0,(int)&g_activeObjectRegistry,0x10), cVar4 == '\x01')) {
...
LAB_004b9e53:
  ...
  *(undefined1 *)(param_1 + 0x468) = 0;
  ...
  iVar10 = PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x7864);
  if (iVar10 < iVar13 * 10) {
    iVar13 = PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x7864);
  }
  else {
    iVar13 = PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x7640);
    iVar13 = iVar13 * 10;
  }
...
LAB_004bafd2:
  ...
  *(undefined2 *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) = uVar7;
  ...
  (&g_abBroadcastEventBuffer)[g_dwBroadcastEventCursor] = uVar5;
  g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 1;
  uVar7 = PeekChecksumStateUnderLock(*(int *)(iVar13 + 0x621e0) + 0x4d90);
  iVar13 = g_clientContext;
  *(undefined2 *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) = uVar7;
  g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 2;
  ...
  *(undefined2 *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) = uVar7;
  ...
  if (cVar4 == '\0') {
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x9cf0);
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x51d8);
  }
  else {
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x51d8);
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x9cf0);
  }
  PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x9f14);
  FUN_004ead90();
  uVar7 = FloatToInt64();
  PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x9f14);
  FUN_004ead70();
  ...
  iVar13 = g_clientContext;
  *(undefined2 *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) = uVar7;
  puVar2 = (undefined2 *)(&DAT_00e9aace + g_dwBroadcastEventCursor);
  g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 2;
  *puVar2 = uVar8;
  g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 2;
  cVar4 = PacketChecksumEquals(*(int *)(iVar13 + 0x621e0) + 0x1c54,0);
  if (cVar4 == '\0') {
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0xa138);
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x51d8);
  }
  else {
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x51d8);
  ...
  PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0xa35c);
  FUN_004ead90();
  uVar7 = FloatToInt64();
  PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0xa35c);
  FUN_004ead70();
  ...
  *puVar2 = uVar8;
  ...
  cVar4 = PacketChecksumEquals(*(int *)(iVar13 + 0x621e0) + 0x1c54,0);
  if (cVar4 == '\0') {
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0xa9c8);
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x51d8);
  }
  else {
    PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0x51d8);
  ...
  PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0xabec);
  FUN_004ead90();
  uVar7 = FloatToInt64();
  PeekChecksumStateUnderLock(*(int *)(g_clientContext + 0x621e0) + 0xabec);
  FUN_004ead70();
  ...
  *puVar2 = uVar8;
  g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 2;
  uVar7 = PeekChecksumStateUnderLock(iVar13 + 0x5af88);
  iVar13 = g_clientContext;
  *(undefined2 *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) = uVar7;
  g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 2;
  uVar7 = PeekChecksumStateUnderLock(iVar13 + 0x5b1ac);
  *(undefined2 *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) = uVar7;
  puVar3 = &DAT_00e9aace + g_dwBroadcastEventCursor;
  g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 2;
  *puVar3 = 0;
  g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 1;
