  ...
  *(int *)(param_1 + 4) = iVar4 + 1;
  ...
  case 0xc:
    ...
    *(undefined1 *)((int)puVar6 + 5) = DAT_005554fc;
    ...
    DAT_00793634 = FUN_0040a4d0((uint)*(byte *)(DAT_005b3484 + 0x475c4) * 0x7d28 + 0x1a328c +
                                DAT_005b3484);
    break;
  case 0xd:
  ...
  case 0xe:
    ...
    if (*(ushort *)(&DAT_006aa660 + DAT_005b3484) != 0xffff) {
      _sprintf(acStack_80,s_event14__d_img_005554e8,*(ushort *)(&DAT_006aa660 + DAT_005b3484) + 1);
      FUN_004f1790(&DAT_00ea0e18,0x2712);
    }
    break;
  case 0xf:
    cVar2 = FUN_0041c2c0(DAT_005b3484,0);
    if (cVar2 != '\0') {
  ...
  case 0x10:
    cVar2 = FUN_0041c2c0(DAT_005b3484,0);
    if ((cVar2 != '\0') && (*(char *)(DAT_005b3484 + 0x45578) == '\0')) {
  ...
  case 0x11:
    ...
    break;
  case 0x12:
    cVar2 = FUN_0041c2c0(DAT_005b3484,1);
    if (cVar2 != '\0') {
  ...
  case 0x14:
    ...
    break;
  case 0x15:
    cVar2 = FUN_0041c2c0(DAT_005b3484,2);
    if (cVar2 != '\0') {
  ...
  case 0x17:
    ...
    break;
  case 0x18:
    cVar2 = FUN_0041c2c0(DAT_005b3484,3);
    if (cVar2 != '\0') {
  ...
  case 0x1a:
    ...
    break;
  case 0x1b:
    cVar2 = FUN_0041c2c0(DAT_005b3484,4);
    if (cVar2 != '\0') {
  ...
  case 0x1d:
    ...
    break;
  case 0x1e:
    cVar2 = FUN_0041c2c0(DAT_005b3484,5);
    if (cVar2 != '\0') {
  ...
  case 0x20:
    ...
    break;
  case 0x21:
    cVar2 = FUN_0041c2c0(DAT_005b3484,6);
    if (cVar2 != '\0') {
  ...
  case 0x23:
    ...
    break;
  case 0x24:
    cVar2 = FUN_0041c2c0(DAT_005b3484,7);
    if (cVar2 != '\0') {
  ...
  case 0x26:
    ...
    break;
  case 0x27:
    cVar2 = FUN_0041c2c0(DAT_005b3484,8);
    if (cVar2 != '\0') {
  ...
  case 0x29:
    ...
    break;
  case 0x2a:
    cVar2 = FUN_0041c2c0(DAT_005b3484,9);
    if (cVar2 != '\0') {
  ...
  case 0x2c:
    ...
    break;
  case 0x2d:
    cVar2 = FUN_0041c2c0(DAT_005b3484,10);
    if (cVar2 != '\0') {
  ...
  case 0x2f:
    ...
    break;
  case 0x30:
    cVar2 = FUN_0041c2c0(DAT_005b3484,0xb);
    if (cVar2 != '\0') {
  ...
  case 0x32:
    ...
    break;
  case 0x33:
    cVar2 = FUN_0041c2c0(DAT_005b3484,0xc);
    if (cVar2 != '\0') {
  ...
  case 0x3b:
    ...
    break;
  case 0x3c:
    cVar2 = FUN_0041c2c0(DAT_005b3484,0xf);
    if (cVar2 != '\0') {
  ...
  if (*(int *)(param_1 + 0x108) == -1) {
    iVar4 = 0;
    do {
      if ((*(char *)(DAT_005b3484 + 0x45914 + iVar4) != '\0') &&
         (*(char *)(DAT_005b3484 + 0x449ba + iVar4) == '\0')) goto LAB_00442056;
      iVar4 = iVar4 + 1;
    } while (iVar4 < 8);
