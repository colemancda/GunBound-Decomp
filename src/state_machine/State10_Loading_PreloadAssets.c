  ...
  *(int *)(param_1 + 4) = iVar4 + 1;
  ...
  case 0xc:
    LoadStageDecorationSet(&DAT_006a7708 + g_clientContext,&DAT_00551cb1,
                           (char *)((uint)*(byte *)(g_clientContext + 0x475c4) * 0x7d28 +
                                    0x1a1ec8 + g_clientContext));
