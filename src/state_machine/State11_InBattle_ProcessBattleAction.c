...

{
  ...
  *unaff_FS_OFFSET = &local_14;
  ...
  if (uVar1 < 0x8501) {
    ...
    if (uVar1 < 0x8007) {
      if (uVar1 == 0x8006) {
        piVar7 = (int *)GetPlayerRecordBySlot(DAT_005b3484);
        if (piVar7 != (int *)0x0) {
          ...
          cVar3 = FUN_0041eaa0(DAT_005b3484,(short)piVar7[0x2fef]);
          if (cVar3 != '\0') {
        ...
        if (uVar1 == 0x4004) {
          if ((*(char *)(bVar16 + 0x5010d + DAT_005b3484) != '\0') &&
             (iVar4 = FUN_004259d0((uint)bVar16 * 0xd + 0x50196 + DAT_005b3484), iVar4 == -1)) {
          ...
          if (uVar1 == 0x4002) {
            ...
            if (*(char *)((int)local_27e0 + 0x5010dU + DAT_005b3484) != '\0') {
              local_27f0 = (undefined *)((int)local_27e0 * 0xd);
              iVar4 = FUN_004259d0(local_27f0 + DAT_005b3484 + 0x50196);
              if (iVar4 == -1) {
                local_2658 = 0;
                pbVar14 = local_2657;
                ...
                FUN_004ee9b0(uVar21);
                FUN_0041ef90(DAT_005b3484,0,local_27e4,puVar12,uVar11,local_27ec[3] + 300,0);
                FUN_0041b8c0(DAT_005b3484,0,(int)local_27e0 * 9 + 0x5012e + DAT_005b3484,
                             local_27f0 + DAT_005b3484 + 0x50196,puVar12,0,1);
            ...
            if (uVar1 == 3) {
              iVar4 = (uint)*(byte *)puVar12 * 0xd + 0x457f1 + DAT_005b3484;
              iVar10 = (uint)bVar16 * 0xd + 0x457f1 + DAT_005b3484;
              iVar6 = iVar4;
            ...
            if (((uVar1 == 0x4001) &&
                (uVar11 = FUN_0040a4d0(DAT_005b3484 + 0x3b49c), bVar16 != uVar11)) &&
               (iVar4 = GetPlayerRecordBySlot(DAT_005b3484), iVar4 != 0)) {
              ...
              *unaff_FS_OFFSET = local_14;
              return;
                ...
                (uVar9 = (uint)bVar16, *(char *)(uVar9 + 0x5010d + DAT_005b3484) != '\0')) {
          local_27f0 = (undefined *)(uVar9 * 0xd);
          local_27e0 = (int *)uVar9;
          iVar4 = FUN_004259d0(local_27f0 + DAT_005b3484 + 0x50196);
          if ((iVar4 == -1) &&
             (*(char *)(uVar9 + 0x50126 + DAT_005b3484) == *(char *)(DAT_005b3484 + 0x3b6c0))) {
            local_2658 = 0;
            pbVar14 = local_2657;
            for (iVar4 = 0xff; iVar4 != 0; iVar4 = iVar4 + -1) {
              pbVar14[0] = 0;
            ...
            FUN_004e3740(&DAT_00794e14);
            FUN_004ee9b0(uVar21);
            FUN_0041ef90(DAT_005b3484,7,local_27e4,puVar12,uVar11,local_27ec[3] + 300,0);
            FUN_0041b8c0(DAT_005b3484,7,(int)local_27e0 * 9 + 0x5012e + DAT_005b3484,
                         local_27f0 + DAT_005b3484 + 0x50196,puVar12,0,1);
            uVar11 = ((int)uVar11 < 0) - 1 & uVar11;
            pbVar14 = local_27d8;
            for (uVar9 = uVar11 >> 2; uVar9 != 0; uVar9 = uVar9 - 1) {
        ...
        uVar11 = FUN_0040a4d0(DAT_005b3484 + 0x3b49c);
        if (bVar16 != uVar11) {
          iVar4 = GetPlayerRecordBySlot(DAT_005b3484);
          bVar16 = *(byte *)puVar12;
        ...
        uVar11 = FUN_0040a4d0(DAT_005b3484 + 0x3b49c);
        if (bVar16 != uVar11) {
          GetPlayerRecordBySlot(DAT_005b3484);
    ...
    if (0x8405 < uVar1) {
      if (uVar1 == 0x8406) {
        iVar4 = GetPlayerRecordBySlot(DAT_005b3484);
        if ((iVar4 != 0) && (uVar11 = FUN_0040a4d0(DAT_005b3484 + 0x3b49c), bVar16 != uVar11)) {
          uVar21 = QueueOutgoingPacketField(*puVar12);
          EncodeChecksumState(uVar21);
          uVar21 = QueueOutgoingPacketField(*(undefined2 *)(param_2 + 0x23));
          EncodeChecksumState(uVar21);
        ...
        bVar16 = *(byte *)puVar12;
        if (bVar16 == 1) {
          uVar21 = FUN_0040a4d0(&DAT_00e9ba40);
          AddToPacketChecksum(uVar21);
          *unaff_FS_OFFSET = local_14;
          return;
        }
        if (bVar16 == 2) {
          uVar21 = FUN_0040a4d0(&DAT_00e9b818);
          AddToPacketChecksum(uVar21);
          *unaff_FS_OFFSET = local_14;
          return;
        }
        if (bVar16 == 3) {
          uVar21 = FUN_0040a4d0(&DAT_00796aa0);
          AddToPacketChecksum(uVar21);
          *unaff_FS_OFFSET = local_14;
          return;
        }
    ...
    if (uVar1 == 0x8405) {
      FUN_0043c440();
      local_27f0 = &DAT_006a7f70 + DAT_005b3484;
      FUN_0043c4a0();
      FUN_0043c4f0();
      FUN_00406500(0);
      FUN_004207c0(DAT_005b3484,bVar16);
      cVar2 = FUN_004065a0();
      if (cVar2 == '\0') {
        uVar11 = FUN_0040b2d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xc080,4);
        if (((char)uVar11 == '\0') ||
           (uVar11 = *(uint *)(DAT_005b3484 + 0x621e0), *(short *)(uVar11 + 0xbfbc) != 0)) {
        ...
        CreateButtonWidget(&DAT_00e9be90,0,0x12,0x3fa,s_b_play_weapon3_00554144,0x58,0x232,0x23,0x22
                           ,uVar11,0);
        cVar2 = FUN_0040b2d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xc080,4);
        if ((cVar2 == '\0') || (*(short *)(*(int *)(DAT_005b3484 + 0x621e0) + 0xbfbc) != 0)) {
          uVar21 = 0;
        }
        else {
          uVar21 = 1;
    ...
    if (uVar1 != 0x8403) {
      ...
      if (((uVar1 == 0x8402) && (uVar11 = FUN_0040a4d0(DAT_005b3484 + 0x3b49c), bVar16 != uVar11))
         && (iVar4 = GetPlayerRecordBySlot(DAT_005b3484), iVar4 != 0)) {
        uVar21 = QueueOutgoingPacketField(*puVar12);
        EncodeChecksumState(uVar21);
        uVar21 = QueueOutgoingPacketField(*(undefined2 *)(param_2 + 0x23));
    ...
    EncodeChecksumState(uVar21);
    QueueOutgoingPacketField(*(char *)(param_2 + 0x25) == '\x01');
    FUN_00406500(*(char *)(param_2 + 0x26) == '\x01');
    ...
    *(undefined1 *)(piVar7 + 0x1947) = *(undefined1 *)(param_2 + 0x2b);
    ...
    FUN_00406500(*(char *)(param_2 + 0x3c) == '\x01');
...
LAB_004b5f6e:
    ...
    iVar6 = FUN_0040a4d0(DAT_005b3484 + 0x3b49c);
    iVar10 = DAT_005b3484;
    if (iVar4 == iVar6) {
LAB_004b7c01:
    ...
    if (*(char *)(iVar4 + 0x4590c + DAT_005b3484) != *(char *)(DAT_005b3484 + 0x3b6c0)) {
    ...
    if (uVar1 < 0xc401) {
      if (uVar1 != 0xc400) {
        ...
        case 0xc301:
          ...
          iVar4 = FUN_0040a4d0((uint)bVar16 * 0x224 + 0xebef4 + DAT_005b3484);
          ...
          FUN_00406500(1);
          *(undefined1 *)(*(int *)(DAT_005b3484 + 0x621e0) + 0xae68) = 1;
          *unaff_FS_OFFSET = local_14;
          return;
        case 0xc303:
          *(undefined4 *)(&DAT_006a7704 + DAT_005b3484) = 0xffffffff;
          FUN_00406500(0);
          iVar4 = DAT_005b3484;
          switch(*(byte *)puVar12) {
          case 0:
          ...
          case 0xe:
            ...
            *unaff_FS_OFFSET = local_14;
            return;
          case 0xf:
            cVar2 = PacketChecksumEquals(DAT_005b3484 + 0x621e8,0xffffffff);
            if (cVar2 != '\0') {
              FUN_0043a5f0();
        ...
        case 0xc304:
          ...
          local_27e0 = (int *)(uint)bVar16;
          local_27f0 = (undefined *)GetPlayerRecordBySlot(DAT_005b3484);
          if (local_27f0 == (undefined *)0x0) break;
          uVar11 = (uint)*(byte *)(param_2 + 0x25);
          iVar4 = GetPlayerRecordBySlot(DAT_005b3484);
          piVar7 = local_27ec;
          if ((((iVar4 != 0) && (*(char *)(DAT_005b3484 + 0x45120) != '\0')) &&
              ((char)local_27ec[0x474] == '\0')) &&
             (cVar2 = PacketChecksumNotEquals(DAT_005b3484 + 0x45354,3), bVar16 = local_27e5,
             cVar2 != '\0')) {
            FUN_0040a280();
            piVar7 = local_27e0;
            bVar16 = bVar16 & 0xf;
            ...
            if ((local_27e5 & 0x10) == 0) {
              if (bVar16 == 1) {
                ...
                iVar10 = FUN_0040a4d0(uVar11 * 0x1120 + 0x5113c + DAT_005b3484);
                ...
                uVar22 = 1;
                uVar21 = FUN_0040a4d0(iVar4 + 0xb30);
                uVar20 = FUN_0040a4d0(iVar4 + 0x90c);
              ...
              if (bVar16 == 1) {
                ...
                if (bVar16 == 3) {
                  ...
                  EncodeChecksumStateXored();
                  iVar4 = FUN_0040a4d0((int)piVar7 * 0x1120 + 0x5113c + DAT_005b3484);
                  ...
                  puVar8 = local_27f0;
                  uVar22 = 0xffffffff;
                  uVar21 = FUN_0040a4d0(local_27f0 + 0xb30);
                  uVar20 = FUN_0040a4d0(puVar8 + 0x90c);
                  FUN_004368f0(uVar20,uVar21,uVar22);
                  uVar21 = FUN_0040a4d0(&local_2658);
          ...
          FUN_004cf050(piVar7);
          cVar2 = PacketChecksumEquals(DAT_005b3484 + 0x45354,1);
          if (cVar2 != '\0') {
            cVar2 = *(char *)((int)local_27e0 + DAT_005b3484 + 0x50126);
            if (cVar2 == '\0') {
              iVar4 = *piVar7;
              uVar22 = 8;
              uVar20 = 3;
              ...
              FUN_0040b060();
              cVar2 = FUN_0040b330(&DAT_0067e3d0 + DAT_005b3484,0);
            }
            else {
              ...
              (**(code **)(iVar4 + 0x28))(uVar21,uVar20,uVar22);
              FUN_0040b060();
              cVar2 = FUN_0040b330(&DAT_0067e5f4 + DAT_005b3484,0);
            }
            if (cVar2 != '\0') {
...
LAB_004b7674:
          ...
          if (cVar2 != '\x01') break;
LAB_004b7fb2:
          cVar2 = FUN_0040b390(DAT_005b3484 + 0x3b49c,DAT_005b3484 + 0x3b6c4);
        ...
        case 0xc305:
          *(undefined1 *)(param_1 + 0x42f) = 0;
          FUN_00406500(1);
          cVar2 = *(char *)(DAT_005b3484 + 0x45127);
          if (cVar2 == '\x01') {
            *(undefined4 *)(&DAT_006a647c + DAT_005b3484) = 0x11;
          }
          else if (cVar2 == '\x02') {
            *(undefined4 *)(&DAT_006a647c + DAT_005b3484) = 0x10;
          }
          else if (cVar2 == '\x03') {
            *(undefined4 *)(&DAT_006a647c + DAT_005b3484) = 0xb5;
          }
          FUN_004eea30(1);
          FUN_00438360();
          iVar4 = *local_27ec;
    ...
    if (uVar1 == 0xc801) {
      bVar16 = *(byte *)puVar12;
      uVar11 = FUN_0040a4d0(DAT_005b3484 + 0x3b49c);
      if (((uVar11 == bVar16) && (*(int *)(DAT_005b3484 + 0x621e0) != 0)) &&
    ...
    case 0xc409:
      ...
      *(undefined1 *)(piVar7 + 0x1947) = *(undefined1 *)(param_2 + 0x2b);
      ...
      QueueOutgoingPacketField((int)*(short *)(param_2 + 0x36));
      iVar4 = DAT_005b3484;
      *(undefined4 *)(&DAT_005f3768 + DAT_005b3484) = 1;
    ...
    case 0xc40a:
      ...
      *unaff_FS_OFFSET = local_14;
      return;
    case 0xc40b:
      cVar2 = PacketChecksumNotEquals(DAT_005b3484 + 0x45354,3);
      if (cVar2 != '\0') {
        ...
        do {
          ...
          if (cVar2 != '\0') {
            ...
            local_c = 0xf;
            EncodeChecksumStateXored();
            iVar10 = FUN_0040a4d0(local_27e4 + 0x5113c + DAT_005b3484);
            iVar6 = FUN_0040a4d0(&DAT_00796aa0);
            ...
            FUN_00438360();
            puVar8 = (undefined *)FUN_0040a4d0(DAT_005b3484 + 0x3b49c);
            if (local_27f0 == puVar8) {
              iVar10 = *(int *)(DAT_005b3484 + 0x44e60) + 1;
