  ...
  *unaff_FS_OFFSET = &local_14;
  ...
  if (uVar1 < 0x8501) {
    if (uVar1 == GB_ACT_POSITION_RELAY) {
      ...
      if ((iVar4 != 0) && (cVar2 = PeekPacketChecksumBool((byte *)(iVar4 + 0x8ba8)), cVar2 == '\0')) {
    ...
    if (uVar1 < 0x8007) {
      if (uVar1 == GB_ACT_FIRE_FEEDBACK_SOUND) {
        ...
        if (piVar7 != (int *)0x0) {
          ...
          cVar3 = PeekPacketChecksumBool((byte *)piVar7 + 0x8bba);
          if (cVar3 == '\0') {
        ...
        if (uVar1 == 0x4004) {
          if ((*(char *)(bVar16 + 0x5010d + g_clientContext) != '\0') &&
            ...
            SpawnSpeechBalloon(*(byte *)(param_2 + 0x21) + 8,g_clientContext + 0x6a7f70,
                         (char *)local_27d8);
            *unaff_FS_OFFSET = local_14;
            return;
          }
          ...
          if (uVar1 == 0x4002) {
            ...
            if (*(char *)((int)local_27e0 + 0x5010dU + g_clientContext) != '\0') {
              ...
              if (iVar4 == -1) {
                ...
                FUN_004e3740((int *)&DAT_00794e14,&local_2658);
                ...
                SpawnSpeechBalloon((int)local_27e0,g_clientContext + 0x6a7f70,(char *)local_27d8);
                iVar4 = GetPlayerRecordBySlot(g_clientContext);
        ...
        if (bVar16 != uVar11) {
          ...
          *unaff_FS_OFFSET = local_14;
          return;
                 ...
                 (uVar11 = PeekChecksumStateUnderLock(g_clientContext + 0x3b49c), bVar16 != uVar11)) &&
                ((iVar4 = GetPlayerRecordBySlot(g_clientContext), iVar4 != 0 &&
                 ((cVar2 = PeekPacketChecksumBool((byte *)(iVar4 + 0x8ba8)), cVar2 != '\0' && (cVar2 = PeekPacketChecksumBool((byte *)(iVar4 + 0x8bb1)), cVar2 != '\0'))
    ...
    if (0x8405 < uVar1) {
      if (uVar1 == GB_ACT_AIM_RELAY_ALT) {
        ...
        if (bVar16 == 1) {
          ...
          AddToPacketChecksum((void *)(g_clientContext + (uint)bVar16 * 0x224 + 0x5ba80), uVar21);
          *unaff_FS_OFFSET = local_14;
          return;
        }
        if (bVar16 == 2) {
    ...
    if (uVar1 == GB_ACT_WEAPON_SELECT_SOUND) {
      ...
      cVar2 = PeekPacketChecksumBool((byte *)(*(int *)(g_clientContext + 0x621e0) + 0x8bba));
      if (cVar2 == '\0') {
      ...
      if (uVar1 != GB_ACT_SCHED_CHECKPOINT) {
        ...
        case GB_ACT_TURN_START:
          ...
          if ((char)param_1[0x474] == '\0') {
            BeginNewTurn(param_1,(undefined2 *)(param_2 + 0x22),*(byte *)(param_2 + 0x21));
          }
        ...
        case GB_ACT_TURN_SETUP:
          ...
          if (piVar7 != (int *)0x0) {
            if ((piVar7[9] != 0xe) && (cVar2 = PeekPacketChecksumBool((byte *)piVar7 + 0x8bbd), cVar2 == '\x01')) {
            ...
            if (piVar7[0x2c29] != -1) {
              StopSoundChannel(piVar7[0x2c29]);
              piVar7[0x2c29] = -1;
            }
            SetGuardedBool(0,GB_GUARD_UNRECOVERED);
            SetGuardedBool(0,GB_GUARD_UNRECOVERED);
          ...
          if (((iVar4 != -1) && (iVar4 = local_27ec[0x429], iVar4 != 60000)) && (iVar4 != 0xffff)) {
            AddToPacketChecksum((void *)(g_clientContext + (uint)bVar16 * 0x224 + 0xebef4), iVar4);
          }
        ...
        case GB_ACT_TURN_PHASE:
          *(undefined4 *)(&DAT_006a7704 + g_clientContext) = 0xffffffff;
          ...
          case 0xe:
            ...
            piVar7 = local_27ec;
            AddToPacketChecksum((void *)(g_clientContext + (uint)bVar16 * 0x224 + 0xebef4), local_27ec[0x429]);
            ...
            if (cVar2 != '\0') {
              ...
              TurnEventSet_Find((int)&DAT_00e9af10,(undefined4 *)&local_27e4,(ushort *)&local_27f0);
          ...
          if ((((iVar4 != 0) && (*(char *)(g_clientContext + 0x45120) != '\0')) &&
            ...
            if ((local_27e5 & 0x10) == 0) {
              if (bVar16 == 1) {
                ...
                AddToPacketChecksum((void *)(g_clientContext + (uint)bVar16 * 0x224 + 0xebef4), 1);
                ...
                local_27dc = uVar11 * 0x224;
                SubFromPacketChecksum((void *)(g_clientContext + local_27dc + 0x5cba0), 2);
                EncodeChecksumStateXored();
                iVar10 = PeekChecksumStateUnderLock(uVar11 * 0x1120 + 0x5113c + g_clientContext);
                iVar6 = PeekChecksumStateUnderLock(&DAT_00796aa0);
              ...
              if (bVar16 == 1) {
                local_27dc = uVar11 * 0x224;
                AddToPacketChecksum((void *)(g_clientContext + local_27dc + 0x5cba0), 1);
                EncodeChecksumStateXored();
                iVar10 = PeekChecksumStateUnderLock(uVar11 * 0x1120 + 0x5113c + g_clientContext);
                iVar6 = PeekChecksumStateUnderLock(&DAT_00796aa0);
                ...
                puVar8 = local_27f0;
                if (bVar16 == 3) {
                  SubFromPacketChecksum((void *)(g_clientContext + local_27dc + 0x5cba0), 1);
                  EncodeChecksumStateXored();
...
LAB_004b7fb2:
          ...
          if (((cVar2 != '\0') && (cVar2 = PeekPacketChecksumBool((byte *)(g_clientContext + 0x62152)), cVar2 == '\0')) &&
        ...
        case GB_ACT_AIM_CONFIRM:
          ...
          if ((iVar4 != 0) && (*(int *)(iVar4 + 0xb0a4) != -1)) {
            StopSoundChannel(*(int *)(iVar4 + 0xb0a4));
          ...
          if ((iVar4 != -1) && (local_27ec[0x429] != 60000)) {
            AddToPacketChecksum((void *)(g_clientContext + local_27dc + 0x5cba0), local_27ec[0x429]);
          }
        ...
        case GB_ACT_WIND_UPDATE:
          AddToPacketChecksum((void *)(g_clientContext + 0xeb854), 3);
          puVar15 = (undefined4 *)((int)local_27ec + 0x2302);
          for (iVar4 = 8; iVar4 != 0; iVar4 = iVar4 + -1) {
      ...
      *(undefined1 *)(piVar7 + 0x2ffa) = 0;
      ...
      cVar2 = FUN_0043c820();
      if (cVar2 == '\x01') {
        cVar2 = PeekPacketChecksumBool((byte *)piVar7 + 0x8bb7);
        if (cVar2 != '\0') {
    ...
    if (uVar1 == GB_ACT_PERIODIC_STATUS) {
      ...
      if (((uVar11 == bVar16) && (*(int *)(g_clientContext + 0x621e0) != 0)) &&
        ...
        *(undefined4 *)(&g_abBroadcastEventBuffer + g_dwBroadcastEventCursor) =
        ...
        puVar8 = &DAT_00e9aad0 + g_dwBroadcastEventCursor;
      ...
      if (cVar2 != '\0') {
        ...
        do {
          ...
          if (cVar2 != '\0') {
            QueueOutgoingPacketField(0);
            iVar4 = GetPlayerRecordBySlot(g_clientContext);
            AddToPacketChecksum((void *)(g_clientContext + local_27dc + 0x5cba0), 4);
            InitGuardSlot();
            local_c = 0xf;
            EncodeChecksumStateXored();
