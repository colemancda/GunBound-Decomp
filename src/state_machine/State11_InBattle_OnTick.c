      ...
      if (0 < *(int *)(g_clientContext + 0x5b81c + uVar11 * 4)) {
        ...
        if (0x50 < iVar6) {
          ...
          if (iStack_35b0 != 0) {
            ...
            TreeLowerBound(&stack0xffffc278,&DAT_00793770);
            piVar15 = unaff_EDI;
          }
          uStack_34 = 2;
          if (iStack_698 != 0) {
...
LAB_004bedb3:
          ...
          if (0x32 < iVar6) {
            ...
            if (iVar6 <= *(int *)(g_clientContext + 0x5b81c + (int)piStack_3d5c * 4)) {
              ...
              if (iStack_2f38 != 0) {
                ...
                TreeLowerBound(&stack0xffffc284,&DAT_00793770);
                piVar15 = unaff_EBX;
              }
              uStack_28 = 2;
              if (iStack_244 != 0) {
      ...
      if (0x32 < *(int *)(g_clientContext + 0x5b83c + (int)piStack_3d5c * 4)) {
        ...
        if (iStack_1e1c != 0) {
          ...
          TreeLowerBound(&stack0xffffc280,&DAT_00793770);
          piVar15 = uStack_3d78;
        }
        uStack_2c = 2;
        if (iStack_8b4 != 0) {
      ...
      if (iVar6 < 500) {
        if (0xf9 < iVar6) {
          ...
          if (iStack_2d14 != 0) {
            ...
            TreeLowerBound(&stack0xffffc27c,&DAT_00793770);
            piVar15 = unaff_EBX;
          }
...
LAB_004c13d9:
  ...
  if (SUBFIELD(uStack_3d78,3,undefined1) != '\0') {
    ...
    if (piStack_3374 != (int *)0x0) {
      ScrambleChecksumGuardBytes();
      TreeLowerBound(&uStack_3d78,&DAT_00793770);
      piVar15 = local_3d68;
    }
    iVar14 = iVar6 + -7;
    if (-1 < iVar6) {
