...

{
  ...
  uStack_4 = param_1;
  LoadSpriteSet(&g_spriteRegistry,10000,"gamelist_back.img");
  LoadSpriteSet(&g_spriteRegistry,0x2711,"gamelist_chat.img");
  LoadSpriteSet(&g_spriteRegistry,0x2712,"gamelist_channel.img");
  LoadSpriteSet(&g_spriteRegistry,0x2713,"gamelist_create.img");
  LoadSpriteSet(&g_spriteRegistry,0x2714,"gamelist_password.img");
  LoadSpriteSet(&g_spriteRegistry,0x2715,"gamelist_directgo.img");
  LoadSpriteSet(&g_spriteRegistry,0x2716,"gameliststage.img");
  LoadSpriteSet(&g_spriteRegistry,1000,"b_gamelist_exit.img");
  LoadSpriteSet(&g_spriteRegistry,0x3e9,"b_gamelist_buddy.img");
  LoadSpriteSet(&g_spriteRegistry,0x3ea,"b_gamelist_ranking.img");
  LoadSpriteSet(&g_spriteRegistry,0x3eb,"b_gamelist_avatar.img");
  LoadSpriteSet(&g_spriteRegistry,0x3ec,"b_gamelist_create.img");
  LoadSpriteSet(&g_spriteRegistry,0x3ed,"b_gamelist_join.img");
  LoadSpriteSet(&g_spriteRegistry,0x44c,"b_gamelist_viewall.img");
  LoadSpriteSet(&g_spriteRegistry,0x44d,"b_gamelist_wait.img");
  LoadSpriteSet(&g_spriteRegistry,0x44e,"b_gamelist_prev.img");
  LoadSpriteSet(&g_spriteRegistry,0x44f,"b_gamelist_next.img");
  LoadSpriteSet(&g_spriteRegistry,0x450,"b_gamelist_friend.img");
  LoadSpriteSet(&g_spriteRegistry,0x451,"b_gamelist_directgo.img");
  LoadSpriteSet(&g_spriteRegistry,0x4b0,"b_gamechat_ch1.img");
  LoadSpriteSet(&g_spriteRegistry,0x4b1,"b_gamechat_ch2.img");
  LoadSpriteSet(&g_spriteRegistry,0x4b2,"b_gamechat_ch3.img");
  LoadSpriteSet(&g_spriteRegistry,0x4b3,"b_gamechat_ch4.img");
  LoadSpriteSet(&g_spriteRegistry,0x4b4,"b_gamechat_ch5.img");
  LoadSpriteSet(&g_spriteRegistry,0x4b5,"b_gamechat_ch6.img");
  LoadSpriteSet(&g_spriteRegistry,0x4b6,"b_gamechat_ch7.img");
  LoadSpriteSet(&g_spriteRegistry,0x4b7,"b_gamechat_ch8.img");
  LoadSpriteSet(&g_spriteRegistry,0x514,"b_gamecreate_solo.img");
  LoadSpriteSet(&g_spriteRegistry,0x515,"b_gamecreate_tag.img");
  LoadSpriteSet(&g_spriteRegistry,0x516,"b_gamecreate_score.img");
  LoadSpriteSet(&g_spriteRegistry,0x517,"b_gamecreate_jewel.img");
  LoadSpriteSet(&g_spriteRegistry,0x518,"b_gamecreate_1vs1.img");
  LoadSpriteSet(&g_spriteRegistry,0x519,"b_gamecreate_2vs2.img");
  LoadSpriteSet(&g_spriteRegistry,0x51a,"b_gamecreate_3vs3.img");
  LoadSpriteSet(&g_spriteRegistry,0x51b,"b_gamecreate_4vs4.img");
  LoadSpriteSet(&g_spriteRegistry,0x51c,"b_gamecreate_create.img");
  LoadSpriteSet(&g_spriteRegistry,0x51d,"b_gamecreate_cancel.img");
  LoadSpriteSet(&g_spriteRegistry,0x578,"b_password_ok.img");
  LoadSpriteSet(&g_spriteRegistry,0x579,"b_password_cancel.img");
  LoadSpriteSet(&g_spriteRegistry,0x5dc,"b_directgo_ok.img");
  LoadSpriteSet(&g_spriteRegistry,0x5dd,"b_directgo_cancel.img");
  LoadSpriteSet(&g_spriteRegistry,0x640,"b_gamelist_yes.img");
  LoadSpriteSet(&g_spriteRegistry,0x641,"b_gamelist_no.img");
