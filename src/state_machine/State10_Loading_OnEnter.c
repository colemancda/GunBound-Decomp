...

{
  ...
  *(byte *)(iVar12 + 0x6214e) = bVar2 + bVar11 + -0x34;
  ...
  case 0:
    ...
    break;
  case 1:
    pcVar6 = (char *)GetLocalizedString(&g_localizedStringTable,0x321);
    pcVar10 = (char *)(param_1 + 8);
    do {
      cVar3 = *pcVar6;
      pcVar6 = pcVar6 + 1;
    ...
    break;
  case 2:
    pcVar6 = (char *)GetLocalizedString(&g_localizedStringTable,0x322);
    pcVar10 = (char *)(param_1 + 8);
    do {
      cVar3 = *pcVar6;
      pcVar6 = pcVar6 + 1;
    ...
    break;
  case 3:
    pcVar6 = (char *)GetLocalizedString(&g_localizedStringTable,0x323);
    pcVar10 = (char *)(param_1 + 8);
    do {
      cVar3 = *pcVar6;
      pcVar6 = pcVar6 + 1;
  ...
  uVar9 = uVar8;
  pcVar6 = (char *)GetLocalizedString(&g_localizedStringTable,0x324);
  ...
  if (cVar3 == '\0') {
    pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x325);
    pcVar6 = pcVar10;
    do {
      cVar3 = *pcVar6;
      pcVar6 = pcVar6 + 1;
...
LAB_0043eca8:
    ...
    if (cVar3 == '\x01') {
      pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x326);
      pcVar6 = pcVar10;
      do {
        cVar3 = *pcVar6;
        pcVar6 = pcVar6 + 1;
    ...
    if (cVar3 == '\x02') {
      pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x327);
      pcVar6 = pcVar10;
      do {
        cVar3 = *pcVar6;
        pcVar6 = pcVar6 + 1;
  ...
  if (cVar3 == '\0') {
    pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x328);
    pcVar6 = pcVar10;
    do {
      cVar3 = *pcVar6;
      pcVar6 = pcVar6 + 1;
...
LAB_0043ed58:
    ...
    if (cVar3 == '\x01') {
      pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x329);
      pcVar6 = pcVar10;
      do {
        cVar3 = *pcVar6;
        pcVar6 = pcVar6 + 1;
    ...
    if (cVar3 == '\x02') {
      pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x32a);
      pcVar6 = pcVar10;
      do {
        cVar3 = *pcVar6;
        pcVar6 = pcVar6 + 1;
  ...
  if (*(char *)(g_clientContext + 0x45127) == '\0') {
    pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x32b);
    pcVar6 = pcVar10;
    do {
      cVar3 = *pcVar6;
      pcVar6 = pcVar6 + 1;
    ...
    if (cVar3 == '\x01') {
      pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x32d);
      pcVar6 = pcVar10;
      do {
        cVar3 = *pcVar6;
        pcVar6 = pcVar6 + 1;
      ...
      pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x32e);
      pcVar6 = pcVar10;
      do {
        cVar3 = *pcVar6;
        pcVar6 = pcVar6 + 1;
      ...
      pcVar10 = (char *)GetLocalizedString(&g_localizedStringTable,0x32f);
      pcVar6 = pcVar10;
      do {
        cVar3 = *pcVar6;
        pcVar6 = pcVar6 + 1;
