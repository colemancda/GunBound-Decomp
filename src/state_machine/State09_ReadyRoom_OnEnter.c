...

{
  ...
  LoadSpriteSet(&g_spriteRegistry,0x2711);
  LoadSpriteSet(&g_spriteRegistry,0x2712);
  LoadSpriteSet(&g_spriteRegistry,0x2713);
  LoadSpriteSet(&g_spriteRegistry,0x2714);
  LoadSpriteSet(&g_spriteRegistry,0x2715);
  LoadSpriteSet(&g_spriteRegistry,0x2716);
  LoadSpriteSet(&g_spriteRegistry,0x2717);
  LoadSpriteSet(&g_spriteRegistry,0x2719);
  ...
  LoadSpriteSet(&g_spriteRegistry,0x3fc);
  LoadSpriteSet(&g_spriteRegistry,0x3fd);
  LoadSpriteSet(&g_spriteRegistry,0x3fe);
  LoadSpriteSet(&g_spriteRegistry,0x3ff);
  LoadSpriteSet(&g_spriteRegistry,0x406);
  LoadSpriteSet(&g_spriteRegistry,0x407);
  LoadSpriteSet(&g_spriteRegistry,0x408);
  LoadSpriteSet(&g_spriteRegistry,0x409);
  LoadSpriteSet(&g_spriteRegistry,0x410);
  LoadSpriteSet(&g_spriteRegistry,0x411);
  LoadSpriteSet(&g_spriteRegistry,0x412);
  LoadSpriteSet(&g_spriteRegistry,0x41a);
  LoadSpriteSet(&g_spriteRegistry,0x41b);
  LoadSpriteSet(&g_spriteRegistry,0x41c);
  LoadSpriteSet(&g_spriteRegistry,0x41d);
  LoadSpriteSet(&g_spriteRegistry,0x424);
  LoadSpriteSet(&g_spriteRegistry,0x425);
  LoadSpriteSet(&g_spriteRegistry,0x426);
  LoadSpriteSet(&g_spriteRegistry,0x42e);
  LoadSpriteSet(&g_spriteRegistry,0x42f);
  LoadSpriteSet(&g_spriteRegistry,0x44c);
  LoadSpriteSet(&g_spriteRegistry,0x44d);
  LoadSpriteSet(&g_spriteRegistry,0x44e);
  LoadSpriteSet(&g_spriteRegistry,0x44f);
  LoadSpriteSet(&g_spriteRegistry,0x450);
  LoadSpriteSet(&g_spriteRegistry,0x451);
  LoadSpriteSet(&g_spriteRegistry,0x452);
  LoadSpriteSet(&g_spriteRegistry,0x453);
  LoadSpriteSet(&g_spriteRegistry,0x454);
  LoadSpriteSet(&g_spriteRegistry,0x455);
  LoadSpriteSet(&g_spriteRegistry,0x456);
  LoadSpriteSet(&g_spriteRegistry,0x457);
  LoadSpriteSet(&g_spriteRegistry,0x458);
  LoadSpriteSet(&g_spriteRegistry,0x459);
  LoadSpriteSet(&g_spriteRegistry,0x45a);
  LoadSpriteSet(&g_spriteRegistry,0x4ba);
  LoadSpriteSet(&g_spriteRegistry,0x4bb);
  LoadSpriteSet(&g_spriteRegistry,0x514);
  LoadSpriteSet(&g_spriteRegistry,0x578);
