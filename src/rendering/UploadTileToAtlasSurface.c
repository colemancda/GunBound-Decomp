 ...
 * Lock (vtbl+0x64), row-by-row memcpy into the computed tile rect,
 * Unlock (vtbl+0x80), then sets the tile's loaded flag.
 * NAMED (2026-07-18); called by PreloadTexture.
 *
...
void UploadTileToAtlasSurface(undefined4 *param_1,int param_2)
