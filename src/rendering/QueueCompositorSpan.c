...

{
  ...
  if (0 < param_2) {
    do {
      ...
      if (psVar4 == psVar11) {
        uVar9 = *(uint *)(regEsi + 0x1000);
        iVar6 = (int)(uVar9 + ((int)uVar9 >> 0x1f & 0x3ffU)) >> 10;
        uVar9 = uVar9 & 0x800003ff;
        if ((int)uVar9 < 0) {
          uVar9 = (uVar9 - 1 | 0xfffffc00) + 1;
        }
        if (*(int *)(regEsi + iVar6 * 4) == 0) {
          pvVar2 = operator_new(0x4000);
          *(void **)(regEsi + iVar6 * 4) = pvVar2;
        }
        *(int *)(regEsi + 0x1000) = *(int *)(regEsi + 0x1000) + 1;
        psVar10 = (short *)(uVar9 * 0x10 + *(int *)(regEsi + iVar6 * 4));
        ...
        *(undefined4 *)(psVar10 + 6) = *(undefined4 *)(psVar4 + 6);
        ...
        if (*psVar4 != param_1) {
          ...
          *(int *)(regEsi + 0x1000) = *(int *)(regEsi + 0x1000) + 1;
          psVar3 = (short *)(uVar9 * 0x10 + *(int *)(regEsi + iVar6 * 4));
          psVar4[1] = sVar7;
          *(short **)(psVar4 + 6) = psVar3;
        }
        psVar3[1] = sVar5;
        *psVar3 = sVar7;
        *(undefined1 *)(psVar3 + 2) = *(undefined1 *)(regEsi + 0x200c);
        ...
        *(int *)(psVar10 + 4) = *(int *)(psVar10 + 4) + (local_10 - *psVar4) * 2;
        ...
        psVar4[1] = sVar5;
        *psVar4 = sVar7;
        *(undefined1 *)(psVar4 + 2) = *(undefined1 *)(regEsi + 0x200c);
