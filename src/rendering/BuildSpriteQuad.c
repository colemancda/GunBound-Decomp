...

{
  ...
  _DAT_00ea0e3c = *(undefined4 *)(regEax + 0x80);
  _DAT_00ea0e40 = *(undefined4 *)(regEax + 0x84);
  _DAT_00ea0e60 = *(float *)(regEax + 0x80) + *(float *)(regEax + 0x88);
  _DAT_00ea0e88 = *(float *)(regEax + 0x84) + *(float *)(regEax + 0x88);
