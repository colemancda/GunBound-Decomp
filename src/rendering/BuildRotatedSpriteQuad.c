/* BuildRotatedSpriteQuad - 0x004ebbc0 in the original binary.
 *
...

{
  ...
  DAT_00ea0e28 = (float)param_2 + fVar2 * _DAT_00558038 + fVar1 * _DAT_0055803c;
  DAT_00ea0e2c = (float)param_3 + fVar2 * _DAT_00558034 + fVar1 * _DAT_00558038;
  _DAT_00ea0e4c = (float)param_2 + fVar1 * _DAT_00557ff0 + fVar2 * _DAT_00558038;
  fVar3 = (float)param_3 + fVar2 * _DAT_00558028;
  _DAT_00ea0e50 = fVar3 + fVar1 * _DAT_00558038;
  _DAT_00ea0e94 = (float)param_2 + fVar2 * _DAT_00558030;
  DAT_00ea0e70 = _DAT_00ea0e94 + fVar1 * _DAT_00557ff0;
  DAT_00ea0e74 = fVar3 + fVar1 * _DAT_00558030;
  _DAT_00ea0e94 = _DAT_00ea0e94 + fVar1 * _DAT_0055803c;
  _DAT_00ea0e98 = (float)param_3 + fVar1 * _DAT_00558030 + fVar2 * _DAT_00558034;
