/* FUN_00499ef0 - 0x00499ef0 in the original binary.
 *
...
void __fastcall FUN_00499ef0(int *param_1)

{
  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  pcVar13 = LeaveCriticalSection_exref;
  ...
  if (cVar2 == '\0') {
    ...
    if (cVar2 == '\0') {
      ...
      uStack_c = 7;
      uVar6 = FUN_0040aca0(param_1[0x3d2] + 0x38,auStack_45c,uVar6);
      uStack_c = 8;
      unaff_EBX = 3;
      cVar2 = FUN_0040b490(param_1 + 0x3d5,uVar6);
      if (cVar2 == '\0') {
        uVar6 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_8a4,4);
        uStack_c = 9;
        uVar6 = FUN_0040aba0(param_1[0x3d2] + 0x38,&iStack_ac8,uVar6);
        uStack_c = 10;
        unaff_EBX = 0xf;
        cVar2 = FUN_0040b490(uVar6,param_1 + 0x3d5);
        bVar16 = false;
...
LAB_0049acb2:
      *(undefined1 *)(param_1 + 5) = 1;
      ...
      if ((cVar2 != '\0') && (cVar2 = FUN_0043a530(), cVar2 == '\0')) {
        iVar3 = *(int *)(*(int *)(DAT_005b3484 + 0x621e4) + 0x24);
  ...
  if (cVar2 != '\0') {
    ...
    if ((-1 < iVar3) && (iVar3 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
      pcVar5 = (char *)(*(int *)(&DAT_006a773c + DAT_005b3484) + iVar3);
      puStack_af0 = (undefined4 *)0x0;
      if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
        do {
          if (*pcVar5 != '\0') goto LAB_0049a03a;
          pcVar5 = pcVar5 + *(int *)(&DAT_006a7720 + DAT_005b3484);
...
LAB_0049a03a:
    ...
    uVar6 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar6,puStack_af0);
    local_ae4 = 1;
    if (0 < param_1[0xfe5]) {
...
LAB_0049a2b5:
    if (bVar16) {
      ...
      if (cVar2 == '\0') {
        ...
        uVar18 = 100;
        uVar17 = 0;
        FUN_004065a0(uVar6,0,100,0xff,iVar3,0);
...
LAB_0049a57d:
        ...
        cVar2 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&uStack_ad8,&uStack_adc,2,1,1);
        if (cVar2 != '\0') {
          auStack_8a4[0] = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
          ...
          uVar6 = FUN_0040a4d0(auStack_ac4);
          FUN_004065a0(uVar6,uVar17,uVar18,uVar19,iVar3,uVar20);
          FUN_00432320((char)param_1[0xf],1,1,uVar6,uVar17,uVar18,uVar19,iVar3,uVar20);
...
LAB_0049a73d:
  ...
  iVar4 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  if ((iVar4 <= iVar3) || (cVar2 = FUN_0040b490(param_1 + 0xed2,param_1 + 0xf5b), cVar2 == '\0')) {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    iVar3 = PeekPacketChecksumState();
    iVar4 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  ...
  iVar3 = DAT_005b3484;
  pbVar14 = (byte *)(DAT_005b3484 + 0x62143);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  iVar4 = _rand();
  *pbVar14 = (byte)iVar4;
  iVar4 = _rand();
