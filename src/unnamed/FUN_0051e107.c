/* FUN_0051e107 - 0x0051e107 in the original binary.
 *
...
FUN_0051e107(undefined4 param_1,undefined4 param_2,int param_3,undefined4 param_4,int param_5)

{
  ...
  do {
    ...
    DAT_00568940 = (int)ROUND((pfVar33[0xe] *
    ...
    ((undefined2 *)(param_5 + 0x20))[iVar19 * 2] = (short)DAT_00568940;
    iVar19 = iVar19 + 1;
    pfVar34 = pfVar33 + 0x20;
  } while (iVar19 != 0);
  cVar23 = cVar20 + -1;
  DAT_00568940 = (int)ROUND(pfVar33[0x27] *
  ...
  *(undefined2 *)(param_5 + 0x20) = (short)DAT_00568940;
  ...
  do {
    ...
    DAT_00568940 = (int)ROUND(*pfVar14 * *(float *)(param_3 + CONCAT31(uVar32,cVar31) * 4) +
    ...
    *(short *)(param_5 + 0x40 + iVar19 * 4) = (short)iVar18;
    iVar19 = iVar19 + 1;
  } while (iVar19 != 0);
