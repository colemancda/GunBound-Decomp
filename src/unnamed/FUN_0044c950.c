...
LAB_0044d5d2:
    ...
    if (cVar20 == '\0') {
      ...
      (*pcVar13)(&DAT_005a9068);
      if (((cVar3 != '\0') ||
          (cVar3 = FUN_0040b300(unaff_EBX,*(undefined4 *)(&DAT_006a7724 + DAT_005b3484)),
...
LAB_0044d78e:
    ...
    if (cVar3 != '\0') {
      ...
      (*pcVar13)(&DAT_005a9068);
      iVar4 = DAT_005b3484;
      piVar14 = (int *)(&DAT_006a7708 + DAT_005b3484);
      cVar3 = FUN_004065a0();
  ...
  if (cVar3 != '\0') {
    ...
    if ((-1 < iVar4) && (iVar4 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
      ...
      if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
        ...
        } while ((int)puStack_ae4 < *(int *)(&DAT_006a7724 + DAT_005b3484));
      }
    }
...
LAB_0044ca9a:
    ...
    uVar7 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar7,puStack_ae4);
    local_ae8 = 1;
    if (0 < param_1[0xfe5]) {
...
LAB_0044cfdd:
        ...
        cVar3 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&uStack_ad0,&uStack_ad4,2,1,1);
        if (cVar3 != '\0') {
          auStack_8a4[0] = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
          ...
          FUN_004065a0(uVar7,uVar16,uVar17,uVar18,iVar4,uVar19);
          FUN_00432320((char)param_1[0xf],1,1,uVar7,uVar16,uVar17,uVar18,iVar4,uVar19);
...
LAB_0044d07e:
  ...
  uVar7 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  FUN_0040a6e0(param_1 + 0x45e,auStack_ac4,uVar7);
  ...
  if (iVar5 < iVar4) {
    ...
    if ((char)((uint)unaff_EBP >> 0x18) == '\0') {
      FUN_0040a6e0(param_1 + 0x3d5,&iStack_ac8,1);
      uStack_c = 7;
    }
    else {
      FUN_0040a5f0(param_1 + 0x3d5,auStack_8a4,1);
      uStack_c = 6;
    }
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    PeekPacketChecksumState();
    ...
    PeekPacketChecksumState();
    (*pcVar13)(&DAT_005a9068);
    uVar16 = FUN_004065a0(unaff_EDI);
    FUN_004375f0(&DAT_006a7f70 + DAT_005b3484,iVar4,uVar7,(char)param_1[0xf],uVar16,unaff_EDI);
    uStack_18 = 6;
    if ((unaff_ESI & 2) != 0) {
