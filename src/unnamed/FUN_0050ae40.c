 ...
 * Frame: [esp+0x20] = local_84 (g_gameStateVTableArray[7], then
 * rebased by param_1*0x17e4 at 0x50b1b2), [esp+0x1c] = local_88,
 * [esp+0x14] = local_90 (the 0x224-stride equipped-array cursor).  Cells:
 * local_84+0x228 (selected index, 0x50ae83); g_clientContext + local_90
 * + 0x5f4ab8 (equipped array, 0x50af2b); the store-catalog record
 * *(ctx+0x44e20) + (*(local_84+0x454)+param_1)*0x450 at +0x22c (part
 * code, 0x50b02d/0x50b08b/0x50b162 - same imul 0x450 as the bounds check
 * against ctx+0x44e24 right above each); then the per-slot cells
 * local_84+0xe1e0 / +0xf0dc, and six category blocks at local_84 +
 * 0xe628/0xe84c/0xea70/0xec94/0xe404/0xeeb8 (address order, confirmed by
 * the BlitSpriteClipped ids 0xc..0x17 the C keeps).  Within each block the
 * three follow-up peeks read frame[0x18], which holds that block's cell
 * pointer (0x50b4cc etc.), so all four get the same cell; the C's
 * `local_8c = ...`/`local_90 = local_88 + 0xe84c` lines are Ghidra's
 * garbled rendering of that pointer store and were left alone.
 */
...

{
  ...
  if (((param_1 == iVar2) && (DAT_0079352c != 0)) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2712,1), iVar2 != 0)) {
...
LAB_0050af95:
    if (uVar5 == 7) {
      if (*(char *)(iVar2 + 0x18) == '\x01') {
        BlitSprite16bpp(7,local_88,local_94 + 4,0x2713);
      }
      else {
        BlitSpriteClipped(7,local_88,local_94 + 4,0x2713);
      }
      break;
    }
  }
...
LAB_0050b0e6:
    if (uVar5 == uVar6) {
      if (*(char *)(iVar2 + 0x18) == '\x01') {
        BlitSprite16bpp(uVar6,local_88 + 6,local_94 + 2,0x2713);
      }
      else {
...
LAB_0050b11f:
  if ((uint)(*(int *)(local_84 + 0x454) + param_1) < *(uint *)(g_clientContext + 0x44e24)) {
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 < 1) {
        iVar2 = local_88 + 0x99;
        if ((DAT_0079352c != 0) && (iVar4 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,9), iVar4 != 0)) {
          if (*(char *)(iVar4 + 0x18) == '\x01') {
            BlitSprite16bpp(9,iVar2,local_94 + 2,0x2713);
          }
          else {
        ...
        iVar2 = local_88 + 0x99;
        if ((DAT_0079352c != 0) && (iVar4 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,8), iVar4 != 0)) {
          if (*(char *)(iVar4 + 0x18) == '\x01') {
            BlitSprite16bpp(8,iVar2,local_94 + 2,0x2713);
          }
          else {
    ...
    if ((iVar2 != 0) && (local_90 < 3)) {
      ...
      if (iVar2 < 0) {
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0xa), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(10,puVar3,local_94 + 2,0x2713);
          }
          else {
        ...
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0xb), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(0xb,puVar3,local_94 + 2,0x2713);
          }
          else {
    ...
    if ((iVar2 != 0) && ((int)local_94 < 3)) {
      ...
      if (iVar2 < 0) {
        ...
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0xc), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(0xc,puVar3,unaff_EBX + 2,0x2713);
          }
          else {
        ...
        puVar3 = local_8c + (int)puVar3 * 0x19 + 0x67;
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0xd), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(0xd,puVar3,unaff_EBX + 2,0x2713);
          }
          else {
    ...
    if ((iVar2 != 0) && ((int)puVar3 < 3)) {
      ...
      if (iVar2 < 0) {
        ...
        if ((DAT_0079352c != 0) && (iVar4 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0xe), iVar4 != 0)) {
          if (*(char *)(iVar4 + 0x18) == '\x01') {
            BlitSprite16bpp(0xe,iVar2 + 0x67,unaff_EBP + 2,0x2713);
          }
          else {
        ...
        iVar2 = (int)puVar3 * 0x19 + local_90;
        if ((DAT_0079352c != 0) && (iVar4 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0xf), iVar4 != 0)) {
          if (*(char *)(iVar4 + 0x18) == '\x01') {
            BlitSprite16bpp(0xf,iVar2 + 0x67,unaff_EBP + 2,0x2713);
          }
          else {
    ...
    if ((iVar2 != 0) && ((int)puVar3 < 3)) {
      ...
      if (iVar2 < 0) {
        ...
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0x10), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(0x10,puVar3,unaff_ESI + 2,0x2713);
          }
          else {
        ...
        puVar3 = local_94 + (int)puVar3 * 0x19 + 0x67;
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0x11), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(0x11,puVar3,unaff_ESI + 2,0x2713);
          }
          else {
    ...
    if ((iVar4 != 0) && ((int)puVar3 < 3)) {
      ...
      (*pcVar7)(&DAT_005a9068);
      if (iVar4 < 0) {
        if ((DAT_0079352c != 0) && (iVar4 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0x12), iVar4 != 0)) {
          if (*(char *)(iVar4 + 0x18) == '\x01') {
            BlitSprite16bpp(0x12,(int)puVar3 * 0x19 + iVar2 + 0x67,unaff_EDI + 2,0x2713);
          }
          else {
        ...
        if ((DAT_0079352c != 0) && (iVar4 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0x13), iVar4 != 0)) {
          if (*(char *)(iVar4 + 0x18) == '\x01') {
            BlitSprite16bpp(0x13,(int)puVar3 * 0x19 + iVar2 + 0x67,unaff_EDI + 2,0x2713);
          }
          else {
    ...
    if ((iVar2 != 0) && ((int)puVar3 < 3)) {
      ...
      if (iVar2 < 0) {
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0x14), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(0x14,puVar1 + (int)puVar3 * 0x19 + 0xe46b,puVar9 + 2,0x2713);
          }
          else {
        ...
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0x15), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(0x15,puVar1 + (int)puVar3 * 0x19 + 0xe46b,puVar9 + 2,0x2713);
          }
          else {
    ...
    if ((iVar2 != 0) && ((int)puVar3 < 3)) {
      ...
      (*pcVar7)(&DAT_005a9068);
      if (iVar2 < 0) {
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0x16), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(0x16,unaff_EDI + (int)puVar3 * 0x19 + 0x67,puVar8 + 2,0x2713);
          }
          else {
        ...
        if ((DAT_0079352c != 0) && (iVar2 = FindSpriteFrame((int)&g_spriteRegistry,0x2713,0x17), iVar2 != 0)) {
          if (*(char *)(iVar2 + 0x18) == '\x01') {
            BlitSprite16bpp(0x17,unaff_EDI + (int)puVar3 * 0x19 + 0x67,puVar8 + 2,0x2713);
          }
          else {
