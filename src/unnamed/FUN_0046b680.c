/* FUN_0046b680 - 0x0046b680 in the original binary.
 *
...
void __fastcall FUN_0046b680(int *param_1)
  ...
  if (iVar6 == 4) {
    ...
    while (uVar13 < 0x186ab) {
      if (uVar13 == 0x186aa) {
        ...
        bVar17 = true;
        if (piVar9[2] == 0) goto LAB_0046ba45;
        break;
      }
  ...
  if ((iVar6 <= iVar5) ||
    ...
    if ((iVar5 <= iVar6) ||
       ((cVar4 = FUN_0040b410(piStack_ad8 + 0xed2,piStack_ad8 + 0xf5b), cVar4 == '\0' ||
        (piStack_ad8[0xed1] < 6)))) goto LAB_0046c976;
  }
  iVar5 = DAT_005b3484;
