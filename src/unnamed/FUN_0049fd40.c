  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  if ((cVar1 != '\0') || (param_1[0xfe7] == 0x2c)) {
    ...
    if ((0x2b < param_1[0xfe7]) ||
       ((cVar1 = FUN_004065a0(), cVar1 != '\0' || ((char)param_1[0xfe8] != '\0')))) {
      ...
      if (cVar1 != '\0') {
        ...
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        if ((-1 < (int)local_af4) && ((int)local_af4 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
          pcVar12 = (char *)(*(int *)(&DAT_006a773c + DAT_005b3484) + (int)local_af4);
          local_af8 = (int *)0x0;
          if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
            do {
              if (*pcVar12 != '\0') goto LAB_004a0a52;
              pcVar12 = pcVar12 + *(int *)(&DAT_006a7720 + DAT_005b3484);
              local_af8 = (int *)((int)local_af8 + 1);
            } while ((int)local_af8 < *(int *)(&DAT_006a7724 + DAT_005b3484));
          }
        }
...
LAB_004a0a52:
        ...
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar5,local_af8);
        local_af4 = (int *)0x1;
        if (0 < param_1[0xfe5]) {
      ...
      puStack_aec = &DAT_006a7f70 + DAT_005b3484;
    ...
    if ((cVar1 != '\0') &&
       (cVar1 = PacketChecksumNotEquals(piVar15,*(int *)(&DAT_006a7720 + DAT_005b3484) + -1),
       cVar1 != '\0')) {
      ...
      if ((cVar1 != '\0') &&
         ...
         cVar1 != '\0')) {
        uVar5 = FUN_0040a5f0(piVar15,auStack_ac4,8);
        ...
        uVar5 = FUN_0040a6e0(piVar15,auStack_ac4,8);
  ...
  if (cVar1 == '\0') {
    ...
    uVar5 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_684,4);
    uStack_10 = 0x13;
    uVar5 = FUN_0040aca0(param_1[0x3d2] + 0x38,auStack_460,uVar5);
    uStack_10 = 0x14;
    unaff_EBX = 0x30;
    cVar1 = FUN_0040b490(local_af8,uVar5);
    if (cVar1 == '\0') {
      uVar5 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_8a8,4);
      uStack_10 = 0x15;
      uVar5 = FUN_0040aba0(param_1[0x3d2] + 0x38,&local_acc,uVar5);
      uStack_10 = 0x16;
      unaff_EBX = 0xf0;
...
LAB_004a0643:
  ...
  if ((char)(unaff_EBX >> 0x18) == '\0') {
    ...
    (*pcVar14)(&DAT_005a9068);
    if (((iVar3 < iVar4) ||
        (cVar1 = FUN_0040b2d0(piStack_ae0,*(undefined4 *)(&DAT_006a7724 + DAT_005b3484)),
...
LAB_004a07f1:
  ...
  if (cVar1 != '\0') {
    ...
    (*pcVar14)(&DAT_005a9068);
    iVar3 = DAT_005b3484;
    piVar15 = (int *)(&DAT_006a7708 + DAT_005b3484);
    cVar1 = FUN_004065a0();
...
LAB_004a0f88:
        ...
        cVar1 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&iStack_adc,&piStack_ad8,2,1,1);
        if (cVar1 != '\0') {
          uStack_8a4 = 0;
          uStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
...
LAB_004a101f:
  *(undefined1 *)(iStack_ad0 + 0x14) = 1;
  ...
  if ((cVar1 != '\0') && (cVar1 = FUN_0043a530(), cVar1 == '\0')) {
    ...
    uVar5 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    puStack_aec = (undefined *)(DAT_005b3484 + 0x621e8);
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    EncodeOutgoingPacketField(uVar5);
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  }
  ...
  if (cVar1 != '\0') {
    puStack_aec = (undefined *)(DAT_005b3484 + 0x5b85c);
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uVar5 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar5);
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_004a14d3:
    ...
    iVar3 = DAT_005b3484;
    if (cVar1 == '\0') {
      pbVar16 = (byte *)(DAT_005b3484 + 0x62146);
      EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      iVar4 = _rand();
      *pbVar16 = (byte)iVar4;
      iVar4 = _rand();
