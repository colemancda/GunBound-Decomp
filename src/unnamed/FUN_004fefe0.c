/* FUN_004fefe0 - 0x004fefe0 in the original binary.
 *
...
/* WARNING: Removing unreachable block (ram,0x004ff063) */

void FUN_004fefe0(void)
      ...
      while (iVar6 != 0) {
        ...
        *(int *)(iVar6 + 0x14) = unaff_ESI[0xb];
        ...
        if ((iVar3 - 1U < (uint)unaff_ESI[7]) && (unaff_ESI[8] == 0)) {
          ...
          if (0x11 < uVar5) {
            do {
              puVar1 = &DAT_0055794c + iVar6;
              iVar6 = iVar6 + 1;
            } while (*puVar1 < uVar5);
          }
          uVar7 = (&DAT_00557948)[iVar6];
          if ((&DAT_00557948)[iVar6] == 0xffffffff) {
            uVar7 = uVar5;
          }
          FUN_00500440(unaff_ESI,uVar7);
        }
        iVar6 = iVar2;
        if (unaff_ESI[1] == 0) {
          unaff_ESI[0xb] = 0;
