/* FUN_00443680 - 0x00443680 in the original binary.
 *
...
undefined4 * FUN_00443680(undefined4 *param_1,int *param_2,int *param_3)

{
  ...
  while (piVar2 != piVar4) {
    param_2 = piVar2;
    FUN_00443780();
    FUN_00443840(unaff_ESI,&param_1,piVar2);
    piVar2 = param_2;
  }
  *puVar3 = piVar2;
  return puVar3;
