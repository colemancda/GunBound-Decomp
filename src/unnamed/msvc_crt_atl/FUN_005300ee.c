/* FUN_005300ee - 0x005300ee in the original binary.
 *
...
float10 FUN_005300ee(double param_1)

{
  ...
  dVar2 = (double)((ulonglong)in_XMM7_Qa & _DAT_005490a0);
  dVar3 = (double)((ulonglong)in_XMM7_Qa & uRam005490a8);
