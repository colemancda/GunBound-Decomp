...

{
  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  if (cVar4 == '\0') {
    ...
    if (cVar4 == '\0') {
      FUN_0040afb0(piVar9 + 0x2bd);
      FUN_0040afb0(piVar9 + 0x346);
    }
    else {
      EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      ...
      if ((int)((uVar13 ^ (int)uVar13 >> 0x1f) - ((int)uVar13 >> 0x1f)) < 200) {
        cVar4 = FUN_0040b330(piVar9 + 0x122,0);
        if (cVar4 == '\0') {
          uVar8 = 200;
        }
        else {
      ...
      if (cVar4 == '\0') {
        ...
        bVar2 = true;
        bVar17 = true;
        cVar4 = FUN_0040b490(uVar8,piVar9 + 0x3d5);
        bVar3 = false;
...
LAB_00466684:
      *(undefined1 *)(piVar9 + 5) = 1;
      ...
      if ((cVar4 != '\0') && (cVar4 = FUN_0043a530(), cVar4 == '\0')) {
        iVar5 = *(int *)(*(int *)(DAT_005b3484 + 0x621e4) + 0x24);
    ...
    if (cVar4 != '\0') {
      ...
      if ((cVar4 == '\0') && ((&DAT_006a7758)[iVar5] != '\0')) {
        if (((&DAT_006a7736)[iVar5] == '\x01') &&
           ((uVar13 = iVar6 - *(int *)(&DAT_006a7714 + iVar5) >> 0x1f,
            200 < (int)((iVar6 - *(int *)(&DAT_006a7714 + iVar5) ^ uVar13) - uVar13) ||
            (uVar13 = iVar10 - *(int *)(&DAT_006a7710 + iVar5) >> 0x1f,
            300 < (int)((iVar10 - *(int *)(&DAT_006a7710 + iVar5) ^ uVar13) - uVar13))))) {
        ...
        iVar11 = *(int *)(&DAT_006a7724 + iVar5) + -0x104;
        if ((iVar10 <= iVar11) && (iVar11 = -0x14, -0x15 < iVar6)) {
          iVar11 = iVar6;
        }
        iVar6 = *piVar9 - iVar12;
        *(int *)(&DAT_006a771c + iVar5) = iVar11;
  ...
  if (cVar4 != '\0') {
    ...
    iVar5 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    if ((-1 < iVar5) && (iVar5 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
      pcVar7 = (char *)(*(int *)(&DAT_006a773c + DAT_005b3484) + iVar5);
      ...
      if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
        ...
        } while ((int)puStack_af4 < *(int *)(&DAT_006a7724 + DAT_005b3484));
      }
    }
...
LAB_0046564a:
    ...
    uVar8 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar8,puStack_af4);
    local_ae8 = 1;
    if (0 < param_1[0xfe5]) {
...
LAB_004658c5:
    if (bVar17) {
      ...
      if (cVar4 == '\0') {
        ...
        uVar19 = 100;
        uVar18 = 0;
        FUN_004065a0(uVar8,0,100,0xff,iVar5,0);
...
LAB_00465b8d:
        ...
        cVar4 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&uStack_adc,&local_ad4,2,1,1);
        if (cVar4 != '\0') {
          uStack_8a4 = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
          ...
          FUN_004065a0(uVar8,uVar18,uVar19,uVar20,iVar5,uVar21);
          FUN_00432320((char)param_1[0xf],1,1,uVar8,uVar18,uVar19,uVar20,iVar5,uVar21);
...
LAB_00465c2e:
  *(undefined1 *)(piStack_ad8 + 5) = 1;
  ...
  PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  FUN_004e4970(uStack_adc,local_ad4,uVar21,uVar20,uVar19,apuStack_ad0[0],uVar18,uVar8);
  ...
  apuStack_ad0[0] = (undefined4 *)PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar18 = FUN_004065a0(local_af0);
  FUN_00437b40(&DAT_006a7f70 + DAT_005b3484,apuStack_ad0[0],uVar8,(char)piStack_ad8[0xf],uVar18,
               local_af0);
  cVar4 = FUN_004065a0();
  if ((cVar4 != '\0') && (cVar4 = FUN_0043a530(), cVar4 == '\0')) {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_00466113:
  ...
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  if ((iVar6 <= iVar5) ||
     (cVar4 = FUN_0040b490(piStack_ad8 + 0xed2,piStack_ad8 + 0xf5b), cVar4 == '\0')) {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    iVar5 = PeekPacketChecksumState();
    iVar6 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    if ((iVar5 <= iVar6) ||
       ((cVar4 = FUN_0040b410(piStack_ad8 + 0xed2,piStack_ad8 + 0xf5b), cVar4 == '\0' ||
        (piStack_ad8[0xed1] < 6)))) goto LAB_00466842;
  }
  iVar5 = DAT_005b3484;
  pbVar16 = (byte *)(DAT_005b3484 + 0x62143);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  iVar6 = _rand();
  *pbVar16 = (byte)iVar6;
  iVar6 = _rand();
