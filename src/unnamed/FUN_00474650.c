  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  if (cVar4 == '\0') {
    ...
    if (cVar4 == '\0') {
      ...
      uVar8 = FUN_0040a8c0(piVar9[0x3d2] + 0x25c,auStack_458,4);
      puStack_8 = (undefined1 *)0x7;
      uVar8 = FUN_0040aca0(piVar9[0x3d2] + 0x38,auStack_67c,uVar8);
  ...
  if (cVar4 != '\0') {
    ...
    if ((-1 < iVar5) && (iVar5 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
      ...
      if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
        ...
        } while ((int)puStack_b04 < *(int *)(&DAT_006a7724 + DAT_005b3484));
      }
    }
...
LAB_0047479a:
    ...
    uVar8 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar8,puStack_b04);
    iStack_af4 = 1;
    if (0 < param_1[0xfe5]) {
  ...
  if (iVar6 == 4) {
    ...
    if (puStack_b04 == (undefined4 *)0x0) {
      ...
      FUN_00454dc0(puStack_b04,0x186a9);
...
LAB_00474cdd:
        ...
        cVar4 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&uStack_aec,&local_ae4,2,1,1);
        if (cVar4 != '\0') {
          uStack_8a4 = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
...
LAB_00475202:
  ...
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  if ((iVar6 <= iVar5) ||
     (cVar4 = FUN_0040b490(piStack_ae8 + 0xed2,piStack_ae8 + 0xf5b), cVar4 == '\0')) {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    iVar5 = PeekPacketChecksumState();
    iVar6 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    if ((iVar5 <= iVar6) ||
       ((cVar4 = FUN_0040b410(piStack_ae8 + 0xed2,piStack_ae8 + 0xf5b), cVar4 == '\0' ||
