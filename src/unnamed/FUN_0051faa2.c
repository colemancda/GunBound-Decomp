/* FUN_0051faa2 - 0x0051faa2 in the original binary.
 *
...
FUN_0051faa2(undefined4 param_1,undefined4 param_2,int param_3,int param_4,int param_5)

{
  ...
  do {
    ...
    ((byte *)(param_5 + 8))[iVar17 * 2] = (byte)((uint)DAT_00569344 >> 8) ^ 0x80;
    iVar17 = iVar17 + 1;
  ...
  *(byte *)(param_5 + 8) = (byte)((uint)DAT_00569344 >> 8) ^ 0x80;
  ...
  do {
    ...
    *(byte *)(param_5 + 0x10 + iVar18 * 2) = (byte)((uint)iVar20 >> 8) ^ 0x80;
    iVar18 = iVar18 + 1;
  } while (iVar18 != 0);
