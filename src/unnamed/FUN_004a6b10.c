/* FUN_004a6b10 - 0x004a6b10 in the original binary.
 *
...
void __fastcall FUN_004a6b10(int param_1)
...
LAB_004a6e54:
              DAT_00ea0e28 = (float)(int)(((-(uint)(*(char *)(param_1 + 0x4a8) != '\0') & 0x200) -
                                          0x117) + iVar4);
              _DAT_00ea0e4c =
                   (float)(int)(((-(uint)(*(char *)(param_1 + 0x4a8) != '\0') & 0x200) - 0xea) +
                               iVar4);
              DAT_00ea0e70 = (float)(iVar4 + 0x16);
              _DAT_00ea0e94 = (float)(iVar4 + -0x17);
              DAT_00ea0e2c = (float)(int)(((-(uint)(*(char *)(param_1 + 0x4a8) != '\0') & 0xffffffd2
                                           ) - 0xe9) + iVar5);
              _DAT_00ea0e50 =
                   (float)(int)(((-(uint)(*(char *)(param_1 + 0x4a8) != '\0') & 0x2c) - 0x116) +
                               iVar5);
              DAT_00ea0e74 = (float)(int)(((-(uint)(*(char *)(param_1 + 0x4a8) != '\0') & 0x2c) -
                                          0x16) + iVar5);
              _DAT_00ea0e98 =
                   (float)(int)((-(uint)(*(char *)(param_1 + 0x4a8) != '\0') & 0xffffffd2) + 0x17 +
                               iVar5);
              _DAT_00ea0e60 = fVar2 + _DAT_00558054;
              puVar8 = &DAT_00ea0e28;
              puVar9 = puVar7 + -0x1b;
              _DAT_00ea0e3c = fVar2;
              ...
              puVar7 = puVar7 + 0x36;
              iVar4 = iVar4 + ((-(uint)(*(char *)(param_1 + 0x4a8) != '\0') & 0x200) - 0x100);
            }
          }
