 ...
 * (with DAT_005a9290's split fields as float offset macros) - the
 * split-struct blocker the note below describes no longer holds.  The
 * operand analysis it records was applied verbatim: ECX stayed param_1,
 * EAX is the trailing regEax.
...
undefined4 * __fastcall MultiplyMatrix4x4ToScratch(float *param_1,float *regEax)

{
  ...
  local_40[0] = param_1[3] * regEax[0xc] +
                *regEax * *param_1 + regEax[4] * param_1[1] + regEax[8] * param_1[2];
  local_40[1] = regEax[1] * *param_1 +
                regEax[9] * param_1[2] + regEax[5] * param_1[1] + regEax[0xd] * param_1[3];
  local_40[2] = regEax[10] * param_1[2] +
                regEax[6] * param_1[1] + param_1[3] * regEax[0xe] + regEax[2] * *param_1;
  local_30 = regEax[8] * param_1[6] +
             param_1[7] * regEax[0xc] + param_1[4] * *regEax + regEax[4] * param_1[5];
  local_2c = regEax[1] * param_1[4] +
             param_1[6] * regEax[9] + param_1[7] * regEax[0xd] + regEax[5] * param_1[5];
  local_28 = regEax[2] * param_1[4] +
             regEax[6] * param_1[5] + param_1[6] * regEax[10] + param_1[7] * regEax[0xe];
  local_20 = param_1[8] * *regEax +
             regEax[0xc] * param_1[0xb] + regEax[4] * param_1[9] + regEax[8] * param_1[10];
  local_1c = regEax[5] * param_1[9] +
             regEax[9] * param_1[10] + regEax[0xd] * param_1[0xb] + regEax[1] * param_1[8];
  local_18 = regEax[10] * param_1[10] +
             regEax[0xe] * param_1[0xb] + param_1[8] * regEax[2] + regEax[6] * param_1[9];
  local_10 = param_1[0xc] * *regEax +
             param_1[0xf] * regEax[0xc] + regEax[8] * param_1[0xe] + regEax[4] * param_1[0xd];
  local_c = param_1[0xc] * regEax[1] +
            param_1[0xd] * regEax[5] + param_1[0xe] * regEax[9] + regEax[0xd] * param_1[0xf];
  local_8 = param_1[0xd] * regEax[6] +
            param_1[0xe] * regEax[10] + param_1[0xf] * regEax[0xe] + param_1[0xc] * regEax[2];
  ...
  local_40[3] = regEax[3] * *param_1 +
                regEax[7] * param_1[1] + param_1[3] * regEax[0xf] + regEax[0xb] * param_1[2];
  local_24 = regEax[3] * param_1[4] +
             regEax[7] * param_1[5] + param_1[6] * regEax[0xb] + param_1[7] * regEax[0xf];
  local_14 = regEax[0xf] * param_1[0xb] +
             regEax[0xb] * param_1[10] + regEax[3] * param_1[8] + regEax[7] * param_1[9];
  local_4 = param_1[0xd] * regEax[7] +
            regEax[0xb] * param_1[0xe] + param_1[0xc] * regEax[3] + param_1[0xf] * regEax[0xf];
LAB_004f221b:
  pfVar3 = local_40;
  ...
  return (undefined4 *)DAT_005a9350;
}
