...

{
  ...
  if (0x202 < param_2) {
    ...
    if (param_2 != 0x205) {
      ...
      iVar10 = FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xb30);
      iVar11 = FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x90c);
      iVar13 = DAT_005b3484;
      cVar4 = FUN_004065a0();
    ...
    *(undefined1 *)((int)param_1 + 0x91) = 0;
    ...
    (&DAT_006a7758)[DAT_005b3484] = uVar5;
  ...
  if (param_2 != 0x202) {
    if (0x112 < param_2) {
      ...
      if ((char)param_1[0x46b] != '\0') {
        ...
        if ((0xa8 < uVar9) && (uVar9 < 0xb4)) {
          if ((0x27 < uVar17) && (uVar17 < 0x41)) {
            *(undefined4 *)(&DAT_005f2f44 + DAT_005b3484) = 0x14;
          }
      ...
      if ((((0x226 < uVar9) && (uVar9 < 599)) && (0xf4 < uVar17)) && (uVar17 < 0x284)) {
        *(uint *)(DAT_005b3484 + 0xebee8) = uVar17;
        *(undefined1 *)(param_1 + 4) = 1;
      }
      if ((((3 < uVar9) && (uVar9 < 0x22)) &&
          ((cVar4 = FUN_004065a0(), iVar13 = DAT_005b3484, cVar4 == '\0' &&
           ((cVar4 = FUN_004065a0(), iVar13 = DAT_005b3484, cVar4 == '\x01' &&
            ((char)param_1[0x42f] == '\x01')))))) &&
         (cVar4 = PacketChecksumNotEquals(DAT_005b3484 + 0xebcbc,6), iVar13 = DAT_005b3484,
         cVar4 != '\0')) {
        iVar10 = 0;
        iVar11 = 0x218;
        do {
          cVar4 = PacketChecksumNotEquals(iVar10 + 0x39f30 + DAT_005b3484,0);
          if (((cVar4 != '\0') && (iVar11 + -0x23 < (int)uVar17)) && ((int)uVar17 < iVar11)) {
            cVar4 = FUN_004065a0();
            if (cVar4 == '\0') {
              iVar10 = FUN_00420600(DAT_005b3484);
              iVar13 = DAT_005b3484;
              if (*(int *)(DAT_005b3484 + 0xf0374) == iVar10) {
                *(undefined4 *)(DAT_005b3484 + 0xf0374) = 0xffffffff;
              }
              else {
                *(int *)(DAT_005b3484 + 0xf0374) = iVar10;
              }
            }
            else {
              uVar20 = FUN_00420600(DAT_005b3484);
      ...
      if (*(char *)((int)param_1 + 0x92) != '\0') {
        ...
        *psVar1 = *(short *)(&DAT_006a7710 + DAT_005b3484) + (short)param_4 + -400;
        ...
        if (iVar13 == 1) {
          ...
          uVar5 = FUN_0040a4d0(&DAT_006a64c4 + DAT_005b3484);
          (&g_replayEventBuffer)[g_replayEventCursor] = uVar5;
        }
        g_replayEventCursor = g_replayEventCursor + 1;
        uVar5 = FUN_0040a4d0(DAT_005b3484 + 0x3b49c);
        (&g_replayEventBuffer)[g_replayEventCursor] = uVar5;
        g_replayEventCursor = g_replayEventCursor + 1;
        Replay_FlushEvent();
      ...
      if (*(char *)((int)param_1 + 0x93) != '\0') {
        ...
        g_replayEventCursor = g_replayEventCursor + 2;
        iVar10 = DAT_005b3484 + 0x3b49c;
        *(short *)(&DAT_00e9aace + iVar13) =
             *(short *)(&DAT_006a7710 + DAT_005b3484) + (short)param_4 + -400;
        g_replayEventCursor = g_replayEventCursor + 2;
        iVar13 = FUN_0040a4d0(iVar10);
        uVar14 = FUN_0040a4d0(iVar13 * 0x224 + 0xebef4 + DAT_005b3484);
        if (uVar14 < 10) {
      ...
      iVar13 = DAT_005b3484;
      if (iVar10 != -1) {
        _DAT_00e9b4e8 = *(undefined2 *)(DAT_005b3484 + 0x4591c + iVar10 * 2);
        pcVar22 = (char *)(iVar10 * 0xd + 0x457f1 + DAT_005b3484);
        ...
        pcVar22 = (char *)FUN_0043dc70(&DAT_00796eec,3000);
        _sprintf(&DAT_00e9b50a,pcVar22,uVar20);
        uVar9 = *(uint *)(DAT_005b3484 + 0x4597c + iVar10 * 4);
        if (999 < uVar9) {
          uVar9 = 999;
        }
        uVar20 = *(undefined4 *)(DAT_005b3484 + 0x4599c + iVar10 * 4);
        pcVar22 = (char *)FUN_0043dc70(&DAT_00796eec,0xbb9);
        _sprintf(&DAT_00e9b58a,pcVar22,uVar9,uVar20);
        iVar13 = *(int *)(DAT_005b3484 + 0x472fc + iVar10 * 4);
        uVar9 = *(int *)(DAT_005b3484 + 0x4731c + iVar10 * 4) + iVar13;
        if (uVar9 == 0) {
          uVar9 = 1;
        }
        uVar9 = (uint)(iVar13 * 100) / uVar9;
        pcVar22 = (char *)FUN_0043dc70(&DAT_00796eec,0xbba);
        _sprintf(&DAT_00e9b60a,pcVar22,uVar9);
        uVar9 = *(uint *)(DAT_005b3484 + 0x4735c + iVar10 * 4);
        if (uVar9 == 0) {
          uVar9 = 1;
        }
        uVar9 = *(uint *)(DAT_005b3484 + 0x4733c + iVar10 * 4) / uVar9;
        pcVar22 = (char *)FUN_0043dc70(&DAT_00796eec,0xbbb);
        _sprintf(&DAT_00e9b68a,pcVar22,uVar9);
        iVar15 = FUN_0040a4d0(iVar10 * 0x448 + 0x477ec + DAT_005b3484);
        iVar12 = FUN_00420650(DAT_005b3484,iVar10,iVar15);
        iVar13 = iVar10 * 0x14 + iVar15;
        iVar11 = *(int *)(DAT_005b3484 + 0x459bc + iVar13 * 4);
        uVar9 = *(int *)(DAT_005b3484 + 0x45c3c + iVar13 * 4) + iVar11;
        if (uVar9 == 0) {
          uVar9 = 1;
        }
        uVar9 = (uint)(iVar11 * 100) / uVar9;
        uVar20 = FUN_0043dc70(&DAT_00796eec,iVar15 + 1000);
        pcVar22 = (char *)FUN_0043dc70(&DAT_00796eec,0xbbc);
        _sprintf(&DAT_00e9b70a,pcVar22,uVar20,uVar9);
        iVar13 = iVar10 * 0x14 + iVar12;
        iVar10 = *(int *)(DAT_005b3484 + 0x459bc + iVar13 * 4);
        uVar9 = *(int *)(DAT_005b3484 + 0x45c3c + iVar13 * 4) + iVar10;
        if (uVar9 == 0) {
          uVar9 = 1;
        }
        uVar9 = (uint)(iVar10 * 100) / uVar9;
        uVar20 = FUN_0043dc70(&DAT_00796eec,iVar12 + 1000);
        pcVar22 = (char *)FUN_0043dc70(&DAT_00796eec,0xbbd);
      ...
      if (*(int *)(*(int *)(DAT_005b3484 + 0x621e0) + 0x24) == 0xd) {
        return;
      }
      if ((char)param_1[0x468] != '\0') {
        return;
      }
      if ((&DAT_005f2f40)[DAT_005b3484] != '\x02') {
        return;
      }
      if (*(int *)(&DAT_005f3768 + DAT_005b3484) == 1) {
        return;
      }
      if (*(int *)(&DAT_005f3768 + DAT_005b3484) == 2) {
        return;
      }
      *(undefined1 *)(param_1 + 0x468) = 1;
      ...
      uVar7 = FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x90c);
      iVar13 = DAT_005b3484;
...
LAB_004b9bb0:
    ...
    if (param_2 != 0x100) {
      ...
      cVar4 = FUN_004065a0();
      if (cVar4 == '\x01') {
        *(undefined4 *)(DAT_005b3484 + 0xebef0) = 0xfffffffd;
        FUN_00406500(0);
        FUN_00406500(0);
        FUN_00405fb0();
        CreateButtonWidget(&DAT_00e9be90,0,2,0x3ea,s_b_play_weapon2_00554154,0x2f,0x232,0x23,0x22,1,
                           0);
        uVar9 = FUN_0040b2d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xc080,4);
        if (((char)uVar9 == '\0') ||
           (uVar9 = *(uint *)(DAT_005b3484 + 0x621e0), *(short *)(uVar9 + 0xbfbc) != 0)) {
      ...
      cVar4 = FUN_004065a0();
      if (cVar4 == '\0') {
        *(undefined4 *)(DAT_005b3484 + 0xebef0) = 0xffffffe8;
        FUN_00406500(1);
        FUN_00405fb0();
        uVar23 = 6;
        ...
        cVar4 = FUN_0040b2d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xc080,4);
        if (((cVar4 == '\0') &&
            ((cVar4 = FUN_004065a0(), cVar4 != '\x01' ||
             (*(char *)(DAT_005b3484 + 0x45127) != '\x03')))) ||
      ...
      g_replayEventCursor = g_replayEventCursor + 1;
      uVar5 = PacketChecksumEquals(*(int *)(DAT_005b3484 + 0x621e0) + 0x1c54,1);
      (&g_replayEventBuffer)[g_replayEventCursor] = uVar5;
      goto LAB_004b9bb0;
    }
    if (param_3 != 0xd) {
      if (param_3 == 0x1b) {
        ...
        if ((&DAT_006a6481)[DAT_005b3484] != '\0') {
          FUN_00409990(&DAT_006a647c + DAT_005b3484,0);
          return;
        }
        FUN_004f2da0(0,0,0);
        return;
    ...
    if (cVar4 == '\0') {
      FUN_0040c880();
      if ((acStack_80[0] != '\0') && (cVar4 = FUN_004218c0(DAT_005b3484,acStack_80), cVar4 == '\0'))
      {
        ...
        if (cVar4 == '\x01') {
          ...
          cVar4 = FUN_00415230();
          if (cVar4 == '\0') {
            Replay_AppendEvent((*(char *)(DAT_005b3484 + 0xebee5) != '\0') + 0x4002);
            pcVar22 = acStack_80;
            do {
              cVar4 = *pcVar22;
              pcVar22 = pcVar22 + 1;
        ...
        uVar21 = 2;
        iVar13 = *param_1;
        uVar20 = FUN_0043dc70(&DAT_00796eec,uVar20);
...
LAB_004b9e53:
    FUN_00409990(&DAT_006a647c + DAT_005b3484,1);
    return;
  }
  ...
  if ((char)param_1[4] != '\0') {
    if ((((0x233 < param_4 >> 0x10) && (param_4 >> 0x10 < 0x247)) && (0xf5 < uVar9)) &&
       (uVar9 < 0x285)) {
      *(uint *)(DAT_005b3484 + 0xebee8) = uVar9;
    }
  ...
  if ((((char)param_1[0x468] != '\x01') ||
      (cVar4 = FUN_004065a0(), iVar13 = DAT_005b3484, cVar4 == '\0')) ||
     ((cVar4 = FUN_004065a0(), iVar13 = DAT_005b3484, cVar4 == '\0' ||
      ((&DAT_005f2f40)[DAT_005b3484] != '\x02')))) goto LAB_004bb56e;
  *(undefined1 *)(param_1 + 0x468) = 0;
  iVar13 = FUN_0040a4d0(*(int *)(iVar13 + 0x621e0) + 0x7640);
  iVar10 = FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x7864);
  if (iVar10 < iVar13 * 10) {
    iVar13 = FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x7864);
  }
  else {
    iVar13 = FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x7640);
    iVar13 = iVar13 * 10;
  }
  QueueOutgoingPacketField(iVar13);
  FUN_0043c860(&DAT_006a7f70 + DAT_005b3484,*(undefined4 *)(DAT_005b3484 + 0x621e0));
  cVar4 = FUN_004065a0();
  if (cVar4 == '\x01') {
    cVar4 = FUN_004065a0();
    if (cVar4 == '\0') {
...
LAB_004bafd2:
    ...
    cVar4 = FUN_0041eaa0(DAT_005b3484,*(undefined2 *)(*(int *)(DAT_005b3484 + 0x621e0) + 0xbfbc));
  ...
  *(undefined2 *)(&g_replayEventBuffer + g_replayEventCursor) = uVar7;
  ...
  if (cVar4 == '\0') {
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x9cf0);
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x51d8);
  }
  else {
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x51d8);
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x9cf0);
  }
  FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x9f14);
  FUN_004ead90();
  uVar7 = FUN_0053753c();
  FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x9f14);
  FUN_004ead70();
  ...
  *puVar2 = uVar8;
  ...
  cVar4 = PacketChecksumEquals(*(int *)(iVar13 + 0x621e0) + 0x1c54,0);
  if (cVar4 == '\0') {
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xa138);
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x51d8);
  }
  else {
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x51d8);
  ...
  FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xa35c);
  FUN_004ead90();
  uVar7 = FUN_0053753c();
  FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xa35c);
  FUN_004ead70();
  ...
  *puVar2 = uVar8;
  ...
  cVar4 = PacketChecksumEquals(*(int *)(iVar13 + 0x621e0) + 0x1c54,0);
  if (cVar4 == '\0') {
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xa9c8);
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x51d8);
  }
  else {
    FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x51d8);
  ...
  FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xabec);
  FUN_004ead90();
  uVar7 = FUN_0053753c();
  FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0xabec);
  FUN_004ead70();
  ...
  *puVar3 = 0;
  ...
  FUN_0043d6d0();
  Replay_FlushEvent();
  FUN_0040a4d0(*(int *)(DAT_005b3484 + 0x621e0) + 0x7864);
  FUN_004ee200();
  FUN_00406500(0);
  FUN_00406500(0);
  QueueOutgoingPacketField(0xffffffff);
