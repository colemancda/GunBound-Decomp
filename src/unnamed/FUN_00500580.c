...
undefined4 * FUN_00500580(int param_1,undefined4 param_2)

{
  ...
  if (unaff_EBX[0xb] == 0) {
    piVar3 = _malloc(unaff_EBX[9] * 0x1c + 4);
    if (piVar3 == (int *)0x0) {
