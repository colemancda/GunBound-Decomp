...

{
  ...
  *unaff_FS_OFFSET = &local_c;
  ...
  local_15b1 = '\0';
  local_15a8 = param_1;
  FUN_0040b180(local_15a0,local_1574,8);
  local_4 = 0;
  ...
  uVar10 = FUN_0040aca0(local_15a0,local_112c,param_1 + 0x488);
  local_4 = 2;
  ...
  uVar10 = FUN_0040aca0(local_158c,local_1574,local_15a8 + 0x6ac);
  local_4 = 4;
  FUN_0040b180(uVar10,local_112c,8);
  local_4 = 5;
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    ...
    if (0 < local_15b0[0]) {
      ...
      do {
        ...
        if ((local_15b1 == '\0') && (iVar11 = FUN_004510f0(local_15c0), iVar11 != 0)) {
          FUN_0040a5f0(iVar9,local_f08,param_2);
          local_4 = 6;
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar11 = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          if (iVar11 < 0x14) {
LAB_00485c3d:
            FUN_0040a5f0(iVar9,local_454,param_2);
            local_4 = 8;
            bVar3 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            iVar11 = PeekPacketChecksumState();
            ...
            if (iVar11 < 0x14) {
              ...
              FUN_0040a5f0(iVar9,local_89c,param_2);
              local_4 = 9;
              bVar3 = true;
              bVar2 = true;
              EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            ...
            FUN_0040a5f0(iVar9,local_1350,param_2);
            local_4 = 7;
            bVar4 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            iVar11 = PeekPacketChecksumState();
        ...
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        if (local_15b2 != 0) {
          local_1580[0] = FUN_0040b180(iVar9 + 0x6ac,local_ce4,8);
          local_4 = 10;
          local_1594[0] = FUN_0040b180(iVar9 + 0x488,local_ac0,8);
          local_4 = 0xb;
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          local_1580[0] = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        ...
        if (iVar11 < 0) {
LAB_0048631a:
          iVar13 = *(int *)(&DAT_006a7720 + DAT_005b3484) + -1;
          iVar12 = iVar13;
          if (iVar11 <= iVar13) {
            iVar12 = iVar11;
          }
          ...
          iVar11 = *(int *)(&DAT_006a7724 + DAT_005b3484) + -1;
          iVar12 = iVar11;
          if (iVar9 <= iVar11) {
            iVar12 = iVar9;
          }
...
LAB_00486e6e:
        ...
        if ((((iVar11 < *(int *)(&DAT_006a7720 + DAT_005b3484)) && (-1 < iVar9)) &&
            (iVar9 < *(int *)(&DAT_006a7724 + DAT_005b3484))) &&
           (*(char *)(*(int *)(&DAT_006a7720 + DAT_005b3484) * iVar9 +
                      *(int *)(&DAT_006a773c + DAT_005b3484) + iVar11) != '\0')) {
        ...
        if (((*(int *)(&DAT_006a7720 + DAT_005b3484) + -1 < iVar11) || (iVar9 < -0x113)) ||
           (*(int *)(&DAT_006a7724 + DAT_005b3484) + -1 < iVar9)) goto LAB_0048631a;
    ...
    if (0 < local_1594[0]) {
      ...
      do {
        ...
        if ((local_15b1 == '\0') && (iVar11 = FUN_004510f0(local_15c0), iVar11 != 0)) {
          local_15b0[0] = FUN_0040a5f0(iVar9,local_1350,param_2);
          local_4 = 0xc;
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_0048661d:
            local_15b0[0] = FUN_0040a5f0(iVar9,local_ac0,param_2);
            local_4 = 0xe;
            bVar6 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            local_15b0[0] = PeekPacketChecksumState();
            ...
            if (local_15b0[0] < 0x14) {
              ...
              FUN_0040a5f0(iVar9,local_ce4,param_2);
              local_4 = 0xf;
              bVar6 = true;
              bVar5 = true;
              EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            ...
            local_15b0[0] = FUN_0040a5f0(iVar9,local_f08,param_2);
            local_4 = 0xd;
            bVar7 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            local_15b0[0] = PeekPacketChecksumState();
        ...
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        if (local_15b2 != 0) {
          FUN_0040b180(iVar9 + 0x6ac,local_230,8);
          local_4 = 0x10;
          local_15b0[0] = FUN_0040b180(iVar9 + 0x488,local_678,8);
          local_4 = 0x11;
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar11 = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_00486cde:
          ...
          iVar9 = *(int *)(&DAT_006a7724 + DAT_005b3484) + -1;
          iVar12 = iVar9;
          if (iVar11 <= iVar9) {
            iVar12 = iVar11;
          }
...
LAB_00486e42:
        ...
        if ((((iVar9 < *(int *)(&DAT_006a7720 + DAT_005b3484)) && (-1 < iVar11)) &&
            (iVar11 < *(int *)(&DAT_006a7724 + DAT_005b3484))) &&
           (*(char *)(iVar11 * *(int *)(&DAT_006a7720 + DAT_005b3484) +
                      *(int *)(&DAT_006a773c + DAT_005b3484) + iVar9) != '\0')) {
        ...
        if (((*(int *)(&DAT_006a7720 + DAT_005b3484) + -1 < iVar9) || (iVar11 < -0x113)) ||
           (*(int *)(&DAT_006a7724 + DAT_005b3484) + -1 < iVar11)) goto LAB_00486cde;
        local_1588 = local_1588 + param_2;
