...

{
  ...
  *unaff_FS_OFFSET = &local_c;
  local_688[0] = 0;
  uVar2 = EncodeChecksumDeltaSub(param_1 + 0x3c,local_678,*(undefined4 *)(&DAT_006a7710 + g_clientContext));
  local_4 = 0;
...
LAB_004716eb:
  ...
  if (!bVar1) {
    ...
    if (iVar4 != 0) {
      uVar8 = *(uint *)(param_1 + 0x484) & 0x8000001f;
      if ((int)uVar8 < 0) {
        uVar8 = (uVar8 - 1 | 0xffffffe0) + 1;
      }
      iVar4 = uVar8 * -2;
      local_688[0] = *(uint *)(param_1 + 0x484) & 0x80000007;
      ...
      if (iVar4 < *(int *)(&DAT_006a7724 + g_clientContext)) {
        ...
        do {
          ...
          if (DAT_00793534 <= iVar6) {
            ...
            _DAT_00ea0e3c = (float)(int)uVar8 * _DAT_00557fb8 + _DAT_0054c870;
            _DAT_00ea0e40 = (float)((int)local_688[0] / 2) * _DAT_00558054 + _DAT_0054c870;
            _DAT_00ea0e60 = (_DAT_00ea0e3c + _DAT_00557fb8) - _DAT_0054bb4c;
            _DAT_00ea0e88 = (_DAT_00ea0e40 + _DAT_00558054) - _DAT_0054bb4c;
            puVar9 = &DAT_00ea0e28;
            puVar10 = puVar7 + -0x1b;
