  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  if (cVar2 == '\0') {
    ...
    if (cVar2 == '\0') {
      ...
      uVar7 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_680,4);
      uStack_c = 7;
      uVar7 = FUN_0040aca0(param_1[0x3d2] + 0x38,auStack_45c,uVar7);
      uStack_c = 8;
      unaff_EBX = 3;
      cVar2 = FUN_0040b490(param_1 + 0x3d5,uVar7);
      if (cVar2 == '\0') {
        uVar7 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_8a4,4);
        uStack_c = 9;
        uVar7 = FUN_0040aba0(param_1[0x3d2] + 0x38,&iStack_ac8,uVar7);
        uStack_c = 10;
        unaff_EBX = 0xf;
        cVar2 = FUN_0040b490(uVar7,param_1 + 0x3d5);
        bVar20 = false;
...
LAB_00483427:
    ...
    if ((char)(unaff_EBX >> 0x18) == '\0') {
      ...
      if (((iVar4 <= iVar5) ||
          ...
          cVar2 != '\0')) || (cVar2 = FUN_0040b330(param_1 + 0x45e,0xfffffc18), cVar2 != '\0'))
      goto LAB_004835e2;
    }
    else {
LAB_004835e2:
    ...
    if (cVar2 != '\0') {
      ...
      (*pcVar18)(&DAT_005a9068);
      iVar4 = DAT_005b3484;
      piVar11 = (int *)(&DAT_006a7708 + DAT_005b3484);
      cVar2 = FUN_004065a0();
      if ((cVar2 == '\0') && ((&DAT_006a7758)[iVar4] != '\0')) {
        if (((&DAT_006a7736)[iVar4] == '\x01') &&
           ((uVar15 = iVar5 - *(int *)(&DAT_006a7714 + iVar4) >> 0x1f,
            ...
            (uVar15 = iVar16 - *(int *)(&DAT_006a7710 + iVar4) >> 0x1f,
            300 < (int)((iVar16 - *(int *)(&DAT_006a7710 + iVar4) ^ uVar15) - uVar15))))) {
        ...
        iVar13 = *(int *)(&DAT_006a7720 + iVar4) + -400;
  ...
  *(undefined1 *)(param_1 + 5) = 1;
  ...
  if ((-1 < iVar4) && (iVar4 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
    pcVar6 = (char *)(*(int *)(&DAT_006a773c + DAT_005b3484) + iVar4);
    iStack_af4 = 0;
    if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
      do {
        if (*pcVar6 != '\0') goto LAB_0048268a;
        pcVar6 = pcVar6 + *(int *)(&DAT_006a7720 + DAT_005b3484);
        iStack_af4 = iStack_af4 + 1;
      } while (iStack_af4 < *(int *)(&DAT_006a7724 + DAT_005b3484));
    }
  }
  iStack_af4 = 10000;
LAB_0048268a:
  ...
  uVar7 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar7,iStack_af4);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar7 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  ...
  if (cVar2 != '\0') {
    ...
    if ((cVar2 == '\0') && ((&DAT_006a7758)[iVar4] != '\0')) {
      if (((&DAT_006a7736)[iVar4] == '\x01') &&
         ((uVar15 = iStack_af4 - *(int *)(&DAT_006a7714 + iVar4) >> 0x1f,
          200 < (int)((iStack_af4 - *(int *)(&DAT_006a7714 + iVar4) ^ uVar15) - uVar15) ||
          (uVar15 = iVar5 - *(int *)(&DAT_006a7710 + iVar4) >> 0x1f,
          300 < (int)((iVar5 - *(int *)(&DAT_006a7710 + iVar4) ^ uVar15) - uVar15))))) {
        (&DAT_006a7736)[iVar4] = 0;
      }
      iVar16 = iVar5;
      if (iVar5 < 400) {
      ...
      if ((*(int *)(&DAT_006a7720 + iVar4) + -400 < iVar16) ||
      ...
      iVar16 = *(int *)(&DAT_006a7724 + iVar4) + -0x104;
      if ((iVar5 <= *(int *)(&DAT_006a7724 + iVar4) + -0x104) &&
         (iVar16 = iStack_af4, iStack_af4 < -0x14)) {
        iVar16 = -0x14;
      }
      *(int *)(&DAT_006a771c + iVar4) = iVar16;
      iVar5 = *piVar11 - (int)puStack_ae0;
      if (((*(int *)(&DAT_006a770c + iVar4) - iVar16) * (*(int *)(&DAT_006a770c + iVar4) - iVar16) +
           iVar5 * iVar5 < 40000) &&
         (((&DAT_006a7734)[iVar4] == '\x01' || ((&DAT_006a7f6c)[iVar4] == '\0')))) {
        *(undefined4 **)(&DAT_006a7710 + iVar4) = puStack_ae0;
        *piVar11 = (int)puStack_ae0;
        *(int *)(&DAT_006a7714 + iVar4) = iVar16;
      ...
      if ((((&DAT_006a7734)[iVar4] == '\0') && ((&DAT_006a7f6c)[iVar4] == '\x01')) &&
        ...
        *(undefined4 **)(&DAT_006a7718 + iVar4) = puVar17;
      }
      if ((&DAT_006a7734)[iVar4] == '\x01') {
        *(undefined4 **)(&DAT_006a7718 + iVar4) = puStack_ae0;
        *(int *)(&DAT_006a771c + iVar4) = iVar16;
      }
    }
  }
  ...
  if (iVar5 == 4) {
    ...
    if (puStack_ae0 == (undefined4 *)0x0) {
      ...
      FUN_00454dc0(puStack_ae0,0x186a9);
...
LAB_00482b76:
    if (bVar20) {
      ...
      if (cVar2 == '\0') {
        ...
        uVar9 = 100;
        uVar8 = 0;
        FUN_004065a0(uVar7,0,100,0xff,iVar4,0);
...
LAB_00482e3e:
        ...
        cVar2 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&piStack_ad4,&uStack_ad8,2,1,1);
        if (cVar2 != '\0') {
          auStack_8a4[0] = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
          ...
          uVar7 = FUN_0040a4d0(auStack_ac4);
          FUN_004065a0(uVar7,uVar8,uVar9,uVar21,iVar4,uVar22);
          FUN_00432320((char)param_1[0xf],1,1,uVar7,uVar8,uVar9,uVar21,iVar4,uVar22);
...
LAB_00482edf:
  ...
  uVar9 = 1;
  uVar8 = 0;
  FUN_004065a0(0,uVar7,uVar15,1,0);
  ...
  iVar5 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  cVar2 = FUN_00406610(iVar4 < iVar5);
  if (cVar2 != '\0') {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uVar7 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar7);
...
LAB_0048305d:
  ...
  iVar5 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  if ((iVar5 <= iVar4) || (cVar2 = FUN_0040b490(param_1 + 0xed2,param_1 + 0xf5b), cVar2 == '\0')) {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    iVar4 = PeekPacketChecksumState();
    iVar5 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
