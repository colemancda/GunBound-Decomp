...
LAB_00495f90:
  ...
  (*pcVar18)();
  uVar5 = FUN_0040aca0(param_1 + 0x10,auStack_cf4,param_1 + 0x10fb);
  uStack_14 = 2;
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  ...
  FUN_0040aca0(param_1 + 0x99,&local_cf8,param_1 + 0x1184);
  uStack_18 = 3;
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar6 = PeekPacketChecksumState();
  EncodeOutgoingPacketField(uVar6);
...
LAB_004974a8:
    ...
    if (cVar2 != '\0') {
      ...
      (*pcVar18)(&DAT_005a9068);
      iVar4 = DAT_005b3484;
      piVar29 = (int *)(&DAT_006a7708 + DAT_005b3484);
      cVar2 = FUN_004065a0();
...
LAB_004964ea:
    ...
    uVar6 = PeekPacketChecksumState();
    (*pcVar18)(&DAT_005a9068);
    FUN_00436070(&DAT_006a7f70 + DAT_005b3484,puVar26,uVar6);
  ...
  if (cVar3 == '\0') {
    ...
    iVar13 = *(int *)(*(int *)(&DAT_006a7f8c + DAT_005b3484) + 0x1c);
...
LAB_00496a28:
        ...
        cVar3 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&stack0xfffff2e0,&stack0xfffff2dc,2,1,1);
        puVar27 = puVar26;
        if (cVar3 != '\0') {
          uStack_afc = 0;
          uStack_d08 = 0;
