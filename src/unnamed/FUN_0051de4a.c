/* FUN_0051de4a - 0x0051de4a in the original binary.
 *
...
FUN_0051de4a(undefined4 param_1,undefined4 param_2,int param_3,undefined4 param_4,int param_5)

{
  ...
  do {
    ...
    ((undefined2 *)(param_5 + 0x10))[iVar19] = (short)DAT_00568940;
    iVar19 = iVar19 + 1;
  ...
  *(undefined2 *)(param_5 + 0x10) = (short)DAT_00568940;
  ...
  do {
    ...
    *(short *)(param_5 + 0x20 + iVar19 * 2) = (short)iVar18;
    iVar19 = iVar19 + 1;
  } while (iVar19 != 0);
