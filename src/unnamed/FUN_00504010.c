/* FUN_00504010 - 0x00504010 in the original binary.
 *
 ...
 * around FUN_00504030.  ECX is a phantom (`mov ecx,7` before any read) so the
...
void __fastcall FUN_00504010(undefined4 param_1,undefined4 *param_2,undefined4 *regEax,
                             undefined4 *regEbx)
