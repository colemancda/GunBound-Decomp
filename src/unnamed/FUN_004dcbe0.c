/* FUN_004dcbe0 - 0x004dcbe0 in the original binary.
 *
...

{
  ...
  *(int *)(param_1 + 0x740) = *(int *)(param_1 + 0x740) + 1;
  ...
  bVar1 = *(byte *)(DAT_005b3484 + 0x475c4);
  local_4 = 0xffffffff;
  if (local_21c != 0) {
    FUN_0040a240();
  ...
  case 2:
    iVar5 = (uint)*(byte *)(DAT_005b3484 + 0x475c4) * 0x7d28;
    FUN_004e3d60(&DAT_006a7708 + DAT_005b3484,iVar5 + 0x1a1ec8 + DAT_005b3484);
    FUN_004dfce0(param_1);
    _sprintf((char *)((int)&uStack_331 + 1),(char *)&PTR_DAT_00555500,
             iVar5 + 0x1a1ec8 + DAT_005b3484);
    AppendPersistentButtonName(&DAT_0067ec70 + DAT_005b3484);
    uVar4 = FindPreloadedTextureByName((int)&uStack_331 + 1);
    *(undefined4 *)(&DAT_006a7f70 + DAT_005b3484) = uVar4;
    puVar2 = &uStack_331;
    do {
      puVar7 = puVar2;
    ...
    *(undefined1 *)((int)puVar7 + 5) = DAT_005554fc;
    ...
    DAT_00793634 = FUN_0040a4d0(((uint)bVar1 + iVar6) * 0x7d28 + 0x1a328c + DAT_005b3484);
    break;
  case 3:
    FUN_004e4010((uint)*(byte *)(DAT_005b3484 + 0x475c4) * 0x7d28 + 0x1a1ec8 + DAT_005b3484);
    break;
  case 4:
    FUN_004e3c50(&DAT_006a7708 + DAT_005b3484);
    if (*(ushort *)(&DAT_006aa660 + DAT_005b3484) != 0xffff) {
      _sprintf(local_2b0,s_event14__d_img_005554e8,*(ushort *)(&DAT_006aa660 + DAT_005b3484) + 1);
      FUN_004f1790(&DAT_00ea0e18,0x271a);
    }
    break;
  case 5:
    cVar3 = FUN_0041c2c0(DAT_005b3484,0);
    if (cVar3 != '\0') {
  ...
  case 7:
    ...
    break;
  case 8:
    cVar3 = FUN_0041c2c0(DAT_005b3484,1);
    if (cVar3 != '\0') {
  ...
  case 10:
    ...
    break;
  case 0xb:
    cVar3 = FUN_0041c2c0(DAT_005b3484,2);
    if (cVar3 != '\0') {
  ...
  case 0xd:
    ...
    break;
  case 0xe:
    cVar3 = FUN_0041c2c0(DAT_005b3484,3);
    if (cVar3 != '\0') {
  ...
  case 0x10:
    ...
    break;
  case 0x11:
    cVar3 = FUN_0041c2c0(DAT_005b3484,4);
    if (cVar3 != '\0') {
  ...
  case 0x13:
    ...
    break;
  case 0x14:
    cVar3 = FUN_0041c2c0(DAT_005b3484,5);
    if (cVar3 != '\0') {
  ...
  case 0x16:
    ...
    break;
  case 0x17:
    cVar3 = FUN_0041c2c0(DAT_005b3484,6);
    if (cVar3 != '\0') {
  ...
  case 0x19:
    ...
    break;
  case 0x1a:
    cVar3 = FUN_0041c2c0(DAT_005b3484,7);
    if (cVar3 != '\0') {
  ...
  case 0x1c:
    ...
    break;
  case 0x1d:
    cVar3 = FUN_0041c2c0(DAT_005b3484,8);
    if (cVar3 != '\0') {
  ...
  case 0x1f:
    ...
    break;
  case 0x20:
    cVar3 = FUN_0041c2c0(DAT_005b3484,9);
    if (cVar3 != '\0') {
  ...
  case 0x22:
    ...
    break;
  case 0x23:
    cVar3 = FUN_0041c2c0(DAT_005b3484,10);
    if (cVar3 != '\0') {
  ...
  case 0x25:
    ...
    break;
  case 0x26:
    cVar3 = FUN_0041c2c0(DAT_005b3484,0xb);
    if (cVar3 != '\0') {
  ...
  case 0x28:
    ...
    break;
  case 0x29:
    cVar3 = FUN_0041c2c0(DAT_005b3484,0xc);
    if (cVar3 != '\0') {
  ...
  case 0x31:
    ...
    break;
  case 0x32:
    cVar3 = FUN_0041c2c0(DAT_005b3484,0xf);
    if (cVar3 != '\0') {
  ...
  case 0x3b:
    ...
    break;
  case 0x3c:
    if (*(char *)(DAT_005b3484 + 0x5010d) != '\0') {
      FUN_004dc5c0();
    }
    break;
  case 0x3d:
    if (*(char *)(DAT_005b3484 + 0x5010e) != '\0') {
      FUN_004dc5c0();
    }
    break;
  case 0x3e:
    if (*(char *)(DAT_005b3484 + 0x5010f) != '\0') {
      FUN_004dc5c0();
    }
    break;
  case 0x3f:
    if (*(char *)(DAT_005b3484 + 0x50110) != '\0') {
      FUN_004dc5c0();
    }
    break;
  case 0x40:
    if (*(char *)(DAT_005b3484 + 0x50111) != '\0') {
      FUN_004dc5c0();
    }
    break;
  case 0x41:
    if (*(char *)(DAT_005b3484 + 0x50112) != '\0') {
      FUN_004dc5c0();
    }
    break;
  case 0x42:
    if (*(char *)(DAT_005b3484 + 0x50113) != '\0') {
      FUN_004dc5c0();
    }
    break;
  case 0x43:
    if (*(char *)(DAT_005b3484 + 0x50114) != '\0') {
      FUN_004dc5c0();
    }
    break;
  case 0x44:
  ...
  case 0x45:
    ...
    cVar3 = PacketChecksumEquals(DAT_005b3484 + 0x45354,3);
    if (cVar3 != '\0') {
  ...
  if (*(int *)(param_1 + 0x744) == -1) {
    iVar6 = 0;
    do {
      if ((*(char *)(DAT_005b3484 + 0x45914 + iVar6) != '\0') &&
         (*(char *)(DAT_005b3484 + 0x449ba + iVar6) == '\0')) goto LAB_004dfad9;
      iVar6 = iVar6 + 1;
    } while (iVar6 < 8);
