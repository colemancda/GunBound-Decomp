/* FUN_00452bf0 - 0x00452bf0 in the original binary.
 *
...

{
  ...
  if (cVar1 != '\0') {
    ...
    /* FIXED (2026-07-15): dropped `self` arg - angr-confirmed at 0x452c33
  ...
  if (iVar2 + 1 == 5) {
    ...
    /* FIXED (2026-07-15): dropped `self` arg - angr-confirmed at 0x452c6c
