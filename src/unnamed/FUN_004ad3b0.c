  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  if (cVar1 != '\0') {
    ...
    if (cVar1 != '\0') {
      ...
      iVar2 = PeekPacketChecksumState();
      LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      if ((-1 < iVar2) && (iVar2 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
        pcVar4 = (char *)(*(int *)(&DAT_006a773c + DAT_005b3484) + iVar2);
        puStack_af0 = (undefined4 *)0x0;
        if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
          do {
            if (*pcVar4 != '\0') goto LAB_004ad512;
            pcVar4 = pcVar4 + *(int *)(&DAT_006a7720 + DAT_005b3484);
...
LAB_004ad512:
      ...
      LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar5,puStack_af0);
      local_aec = 1;
      if (0 < param_1[0xfe5]) {
...
LAB_004adaf2:
  ...
  if (cVar1 == '\0') {
    ...
    uVar5 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_680,4);
    uStack_c = 7;
    uVar5 = FUN_0040aca0(param_1[0x3d2] + 0x38,auStack_45c,uVar5);
    uStack_c = 8;
    unaff_EBX = 3;
    cVar1 = FUN_0040b490(param_1 + 0x3d5,uVar5);
    if (cVar1 == '\0') {
      uVar5 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_8a4,4);
      uStack_c = 9;
      uVar5 = FUN_0040aba0(param_1[0x3d2] + 0x38,auStack_ac8,uVar5);
      uStack_c = 10;
      unaff_EBX = 0xf;
...
LAB_004add3c:
  ...
  if ((char)(unaff_EBX >> 0x18) == '\0') {
    ...
    (*pcVar11)(&DAT_005a9068);
    if (((iVar2 <= iVar3) ||
        (cVar1 = FUN_0040b300(param_1 + 0x45e,*(undefined4 *)(&DAT_006a7724 + DAT_005b3484)),
...
LAB_004adef8:
    *(undefined1 *)(param_1 + 5) = 1;
    ...
    if ((cVar1 != '\0') && (cVar1 = FUN_0043a530(), cVar1 == '\0')) {
      iVar2 = *(int *)(*(int *)(DAT_005b3484 + 0x621e4) + 0x24);
  ...
  if (cVar1 != '\0') {
    ...
    (*pcVar11)(&DAT_005a9068);
    iVar2 = DAT_005b3484;
    piVar12 = (int *)(&DAT_006a7708 + DAT_005b3484);
    cVar1 = FUN_004065a0();
...
LAB_004ad793:
    if (bVar13) {
      ...
      if (cVar1 == '\0') {
        ...
        uVar15 = 100;
        uVar14 = 0;
        FUN_004065a0(uVar5,0,100,0xff,iVar9,0);
...
LAB_004ada51:
        ...
        cVar1 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&uStack_ad8,&uStack_adc,2,1,1);
        if (cVar1 != '\0') {
          auStack_8a4[0] = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
          ...
          FUN_004065a0(uVar5,uVar14,uVar15,uVar16,iVar9,uVar17);
          FUN_00432320((char)param_1[0xf],1,1,uVar5,uVar14,uVar15,uVar16,iVar9,uVar17);
