 ...
 * EDX is read before anything writes it. Its one caller Vector_Insert_34
 ...
 * src/unnamed/Vector_UninitFillN_34.c and src/unnamed/Vector_UninitCopy_34.c.
 *
 * The three Vector_UninitCopy_34 calls are the three halves of an insert:
 ...
 * Vector_UninitFillN_34 uses as its own destination, a value the port
 * discarded.
 */
...

{
  ...
  *unaff_FS_OFFSET = &local_10;
  Vector_CopyElement_34(0,regEdx,(undefined4 *)local_50);
  iVar2 = *(int *)(param_2 + 4);
  if (iVar2 == 0) {
    uVar5 = 0;
  }
  ...
  if (param_1 != 0) {
    ...
    if (uVar5 < iVar1 + param_1) {
      ...
      local_8 = 0;
      iDestEnd = Vector_UninitCopy_34(*(int *)(param_2 + 4),0,param_3,(int)pvVar3,param_3);
      Vector_UninitFillN_34(iDestEnd,0,param_3,param_1,(undefined4 *)local_50);
      Vector_UninitCopy_34(param_3,0,param_3,iDestEnd + param_1 * 0x34,*(int *)(param_2 + 8));
    ...
    if ((uint)((*(int *)(param_2 + 8) - param_3) / 0x34) < param_1) {
      Vector_UninitCopy_34(param_3,0,param_3,param_3 + param_1 * 0x34,*(int *)(param_2 + 8));
      local_8 = 2;
      Vector_UninitFillN_34(*(int *)(param_2 + 8),0,param_3,
                   param_1 - (*(int *)(param_2 + 8) - param_3) / 0x34,(undefined4 *)local_50);
      *(uint *)(param_2 + 8) = *(int *)(param_2 + 8) + param_1 * 0x34;
    }
    else {
      uVar4 = Vector_UninitCopy_34(*(int *)(param_2 + 8) - param_1 * 0x34,0,param_3,
