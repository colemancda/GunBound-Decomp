...
LAB_004af8b0:
  ...
  uVar5 = FUN_0040aca0(param_1 + 0x10,&local_cfc,param_1 + 0x1140);
  uStack_1c = 2;
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  ...
  FUN_0040aca0(param_1 + 0x99,&local_d00,param_1 + 0x11c9);
  uStack_20 = 3;
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar6 = PeekPacketChecksumState();
  EncodeOutgoingPacketField(uVar6);
  ...
  if (cVar2 == '\0') {
    ...
    if (cVar24 == '\0') {
      ...
      if ((int)((uVar16 ^ (int)uVar16 >> 0x1f) - ((int)uVar16 >> 0x1f)) < 200) {
        cVar24 = FUN_0040b330(param_1 + 0x122,0);
        if (cVar24 == '\0') {
          uVar5 = 200;
        }
        else {
      ...
      uStack_40 = 0xb;
      uVar5 = FUN_0040aca0(param_1[0x3d2] + 0x38,auStack_6b4,uVar5);
      uStack_40 = 0xc;
      uVar16 = 3;
      cVar24 = FUN_0040b490(param_1 + 0x3d5,uVar5);
      if (cVar24 == '\0') {
        ...
        uStack_40 = 0xe;
        uVar16 = 0xf;
        cVar24 = FUN_0040b490(uVar5,param_1 + 0x3d5);
        bVar23 = false;
...
LAB_004b0dc8:
  ...
  if (cVar2 != '\0') {
    ...
    iVar4 = PeekPacketChecksumState();
    (*pcVar20)(&DAT_005a9068);
    FUN_00436070(&DAT_006a7f70 + DAT_005b3484,puVar28,iVar4);
...
LAB_004b039b:
        ...
        cVar3 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&stack0xfffff2d8,&stack0xfffff2c8,2,1,1);
        if (cVar3 != '\0') {
          uStack_b04 = 0;
          local_d10 = 0;
          EncodeOutgoingPacketField(0);
