 ...
 * (0x423eff-0x423f17): `mov edi,[esp+0x118]` (= this function's own
 * param_1) / `add edi,0xf6e8` (archive = param_1 + 0xf6e8, the same
 * per-session archive FUN_00423bf0.c resolves at g_clientContext + 0xf6e8 -
