/* FUN_0052a7aa - 0x0052a7aa in the original binary.
 *
...
LAB_0052a8b6:
    ...
    if ((uVar1 & 1) != 0) {
      _File->_cnt = 0;
      if ((uVar1 & 0x10) == 0) goto LAB_0052a8b6;
    ...
    if (((uVar1 & 0x10c) == 0) &&
       (((_File_00 != (FILE *)&DAT_0056c5f0 && (_File_00 != (FILE *)&DAT_0056c610)) ||
    ...
    if ((_File_00->_flag & 0x108) == 0) {
      ...
      if ((int)_MaxCharCount < 1) {
        if (_FileHandle == 0xffffffff) {
          ...
          puVar4 = (undefined *)
                   ((&DAT_00f28320)[(int)_FileHandle >> 5] + (_FileHandle & 0x1f) * 0x24);
        }
        if ((puVar4[4] & 0x20) != 0) {
