...
void __fastcall FUN_004eb640(undefined4 param_1,int param_2,undefined2 param_3)

{
  ...
  if (((DAT_0079352c != 0) && (unaff_EDI <= DAT_0056df34)) && (DAT_00793534 <= unaff_EDI)) {
    ...
    if (0 < param_2) {
      FUN_004f2740(DAT_0079352c + (DAT_005b3620 * unaff_EDI + in_EAX) * 2,param_3,param_2);
    }
  }
  return;
}
