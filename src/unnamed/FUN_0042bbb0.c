...
LAB_0042c334:
  ...
  if (*(char *)(DAT_005b3484 + 0x45578) == '\0') {
    ...
    local_8b8[7] = iVar6;
    local_8b8[0xe26] = s_flameevent1_00553e2c._0_4_;
    local_8b8[0xe27] = s_flameevent1_00553e2c._4_4_;
    local_8b8[0xe28] = s_flameevent1_00553e2c._8_4_;
  }
  ...
  *(byte *)(local_8b8 + 0xf) = unaff_retaddr & 7;
  ...
  uStack_8b4 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uStack_8b4 = FUN_0040a8c0(uStack_8a8,auStack_67c,uStack_8b4);
  ...
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar4 = uStack_668;
  puStack_8 = (undefined1 *)CONCAT31(puStack_8._1_3_,0x21);
  if (uStack_668 != 0) {
    FUN_0040a240();
    uStack_8b4 = uVar4;
  ...
  uStack_8b4 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  FUN_0040a8c0(uVar8,auStack_8a0,uStack_8b4);
  ...
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar4 = uStack_88c;
  puStack_8 = (undefined1 *)CONCAT31(puStack_8._1_3_,0x23);
  if (uStack_88c != 0) {
    FUN_0040a240();
    uStack_8b4 = uVar4;
    FUN_0040b540(&uStack_8a8);
  ...
  *(byte *)((int)local_8bc + 0xf47) = bVar12 + *(char *)((int)local_8bc + 0xf45) + -0x34;
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  FUN_004064a0(param_10);
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  EncodeOutgoingPacketField(param_9);
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  FUN_004064a0(param_4);
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_0042d20d:
    ...
    fStack_8ac = (float)CONCAT31(fStack_8ac._1_3_,1);
    if (0x6e < param_7) goto LAB_0042d20d;
  }
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  FUN_004064a0(fStack_8ac);
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_0042d56e:
    ...
    uStack_8b0 = CONCAT31(uStack_8b0._1_3_,1);
  }
  else {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    iVar6 = PeekPacketChecksumState();
...
LAB_0042d667:
  ...
  if ((iVar6 != 0) && (cVar5 = FUN_004065a0(), cVar5 != '\0')) {
    ...
    uVar8 = FUN_0040a8c0(local_8bc + 0x9b9,auStack_8a0,4);
    ...
    uVar8 = FUN_0040a8c0(local_8bc + 0xa42,auStack_8a0,4);
  ...
  if (cVar5 == '\x01') {
    ...
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    puStack_8 = (undefined1 *)CONCAT31(puStack_8._1_3_,0x28);
    if (uStack_88c != 0) {
      FUN_0040a240();
      FUN_0040b540(&uStack_8b4);
    }
    ...
    uVar8 = FUN_0040a7d0(local_8bc + 0x9b9,auStack_67c,3);
    ...
    EncodeOutgoingPacketField(iVar9 + iVar6);
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    puStack_8 = (undefined1 *)CONCAT31(puStack_8._1_3_,0x2a);
    if (uStack_88c != 0) {
      FUN_0040a240();
      FUN_0040b540(&uStack_8b4);
    }
    ...
    uVar8 = FUN_0040a7d0(local_8bc + 0xa42,auStack_67c,3);
    ...
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    puStack_8 = (undefined1 *)CONCAT31(puStack_8._1_3_,0x2c);
    if (uStack_88c != 0) {
      FUN_0040a240();
      FUN_0040b540(&uStack_8b4);
      uVar7 = uStack_88c;
  ...
  if (cVar5 != '\0') {
    ...
    (*pcVar15)(&DAT_005a9068);
    uVar8 = FUN_0040a7d0(uVar7 + 0x24c0,&puStack_680,uVar8);
    uStack_c = 0x2e;
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    PeekPacketChecksumState();
    puVar18 = &DAT_005a9068;
    (*pcVar15)(&DAT_005a9068);
    FUN_0040a8c0(uVar8,&uStack_8a8,unaff_ESI);
    uStack_10 = CONCAT31(uStack_10._1_3_,0x2f);
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uVar8 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar8);
    (*pcVar15)(&DAT_005a9068);
    ...
    (*pcVar15)(&DAT_005a9068);
    uVar8 = FUN_0040a7d0(unaff_EDI + 0x26e4,auStack_68c,uVar8);
    uStack_18 = 0x30;
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    PeekPacketChecksumState();
    (*pcVar15)(&DAT_005a9068);
    FUN_0040a8c0(uVar8,&uStack_8b4,puVar19);
    uStack_1c = 0x31;
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uVar8 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar8);
    (*pcVar15)(&DAT_005a9068);
    uStack_20 = CONCAT31(uStack_20._1_3_,0x30);
    ...
    uVar8 = PeekPacketChecksumState();
    (*pcVar15)(&DAT_005a9068);
    uVar8 = FUN_0040a7d0(puVar18 + 0x2908,auStack_250,uVar8);
    uStack_24 = 0x32;
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    PeekPacketChecksumState();
    (*pcVar15)(&DAT_005a9068);
    FUN_0040a8c0(uVar8,auStack_478,puVar17);
    uStack_28 = 0x33;
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uVar8 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar8);
    (*pcVar15)(&DAT_005a9068);
    puStack_8 = (undefined1 *)CONCAT31(puStack_8._1_3_,0x32);
    if (iStack_444 != 0) {
      FUN_0040a240();
      FUN_0040b540(&uStack_8b4);
    }
