  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  if (cVar4 == '\0') {
    ...
    if (cVar4 == '\0') {
      ...
      uVar8 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_680,4);
      uStack_c = 7;
      uVar8 = FUN_0040aca0(param_1[0x3d2] + 0x38,auStack_45c,uVar8);
      uStack_c = 8;
      bVar2 = false;
      bVar18 = false;
      cVar4 = FUN_0040b490(param_1 + 0x3d5,uVar8);
      if (cVar4 == '\0') {
        uVar8 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_8a4,4);
        uStack_c = 9;
        uVar8 = FUN_0040aba0(param_1[0x3d2] + 0x38,&iStack_ac8,uVar8);
        uStack_c = 10;
        bVar2 = true;
        bVar18 = true;
...
LAB_0049168f:
    ...
    if (cVar4 == '\0') {
      ...
      (*pcVar15)(&DAT_005a9068);
      if (((cVar4 != '\0') ||
          (cVar4 = FUN_0040b300(unaff_ESI,*(undefined4 *)(&DAT_006a7724 + DAT_005b3484)),
  ...
  if (cVar4 != '\0') {
    ...
    if ((-1 < iVar5) && (iVar5 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
      ...
      if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
        ...
        } while ((int)puStack_aec < *(int *)(&DAT_006a7724 + DAT_005b3484));
      }
    }
...
LAB_0049096a:
    ...
    uVar8 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar8,puStack_aec);
    local_ae4 = 1;
    if (0 < param_1[0xfe5]) {
...
LAB_00490ea2:
        ...
        cVar4 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&uStack_ad0,&uStack_ad4,2,1,1);
        if (cVar4 != '\0') {
          auStack_8a4[0] = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
          ...
          FUN_004065a0(uVar8,uVar19,uVar20,uVar21,iVar5,uVar23);
          FUN_00432320((char)param_1[0xf],1,1,uVar8,uVar19,uVar20,uVar21,iVar5,uVar23);
...
LAB_00490f39:
  *(undefined1 *)(param_1 + 5) = 1;
  ...
  (*pcVar15)(&DAT_005a9068);
  uVar19 = FUN_004065a0();
  FUN_00437d90(&DAT_006a7f70 + DAT_005b3484,unaff_ESI,uVar8,(char)param_1[0xf],uVar19);
  cVar4 = FUN_004065a0();
  if ((cVar4 != '\0') && (cVar4 = FUN_0043a530(), cVar4 == '\0')) {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
