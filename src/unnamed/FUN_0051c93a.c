/* FUN_0051c93a - 0x0051c93a in the original binary.
 *
...
FUN_0051c93a(undefined4 param_1,undefined4 param_2,float *param_3,undefined4 *param_4)

{
  ...
  DAT_00568840 = *param_3 + param_3[0x1f];
  DAT_00568880 = (*param_3 - param_3[0x1f]) * DAT_00f25a40;
  DAT_00568844 = param_3[1] + param_3[0x1e];
  DAT_00568884 = (param_3[1] - param_3[0x1e]) * _DAT_00f25a44;
  DAT_00568848 = param_3[2] + param_3[0x1d];
  DAT_00568888 = (param_3[2] - param_3[0x1d]) * _DAT_00f25a48;
  DAT_0056884c = param_3[3] + param_3[0x1c];
  DAT_0056888c = (param_3[3] - param_3[0x1c]) * _DAT_00f25a4c;
  DAT_00568850 = param_3[4] + param_3[0x1b];
  DAT_00568890 = (param_3[4] - param_3[0x1b]) * _DAT_00f25a50;
  DAT_00568854 = param_3[5] + param_3[0x1a];
  DAT_00568894 = (param_3[5] - param_3[0x1a]) * _DAT_00f25a54;
  DAT_00568858 = param_3[6] + param_3[0x19];
  DAT_00568898 = (param_3[6] - param_3[0x19]) * _DAT_00f25a58;
  DAT_0056885c = param_3[7] + param_3[0x18];
  DAT_0056889c = (param_3[7] - param_3[0x18]) * _DAT_00f25a5c;
  DAT_00568860 = param_3[8] + param_3[0x17];
  DAT_005688a0 = (param_3[8] - param_3[0x17]) * _DAT_00f25a60;
  DAT_00568864 = param_3[9] + param_3[0x16];
  _DAT_005688a4 = (param_3[9] - param_3[0x16]) * _DAT_00f25a64;
  DAT_00568868 = param_3[10] + param_3[0x15];
  _DAT_005688a8 = (param_3[10] - param_3[0x15]) * _DAT_00f25a68;
  DAT_0056886c = param_3[0xb] + param_3[0x14];
  _DAT_005688ac = (param_3[0xb] - param_3[0x14]) * _DAT_00f25a6c;
  DAT_00568870 = param_3[0xc] + param_3[0x13];
  _DAT_005688b0 = (param_3[0xc] - param_3[0x13]) * _DAT_00f25a70;
  DAT_00568874 = param_3[0xd] + param_3[0x12];
  _DAT_005688b4 = (param_3[0xd] - param_3[0x12]) * _DAT_00f25a74;
  DAT_00568878 = param_3[0xe] + param_3[0x11];
  DAT_005688b8 = (param_3[0xe] - param_3[0x11]) * _DAT_00f25a78;
  DAT_0056887c = param_3[0xf] + param_3[0x10];
  DAT_005688bc = (param_3[0xf] - param_3[0x10]) * _DAT_00f25a7c;
  iVar3 = 0;
  iVar2 = 2;
  do {
