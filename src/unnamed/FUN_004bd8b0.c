...

{
  ...
  *unaff_FS_OFFSET = &uStack_14;
  iVar6 = DAT_005b3484;
  uStack_1c = 0x4bd8d6;
  *(int *)(&DAT_006a64b8 + DAT_005b3484) = *(int *)(&DAT_006a64b8 + DAT_005b3484) + 1;
  ...
  if (*(int *)(&DAT_006a76f8 + iVar6) != 0) {
    ...
    if ((iVar6 == iVar5) &&
       (local_3d54 = 0, iVar6 = DAT_005b3484, *(int *)(&DAT_006a76f8 + DAT_005b3484) != 0)) {
      do {
        ...
        if ((iVar14 + 1) % 0x3c == 0) {
          ...
          do {
            ...
            if (((((&DAT_00e55e20)[local_3d4c >> 5] & 1 << ((byte)local_3d4c & 0x1f)) != 0) &&
               ...
               (cVar3 = FUN_004e82c0(), iVar6 = DAT_005b3484, cVar3 != '\0')) {
              FUN_004e83b0();
              iVar6 = DAT_005b3484;
            }
...
LAB_004bdd1c:
            ...
            if ((((&DAT_00e55e20)[local_3d4c >> 5] & 1 << (bVar13 & 0x1f)) != 0) &&
               ((&DAT_006a7670)[local_3d4c + local_3d50 * 8 + iVar6] == '\0')) {
              Replay_AppendEvent();
              if (*(uint *)(&DAT_006a76f8 + DAT_005b3484) <= local_3d54) goto LAB_004bdd21;
              (&g_replayEventBuffer)[g_replayEventCursor] =
                   *(undefined1 *)(*(int *)(&DAT_006a76f4 + DAT_005b3484) + iVar5);
              ...
              iVar14 = DAT_007934e8;
              iVar6 = DAT_005b3484;
              if (*(int *)(&DAT_006aaac4 + local_3d50 * 4 + DAT_005b3484) % 600 == 0) {
  ...
  iVar6 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  if (iVar6 == *(int *)(&DAT_006a64b0 + DAT_005b3484)) {
    iVar6 = *(int *)(&DAT_006a64b4 + DAT_005b3484);
    iVar5 = DAT_005b3484;
    if (iVar6 != -1) {
      if ((DAT_00793549 != '\0') &&
    ...
    if (*(int *)(&DAT_006a64b4 + DAT_005b3484) == -1) {
      uVar7 = FUN_004ee9b0();
      *(undefined4 *)(&DAT_006a64b4 + DAT_005b3484) = uVar7;
      param_1 = local_3d58;
    }
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    PeekPacketChecksumState();
    ...
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    iVar5 = DAT_005b3484;
    iVar6 = iVar6 - *(int *)(&DAT_006a64b0 + DAT_005b3484);
    if (iVar6 < 1) {
      iVar6 = iVar6 + -0xf;
    }
    else {
    ...
    *(int *)(&DAT_006a64b0 + DAT_005b3484) =
         *(int *)(&DAT_006a64b0 + DAT_005b3484) + ((int)(iVar6 + (iVar6 >> 0x1f & 0xfU)) >> 4);
  }
  if (((char)param_1[4] == '\0') && (*(char *)((int)param_1 + 0x91) == '\0')) {
    iVar6 = 0;
    local_3d4c = 0;
    bVar13 = DAT_0056d10c < 5;
    if ((bool)bVar13) {
      local_3d4c = -*(int *)(&DAT_005f2f44 + iVar5);
    }
    if (0x31b < DAT_0056d10c) {
...
LAB_004bdf96:
  ...
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  iVar6 = DAT_005b3484;
  pbVar17 = &DAT_006aa628 + DAT_005b3484;
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  iVar5 = _rand();
  *pbVar17 = (byte)iVar5;
  iVar5 = _rand();
  ...
  if (-1 < iVar6) {
    cVar3 = FUN_004065a0();
    if ((cVar3 != '\x01') || (cVar3 = FUN_004065a0(), cVar3 != '\0')) {
      EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      iVar6 = PeekPacketChecksumState();
      LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      ...
      *(int *)(&DAT_006a7730 + iVar6) = iVar5 + -400;
      ...
      if (cVar3 == '\0') {
        ...
        do {
          ...
          if ((iVar5 != 0) && (cVar3 = FUN_004065a0(), cVar3 != '\x01')) {
            FUN_0045ea40();
          }
          iVar6 = iVar6 + 1;
        } while (iVar6 < 8);
...
LAB_004be4b1:
    if (uVar11 == local_3d54) {
      ...
      PeekPacketChecksumState();
      LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      uVar7 = FUN_0040a7d0(iVar6 + 0x8c8);
      local_c = 0;
      FUN_0040aea0(uVar7);
      local_c._0_1_ = 1;
      EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
code_r0x004be720:
  if (*(int *)(DAT_005b3484 + 0x621e0) != 0) {
    ...
    iVar6 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    if (((iVar6 < 1) && (cVar3 = FUN_004065a0(), cVar3 != '\0')) &&
       (cVar3 = FUN_004065a0(), cVar3 == '\0')) {
  ...
  if (iVar6 != 3) {
    ...
    do {
      ...
      iVar6 = DAT_005b3484;
      if (*(int *)(DAT_005b3484 + 0x5b81c + uVar11 * 4) != 0) {
        *(undefined4 *)(DAT_005b3484 + 0x5b83c + uVar11 * 4) = 0;
      }
      (*pcVar16)();
      ...
      iVar6 = DAT_005b3484;
      piVar15 = local_3d60;
      if (0 < *(int *)(DAT_005b3484 + 0x5b81c + uVar11 * 4)) {
        pbVar17 = &DAT_0067e3cc + DAT_005b3484;
        ...
        if (bVar18 || (bVar12 >> (bVar13 & 7) & 1) != 1) {
          piStack_3d64[(int)local_3d60 + 0x435] =
               piStack_3d64[(int)local_3d60 + 0x435] +
               *(int *)(DAT_005b3484 + 0x5b81c + (int)local_3d60 * 4);
        ...
        if (0x50 < iVar6) {
          ...
          iVar6 = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          if (*(int *)(DAT_005b3484 + 0x5b81c + (int)local_3d68 * 4) < iVar6) goto LAB_004bedb3;
          (*pcVar16)(&DAT_005a9068);
          ...
          iVar5 = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          uVar7 = FUN_0040a7d0(&local_3d68,auStack_6a4,iVar5 + iVar6);
          uStack_2c = 3;
          (*pcVar16)(&DAT_005a9068);
          uVar8 = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          FUN_0040a8c0(uVar7,auStack_35c0,uVar8);
          uStack_30 = 4;
          (*pcVar16)(&DAT_005a9068);
...
LAB_004bedb3:
          ...
          if (0x32 < iVar6) {
            ...
            iVar6 = PeekPacketChecksumState();
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            if (iVar6 <= *(int *)(DAT_005b3484 + 0x5b81c + (int)piStack_3d5c * 4)) {
              (*pcVar16)(&DAT_005a9068);
              ...
              iVar6 = PeekPacketChecksumState();
              LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
              uStack_3d78 = (int *)((int)piStack_3d64 * 0x1120 + 0x5113c + DAT_005b3484);
              (*pcVar16)(&DAT_005a9068);
              unaff_ESI = PeekPacketChecksumState();
              LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
              uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_250,unaff_ESI + iVar6);
              uStack_20 = CONCAT31(uStack_20._1_3_,5);
              (*pcVar16)(&DAT_005a9068);
              unaff_EDI = (int *)PeekPacketChecksumState();
              LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
              FUN_0040a8c0(uVar7,auStack_2f48,unaff_EDI);
        ...
        cVar3 = FUN_00406610(0x31 < *(int *)(DAT_005b3484 + 0x5b81c + (int)piStack_3d5c * 4));
        if (cVar3 != '\0') {
          (*pcVar16)(&DAT_005a9068);
          ...
          unaff_ESI = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_1594,unaff_ESI + iVar6);
          uStack_20 = CONCAT31(uStack_20._1_3_,7);
          (*pcVar16)(&DAT_005a9068);
          unaff_EDI = (int *)PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          FUN_0040a8c0(uVar7,auStack_2b00,unaff_EDI);
        ...
        cVar3 = FUN_00406860();
        if ((cVar3 != '\0') && (cVar3 = FUN_004065a0(), cVar3 != '\0')) {
          (*pcVar16)(&DAT_005a9068);
          iVar6 = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          if (iVar6 <= *(int *)(DAT_005b3484 + 0x5b81c + (int)piStack_3d5c * 4)) {
            ...
            unaff_ESI = PeekPacketChecksumState();
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_474,unaff_ESI + iVar6);
            uStack_20 = CONCAT31(uStack_20._1_3_,9);
            (*pcVar16)(&DAT_005a9068);
            unaff_EDI = (int *)PeekPacketChecksumState();
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            FUN_0040a8c0(uVar7,auStack_26b8,unaff_EDI);
        ...
        if (cVar3 != '\0') {
          ...
          unaff_ESI = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_114c,unaff_ESI + iVar6);
          uStack_20 = CONCAT31(uStack_20._1_3_,0xb);
          (*pcVar16)(&DAT_005a9068);
          unaff_EDI = (int *)PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          FUN_0040a8c0(uVar7,auStack_2270,unaff_EDI);
      ...
      if (0x32 < *(int *)(DAT_005b3484 + 0x5b83c + (int)piStack_3d5c * 4)) {
        (*pcVar16)(&DAT_005a9068);
        iVar6 = PeekPacketChecksumState();
        EncodeOutgoingPacketField(iVar6 + -1);
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        ...
        iVar6 = PeekPacketChecksumState();
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        unaff_ESI = (int)local_3d68 * 0x1120 + 0x5113c + DAT_005b3484;
        (*pcVar16)(&DAT_005a9068);
        unaff_EDI = (int *)PeekPacketChecksumState();
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        uVar7 = FUN_0040a7d0(&local_3d60,auStack_8c0,(int)unaff_EDI + iVar6);
        uStack_24 = CONCAT31(uStack_24._1_3_,0xd);
        (*pcVar16)(&DAT_005a9068);
        uVar8 = PeekPacketChecksumState();
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        FUN_0040a8c0(uVar7,auStack_1e2c,uVar8);
        uStack_28 = 0xe;
        (*pcVar16)(&DAT_005a9068);
        uVar7 = PeekPacketChecksumState();
        EncodeOutgoingPacketField(uVar7);
      ...
      iVar6 = *(int *)(DAT_005b3484 + 0x5b81c + (int)piStack_3d5c * 4);
      if (iVar6 < 500) {
        if (0xf9 < iVar6) {
          (*pcVar16)(&DAT_005a9068);
          EncodeOutgoingPacketField(0x14);
          ...
          iVar6 = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          uStack_3d70 = (int *)((int)piStack_3d64 * 0x1120 + 0x5113c + DAT_005b3484);
          (*pcVar16)(&DAT_005a9068);
          unaff_EBX = (int *)PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_28d8,(int)unaff_EBX + iVar6);
          uStack_20 = CONCAT31(uStack_20._1_3_,0x11);
          (*pcVar16)(&DAT_005a9068);
          uStack_3d78 = (int *)PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          FUN_0040a8c0(uVar7,auStack_2d24,uStack_3d78);
          uStack_24 = CONCAT31(uStack_24._1_3_,0x12);
          (*pcVar16)(&DAT_005a9068);
          uVar7 = PeekPacketChecksumState();
          EncodeOutgoingPacketField(uVar7);
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        ...
        if (0x95 < iVar6) {
          ...
          unaff_EBX = (int *)PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_2048,(int)unaff_EBX + iVar6);
          uStack_20 = CONCAT31(uStack_20._1_3_,0x13);
          (*pcVar16)(&DAT_005a9068);
          uStack_3d78 = (int *)PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          FUN_0040a8c0(uVar7,auStack_2494,uStack_3d78);
          uStack_24 = CONCAT31(uStack_24._1_3_,0x14);
          (*pcVar16)(&DAT_005a9068);
          uVar7 = PeekPacketChecksumState();
          EncodeOutgoingPacketField(uVar7);
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        ...
        unaff_EBX = (int *)PeekPacketChecksumState();
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_d04,(int)unaff_EBX + iVar6);
        uStack_20 = CONCAT31(uStack_20._1_3_,0xf);
        (*pcVar16)(&DAT_005a9068);
        uStack_3d78 = (int *)PeekPacketChecksumState();
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        FUN_0040a8c0(uVar7,auStack_19e0,uStack_3d78);
...
LAB_004c008f:
      ...
      FUN_0040a7d0((int)local_3d58 + DAT_005b3484 + 0x5ff00,auStack_1bf4,1000);
      uStack_14 = CONCAT31(uStack_14._1_3_,0x15);
      local_3d68 = (int *)((int)local_3d58 + DAT_005b3484 + 0x5ede0);
      (*pcVar16)(&DAT_005a9068);
      ...
      if (bVar18) {
        ...
        if (iVar6 == 1) {
          ...
          unaff_EBX = (int *)PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_338c,(int)unaff_EBX + iVar6);
          uStack_20 = CONCAT31(uStack_20._1_3_,0x16);
          (*pcVar16)(&DAT_005a9068);
          uStack_3d78 = (int *)PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          FUN_0040a8c0(uVar7,auStack_316c,uStack_3d78);
          uStack_24 = CONCAT31(uStack_24._1_3_,0x17);
          (*pcVar16)(&DAT_005a9068);
          uVar7 = PeekPacketChecksumState();
          EncodeOutgoingPacketField(uVar7);
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_004c08c8:
          ...
          if (iVar6 == 2) {
            ...
            unaff_EBX = (int *)PeekPacketChecksumState();
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_ae0,(int)unaff_EBX + iVar6);
            uStack_20 = CONCAT31(uStack_20._1_3_,0x18);
            (*pcVar16)(&DAT_005a9068);
            uStack_3d78 = (int *)PeekPacketChecksumState();
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            FUN_0040a8c0(uVar7,auStack_f2c,uStack_3d78);
            uStack_24 = CONCAT31(uStack_24._1_3_,0x19);
            (*pcVar16)(&DAT_005a9068);
            uVar7 = PeekPacketChecksumState();
            EncodeOutgoingPacketField(uVar7);
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          ...
          if (iVar6 == 3) {
            ...
            iVar5 = PeekPacketChecksumState();
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            uVar7 = FUN_0040a7d0(&piStack_3d5c,auStack_1370,iVar5 + iVar6);
            uStack_20 = CONCAT31(uStack_20._1_3_,0x1a);
            (*pcVar16)(&DAT_005a9068);
            uVar8 = PeekPacketChecksumState();
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            FUN_0040a8c0(uVar7,auStack_17bc,uVar8);
  ...
  *(undefined4 *)(&g_replayEventBuffer + g_replayEventCursor) = uVar7;
  ...
  if (DAT_0056dbe8 == -1) {
    ...
    iVar6 = DAT_005b3484;
    if (iVar5 == iVar14) {
      *(undefined4 *)(&DAT_006aaafc + DAT_005b3484) = 0;
      ...
      *(undefined4 *)(&DAT_006a76e4 + iVar6) = 0;
      ...
      if ((*(uint *)(&DAT_006a76fc + iVar6) <= uVar11) &&
         (cVar3 = FUN_0050ed30(), iVar5 = DAT_005b3484, cVar3 == '\0')) {
                    /* WARNING: Subroutine does not return */
        FUN_004010c0();
      }
      ...
      *(int *)(&DAT_006a76f8 + iVar6) = *(int *)(&DAT_006a76f8 + iVar6) + 1;
      ...
      uVar7 = FUN_0045d360();
      *(undefined4 *)(&DAT_006aab04 + DAT_005b3484) = uVar7;
      FUN_00423a20();
    }
    else {
      Replay_AppendEvent();
      ...
      *(undefined4 *)(&g_replayEventBuffer + g_replayEventCursor) = uVar7;
      ...
      uVar7 = PeekPacketChecksumState();
      LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      *(undefined4 *)(&DAT_006a7704 + DAT_005b3484) = uVar7;
      EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      PeekPacketChecksumState();
      LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      FUN_004e7140();
  ...
  if (piStack_3d5c[0x42d] == -1) {
    ...
    if ((iVar6 == -1) && (*(char *)((int)piStack_3d5c + 0x10bd) == '\0')) {
      ...
      *(undefined4 *)(&g_replayEventBuffer + g_replayEventCursor) = uVar7;
      ...
      cVar3 = FUN_0040b390(DAT_005b3484 + 0x3b6c4,DAT_005b3484 + 0x3b49c);
      iVar6 = DAT_005b3484;
      if (cVar3 == '\0') {
        ...
        *(undefined4 *)(&DAT_006a7704 + DAT_005b3484) = uVar7;
        ...
        puVar1 = (undefined4 *)(&DAT_006a76e8 + DAT_005b3484);
        *(undefined4 *)(&DAT_006aab00 + DAT_005b3484) = 0;
        *puVar1 = 0;
        *(undefined4 *)(&DAT_006a76ec + iVar6) = 0;
        FUN_004d2130(0xf);
        iVar6 = DAT_005b3484;
        (&DAT_006aa624)[DAT_005b3484] = 0xf;
        EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        iVar14 = PeekPacketChecksumState();
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_004c13d9:
  iVar6 = *(int *)(DAT_005b3484 + 0xebeec);
  if (*(int *)(DAT_005b3484 + 0xebef0) != iVar6) {
    iVar14 = *(int *)(DAT_005b3484 + 0xebef0) - iVar6;
    if (iVar14 < 0) {
      iVar14 = iVar14 + -3;
    }
    else {
    ...
    *(int *)(DAT_005b3484 + 0xebeec) = ((int)(iVar14 + (iVar14 >> 0x1f & 3U)) >> 2) + iVar6;
  }
  (*pcVar16)(&DAT_005a9068);
  iVar6 = PeekPacketChecksumState();
  uStack_3d78 = (int *)CONCAT13(iVar6 == 3,(undefined3)uStack_3d78);
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  if (uStack_3d78._3_1_ != '\0') {
    FUN_0040aca0(&DAT_0067e5f4 + DAT_005b3484,auStack_3384,&DAT_0067ea3c + DAT_005b3484);
    piStack_18 = (int *)0x1c;
    (*pcVar16)(&DAT_005a9068);
    iVar6 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    ...
    uStack_3d78 = (int *)(&DAT_0067ea3c + DAT_005b3484);
    (*pcVar16)(&DAT_005a9068);
    iVar6 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(((int)(iVar14 + (iVar14 >> 0x1f & 7U)) >> 3) + iVar6);
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    FUN_0040aca0(&DAT_0067e3d0 + DAT_005b3484,auStack_3168,&DAT_0067e818 + DAT_005b3484);
    uStack_20 = 0x1d;
    (*pcVar16)(&DAT_005a9068);
    PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  ...
  iVar6 = DAT_005b3484;
  if ((char)piVar15[4] != '\0') {
    if (DAT_0056d10c < 0xf5) {
      iVar5 = 0xf5;
    }
    else {
      iVar5 = DAT_0056d10c;
      if (0x285 < DAT_0056d10c) {
        iVar5 = 0x285;
      }
    }
    *(int *)(DAT_005b3484 + 0xebee8) = iVar5;
  }
  if (((-99 < *(int *)(&DAT_006a73c0 + iVar6)) &&
    ...
    if (iVar6 == 0) {
      ...
      if (iVar6 < 8) {
        ...
        iVar6 = DAT_005b3484;
        *(undefined4 *)(&DAT_006a73c8 + DAT_005b3484) = 2;
      }
      else {
        FUN_004ee9b0(0);
...
LAB_004c1730:
  ...
  if (((char)piStack_3d64[0x468] == '\x01') && (*(int *)(iVar6 + 0x621e0) != 0)) {
    cVar3 = FUN_00406710();
    iVar6 = DAT_005b3484;
    if ((cVar3 == '\0') || ((&DAT_005f2f40)[DAT_005b3484] != '\x02')) {
  ...
  if (((*(int *)(iVar6 + 0x621e0) != 0) && ((&DAT_005f2f40)[iVar6] == '\x02')) &&
     (cVar3 = FUN_004065a0(), iVar6 = DAT_005b3484, cVar3 != '\0')) {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    iVar5 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    iVar6 = DAT_005b3484;
    if (((iVar5 < 0x8c) && (*(char *)((int)piVar15 + 0x11c5) == '\0')) &&
       (cVar3 = FUN_004065a0(), iVar6 = DAT_005b3484, cVar3 == '\x01')) {
