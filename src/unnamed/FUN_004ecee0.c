/* FUN_004ecee0 - 0x004ecee0 in the original binary.
 *
...
void __thiscall FUN_004ecee0(int param_1,int param_2,int param_3)

{
  ...
  DAT_00ea0e28 = (float)param_2 + fVar2 * _DAT_00557ffc + fVar1 * _DAT_00558000;
  DAT_00ea0e2c = (float)param_3 + fVar2 * _DAT_00557ff8 + fVar1 * _DAT_00557ffc;
  _DAT_00ea0e4c = (float)param_2 + fVar1 * _DAT_00557ff4 + fVar2 * _DAT_00557ffc;
  fVar3 = (float)param_3 + fVar2 * _DAT_00557fec;
  _DAT_00ea0e50 = fVar3 + fVar1 * _DAT_00557ffc;
  _DAT_00ea0e94 = (float)param_2 + fVar2 * _DAT_00557ff0;
  DAT_00ea0e70 = _DAT_00ea0e94 + fVar1 * _DAT_00557ff4;
  DAT_00ea0e74 = fVar3 + fVar1 * _DAT_00557ff0;
  _DAT_00ea0e94 = _DAT_00ea0e94 + fVar1 * _DAT_00558000;
  _DAT_00ea0e98 = (float)param_3 + fVar1 * _DAT_00557ff0 + fVar2 * _DAT_00557ff8;
