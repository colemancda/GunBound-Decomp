...
LAB_0046ec2d:
        ...
        cVar4 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&uStack_ad8,&uStack_ad4,2,1,1);
        if (cVar4 != '\0') {
          uStack_8a4 = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
          ...
          FUN_004065a0(uVar8,uVar20,uVar21,uVar22,iVar5,uVar23);
          FUN_00432320((char)param_1[0xf],1,1,uVar8,uVar20,uVar21,uVar22,iVar5,uVar23);
...
LAB_0046f388:
  ...
  iVar5 = DAT_005b3484;
  pbVar18 = (byte *)(DAT_005b3484 + 0x62143);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  iVar6 = _rand();
  *pbVar18 = (byte)iVar6;
  iVar6 = _rand();
