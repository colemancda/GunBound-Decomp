/* FUN_004ac4d0 - 0x004ac4d0 in the original binary.
 *
 ...
 * recovered.  The first peek (0x4ac51a) reads the return value of the
 ...
 * (`imul eax,eax,0x224`) to index the six-cell guard table at 0xea0090,
...
undefined4 __fastcall FUN_004ac4d0(int param_1)

{
  ...
  *unaff_FS_OFFSET = &local_c;
  ...
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar1 = PeekPacketChecksumState((void *)(&DAT_00ea0090 + uIndex * 0x224));
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  local_4 = 0xffffffff;
