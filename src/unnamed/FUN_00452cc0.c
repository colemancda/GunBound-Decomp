...
LAB_00453238:
  ...
  if (cVar3 == '\0') {
    FUN_0040b180(param_1 + 0x10,&stack0xfffff514,8);
    uStack_30 = 0xc;
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uVar6 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar6);
    ...
    FUN_0040b180(param_1 + 0x99,&stack0xfffff510,8);
    uStack_34 = 0xd;
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uVar6 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar6);
    ...
    if (cVar3 == '\0') {
      ...
      uVar7 = FUN_0040a4d0(param_1 + 0x122);
      ...
      uVar6 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_488,4);
      uStack_38 = 0xe;
      uVar6 = FUN_0040aca0(param_1[0x3d2] + 0x38,auStack_6ac,uVar6);
      uStack_38 = 0xf;
      uVar7 = 3;
      cVar3 = FUN_0040b490(param_1 + 0x3d5,uVar6);
      if (cVar3 == '\0') {
        uVar6 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_8d0,4);
        uStack_38 = 0x10;
        uVar6 = FUN_0040aba0(param_1[0x3d2] + 0x38,&stack0xfffff50c,uVar6);
        uStack_38 = 0x11;
        uVar7 = 0xf;
...
LAB_00453b3c:
    ...
    if ((((cStack_ad9 != '\0') || (cVar3 = FUN_0040b300(), cVar3 != '\0')) ||
        (cVar3 = FUN_0040b300(), cVar3 != '\0')) || (cVar3 = FUN_0040b330(), cVar3 != '\0')) {
  ...
  cVar3 = FUN_004065a0();
  if (cVar3 != '\0') {
    iVar8 = FUN_0040a4d0(param_1 + 0x3d5);
    if ((-1 < iVar8) && (iVar8 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
      pcVar14 = (char *)(*(int *)(&DAT_006a773c + DAT_005b3484) + iVar8);
      iVar8 = 0;
      if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
        do {
          if (*pcVar14 != '\0') goto LAB_004535de;
          pcVar14 = pcVar14 + *(int *)(&DAT_006a7720 + DAT_005b3484);
          iVar8 = iVar8 + 1;
        } while (iVar8 < *(int *)(&DAT_006a7724 + DAT_005b3484));
      }
    }
    iVar8 = 10000;
LAB_004535de:
    ...
    iVar9 = iVar8;
    uVar6 = FUN_0040a4d0(piVar1);
    FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar6,iVar8);
    iVar8 = 1;
    if (0 < param_1[0xfe5]) {
      iVar8 = param_1[0xfe5];
    }
    ...
    uVar17 = 2;
    uVar16 = 0xff;
    uVar6 = FUN_0040a4d0(param_1 + 0x5f9);
    uVar11 = 0;
    FUN_0040a4d0(piVar1);
    FUN_004065a0(uVar11,uVar6,uVar16,uVar17,uVar18);
  ...
  PeekPacketChecksumState();
  (*pcVar15)(&DAT_005a9068);
  FUN_004398e0(&DAT_006a7f70 + DAT_005b3484,param_1[2],uVar6,puVar20,param_1,0);
  (**(code **)(*param_1 + 0x20))();
  if (param_1[9] < 2) {
    *(undefined1 *)(param_1 + 5) = 1;
  }
    ...
    uVar16 = 0x2071;
    uVar6 = FUN_0040a4d0(param_1 + 0x45e);
    uVar11 = FUN_0040a4d0(param_1 + 0x3d5);
    FUN_004373c0(uVar11,uVar6,uVar16,pcVar14);
    param_1[0xfeb] = 0;
  }
  cVar3 = FUN_004065a0();
  iVar5 = DAT_005b3484;
  if ((cVar3 != '\0') && (cVar3 = FUN_0043a530(), iVar5 = DAT_005b3484, cVar3 == '\0')) {
    uVar6 = FUN_0040a4d0(&DAT_007949c8);
    QueueOutgoingPacketField(uVar6);
    iVar5 = DAT_005b3484;
    *(undefined4 *)(&DAT_005f3768 + DAT_005b3484) = 5;
    *(undefined4 *)(&DAT_005f376c + iVar5) = 0;
  }
  uVar6 = FUN_0040b490(iVar5 + 0x5b85c,param_1 + 0xe48);
  ...
  if ((cStack_ad9 == '\0') || (cVar3 = FUN_0040b2d0(), cVar3 == '\0')) {
    ...
    iVar5 = PeekPacketChecksumState();
    (*pcVar15)();
    if ((0 < iVar5) && (cVar3 = FUN_0040b330(), cVar3 != '\0')) goto LAB_00453887;
  }
  else {
LAB_00453887:
    cVar3 = FUN_004065a0();
  ...
  cVar3 = FUN_0040b490();
  if (((cVar3 != '\0') && (cVar3 = FUN_0040b490(), cVar3 != '\0')) ||
