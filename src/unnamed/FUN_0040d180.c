 ...
 * forwards its EAX to FUN_004fe420 as the object being constructed.  Its two
 ...
 *
 * Wiring it required resizing both globals first: FUN_004fe420 writes 0x30
...
{
  FUN_004fe420(0xa,0x3f400000,0x3e800000,0x40100000,0x11,regEax);
  return;
}
