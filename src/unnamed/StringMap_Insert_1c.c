/* StringMap_Insert_1c - 0x00500580 in the original binary.
 *
 * The insert half of StringMap_Find_1c: carve a node out of the chunk list (growing it by
 * 0x1c records at a time), link it at the head of its bucket, and stamp the
