/* IntMap_Insert_1768 - 0x00500840 in the original binary.
 *
 * The insert half of IntMap_Find_1768: carve a node out of the chunk list (growing it by
 * 0x1768 records at a time), link it at the head of its bucket, and stamp the
...

{
  ...
  if (regEsi[0xb] == 0) {
    piVar2 = _malloc(regEsi[9] * 0x1768 + 4);
    if (piVar2 == (int *)0x0) {
