/* FUN_004511b0 - 0x004511b0 in the original binary.
 *
 ...
 * cell at both argless PeekPacketChecksumState() calls: FUN_004510f0's twin, same two cells.
 */
#include "ghidra_types.h"


int FUN_004511b0(int param_1)
