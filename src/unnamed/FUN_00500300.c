/* FUN_00500300 - 0x00500300 in the original binary.
 *
...
void FUN_00500300(int *param_1,uint param_2)
  ...
  if (param_2 != param_1[2]) {
    ...
    if (param_1[2] != 0) {
      do {
        ...
        while (iVar3 != 0) {
          uVar4 = *(uint *)(iVar3 + 0x24) % param_2;
          iVar1 = *(int *)(iVar3 + 0x20);
          *(undefined4 *)(iVar3 + 0x20) = puVar2[uVar4];
          puVar2[uVar4] = iVar3;
          iVar3 = iVar1;
        }
        uVar6 = uVar6 + 1;
