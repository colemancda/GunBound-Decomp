/* FUN_0052916e - 0x0052916e in the original binary.
 *
...

{
  ...
  if ((local_8 & 1) == 0) {
    ...
    *piVar4 = *piVar4 + -1;
    if (*piVar4 == 0) {
      if (DAT_00f29690 != (uint *)0x0) {
        VirtualFree((LPVOID)(DAT_00f296a8 * 0x8000 + DAT_00f29690[3]),0x8000,0x4000);
        DAT_00f29690[2] = DAT_00f29690[2] | 0x80000000U >> ((byte)DAT_00f296a8 & 0x1f);
        *(undefined4 *)(DAT_00f29690[4] + 0xc4 + DAT_00f296a8 * 4) = 0;
        *(char *)(DAT_00f29690[4] + 0x43) = *(char *)(DAT_00f29690[4] + 0x43) + -1;
        if (*(char *)(DAT_00f29690[4] + 0x43) == '\0') {
          DAT_00f29690[1] = DAT_00f29690[1] & 0xfffffffe;
        }
        if (DAT_00f29690[2] == 0xffffffff) {
          VirtualFree((LPVOID)DAT_00f29690[3],0,0x8000);
          HeapFree(DAT_00f296ac,0,(LPVOID)DAT_00f29690[4]);
          _memmove(DAT_00f29690,DAT_00f29690 + 5,
                   (DAT_00f29694 * 0x14 - (int)DAT_00f29690) + -0x14 + DAT_00f29698);
          DAT_00f29694 = DAT_00f29694 + -1;
          if (DAT_00f29690 < param_1) {
            param_1 = param_1 + -5;
          }
          DAT_00f296a0 = DAT_00f29698;
        }
      }
      DAT_00f29690 = param_1;
      DAT_00f296a8 = uVar14;
    }
  }
  return;
