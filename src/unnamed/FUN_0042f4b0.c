...

{
  ...
  *(byte *)(piVar3 + 0xf) = (byte)param_1 & 7;
  ...
  puStack_8f0 = (undefined *)FUN_0053753c();
  ...
  puStack_8f8 = (undefined *)FUN_0053753c();
  ...
  puStack_900 = (undefined *)FUN_0053753c();
  ...
  puStack_908 = (undefined *)FUN_0053753c();
  ...
  puStack_910 = (undefined *)FUN_0053753c();
  ...
  *(byte *)((int)piVar3 + 0x391d) = bVar9 + *(char *)((int)piVar3 + 0x391b) + -0x34;
  ...
  if (DAT_0079352a != '\0') {
    ...
    puVar5 = &DAT_00e9aacd + g_replayEventCursor;
    ...
    *puVar1 = uStack_5c;
    ...
    g_replayEventCursor = g_replayEventCursor + 4;
    *puVar1 = 0xffffffff;
    puVar5 = &DAT_00e9aad0 + g_replayEventCursor;
    g_replayEventCursor = g_replayEventCursor + 4;
    *puVar5 = 0xff;
    puVar5 = &DAT_00e9aacd + g_replayEventCursor;
    g_replayEventCursor = g_replayEventCursor + 1;
  ...
  if ((iVar4 != 0) && (cVar2 = FUN_004065a0(), cVar2 != '\0')) {
    ...
    FUN_0040a8c0(piVar3 + 0x9b9,&puStack_914);
    uStack_7c = 3;
    FUN_0040afb0();
    uStack_7c = 0xffffffff;
    if (puStack_900 != (undefined *)0x0) {
    ...
    FUN_0040a8c0(piVar3 + 0xa42,&puStack_914);
    uStack_7c = 4;
    FUN_0040afb0();
    uStack_7c = 0xffffffff;
    if (puStack_900 != (undefined *)0x0) {
  ...
  if (cVar2 == '\x01') {
    ...
    EncodeOutgoingPacketField();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uStack_7c = CONCAT31(uStack_7c._1_3_,5);
    if (puStack_900 != (undefined *)0x0) {
      FUN_0040a240();
      FUN_0040b540();
      pcVar11 = LeaveCriticalSection_exref;
    ...
    PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    FUN_0040a8c0(puStack_924,auStack_6f0);
    uStack_7c._0_1_ = 8;
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    puStack_924 = (undefined *)PeekPacketChecksumState();
    PeekPacketChecksumState();
    EncodeOutgoingPacketField();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uStack_7c = CONCAT31(uStack_7c._1_3_,7);
    if (iStack_6dc != 0) {
      FUN_0040a240();
      FUN_0040b540();
      pcVar11 = LeaveCriticalSection_exref;
    ...
    EncodeOutgoingPacketField();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uStack_7c = CONCAT31(uStack_7c._1_3_,9);
    if (iStack_6dc != 0) {
      FUN_0040a240();
      FUN_0040b540();
      pcVar11 = LeaveCriticalSection_exref;
  ...
  if (cVar2 != '\0') {
    ...
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    FUN_0040a8c0(uVar7,auStack_6f8,uVar8);
    iStack_84 = CONCAT31(iStack_84._1_3_,0xc);
    (*pcVar10)(&DAT_005a9068);
    uVar7 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar7);
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uStack_88 = CONCAT31(uStack_88._1_3_,0xb);
    if (iStack_6e8 != 0) {
      FUN_0040a240();
    ...
    uVar8 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    FUN_0040a8c0(uVar7,auStack_704,uVar8);
    puVar5 = &DAT_005a9068;
    uStack_90 = 0xe;
    (*pcVar10)(&DAT_005a9068);
    uVar7 = PeekPacketChecksumState();
    ...
    uVar7 = PeekPacketChecksumState();
    (*pcVar11)(&DAT_005a9068);
    FUN_0040a8c0(uVar7,auStack_4f4,puVar5);
    uStack_a4 = 0x10;
    (*pcVar10)(&DAT_005a9068);
    uVar7 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar7);
    (*pcVar11)(&DAT_005a9068);
    uStack_7c = CONCAT31(uStack_7c._1_3_,0xf);
    if (iStack_4b8 != 0) {
      FUN_0040a240();
      FUN_0040b540();
    }
