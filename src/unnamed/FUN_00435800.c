/* FUN_00435800 - 0x00435800 in the original binary.
 *
...
void FUN_00435800(undefined4 param_1,int param_2,int param_3,undefined4 param_4)
  ...
  if (cVar1 == '\0') {
    ...
    for (iVar6 = (param_2 - iVar2) + -5; iVar6 <= iVar2 + 5 + param_2; iVar6 = iVar6 + 1) {
      ...
      if (iVar3 != 0) {
        ...
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        uVar5 = FUN_0040a5f0(iVar3 + 0x38,local_230,param_2);
        local_4 = 0;
