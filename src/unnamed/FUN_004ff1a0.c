...

{
  ...
  HashMap_Construct(0xa,0x3f400000,0x3e800000,0x40100000,0x11,(undefined4 *)(regEdi + 0x20));
  HashMap_Construct(0xa,0x3f400000,0x3e800000,0x40100000,0x11,(undefined4 *)(regEdi + 0x50));
