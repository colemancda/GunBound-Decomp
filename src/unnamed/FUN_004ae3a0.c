...

{
  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  cVar6 = FUN_004065a0();
  if (cVar6 == '\0') {
    FUN_0040b180(param_1 + 0x10,auStack_ac0,8);
    uStack_4 = 0;
    ...
    uStack_4 = 0xffffffff;
    FUN_0040a2a0();
    FUN_0040b180(param_1 + 0x99,auStack_ac0,8);
    ...
    if (cVar6 == '\0') {
      ...
      uVar13 = FUN_0040a4d0(param_1 + 0x122);
      ...
      uVar11 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_678,4);
      uStack_4 = 2;
      uVar11 = FUN_0040aca0(param_1[0x3d2] + 0x38,auStack_89c,uVar11);
      bVar4 = false;
      bVar3 = false;
      uStack_4 = 3;
      cVar6 = FUN_0040b490(piVar2,uVar11);
      if (cVar6 == '\0') {
        uVar11 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_454,4);
        uStack_4 = 4;
        uVar11 = FUN_0040aba0(param_1[0x3d2] + 0x38,auStack_ac0,uVar11);
        uStack_4 = 5;
        bVar4 = true;
        bVar3 = true;
        cVar6 = FUN_0040b490(uVar11,piVar2);
        bVar5 = false;
...
LAB_004ae9a8:
      ...
      if (bVar5) {
        ...
        if (iVar7 + 1 < 3) {
          uVar11 = FUN_0040a500(param_1 + 0x122,auStack_230);
          uStack_4 = 6;
    ...
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    if ((((iVar7 < 0) ||
         (cVar6 = FUN_0040b300(piVar2,*(undefined4 *)(&DAT_006a7720 + DAT_005b3484)), cVar6 != '\0')
         ) || (cVar6 = FUN_0040b300(piVar1,*(undefined4 *)(&DAT_006a7724 + DAT_005b3484)),
    ...
    if (cVar6 != '\0') {
      ...
      iVar14 = FUN_0040a4d0(piVar2);
      iVar7 = DAT_005b3484;
      piVar2 = (int *)(&DAT_006a7708 + DAT_005b3484);
      cVar6 = FUN_004065a0();
  ...
  if (cVar6 != '\0') {
    ...
    uVar9 = FUN_004e4340();
    uVar11 = uVar9;
    uVar10 = FUN_0040a4d0(piVar2);
    FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar10,uVar11);
    iVar7 = 1;
    if (0 < param_1[0xfe5]) {
      iVar7 = param_1[0xfe5];
    }
    uVar13 = (uint)*(byte *)(param_1 + 0xf);
    uVar11 = FUN_0040a4d0(&DAT_00e55ab8);
    iVar8 = FUN_0040a4d0(&DAT_00e55ab8);
    iVar8 = iVar8 / iVar7;
    uVar10 = FUN_0040a4d0(&DAT_007949c8);
    uVar18 = 0;
    uVar12 = FUN_0040a4d0(piVar2);
    FUN_0043af40(uVar12,uVar9,uVar18,uVar10,iVar8,uVar11,uVar13);
    uVar18 = 0;
    uVar12 = 2;
    uVar10 = 0xff;
    uVar11 = FUN_0040a4d0(param_1 + 0x5f9);
    uVar9 = 0;
    FUN_0040a4d0(piVar2);
    FUN_004065a0(uVar9,uVar11,uVar10,uVar12,uVar18);
  ...
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  FUN_004398e0(&DAT_006a7f70 + DAT_005b3484,param_1[2],uVar9,uVar11,param_1,0);
  *(undefined1 *)(param_1 + 5) = 1;
  (**(code **)(*param_1 + 0x20))();
  if (param_1[9] == 0) {
    pcVar19 = s_ssflame12_005549c8;
    uVar10 = 0x2077;
    uVar11 = FUN_0040a4d0(param_1 + 0x45e);
    uVar9 = FUN_0040a4d0(piVar2);
    FUN_004373c0(uVar9,uVar11,uVar10,pcVar19);
  }
  cVar6 = FUN_004065a0();
  iVar7 = DAT_005b3484;
  if ((cVar6 != '\0') && (cVar6 = FUN_0043a530(), iVar7 = DAT_005b3484, cVar6 == '\0')) {
    uVar11 = FUN_0040a4d0(&DAT_007949c8);
    QueueOutgoingPacketField(uVar11);
    iVar7 = DAT_005b3484;
    *(undefined4 *)(&DAT_005f3768 + DAT_005b3484) = 5;
    *(undefined4 *)(&DAT_005f376c + iVar7) = 0;
  }
  uVar11 = FUN_0040b490(iVar7 + 0x5b85c,param_1 + 0xe48);
  ...
  iVar7 = PeekPacketChecksumState();
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  if ((iVar7 < 0) && (cVar6 = FUN_0040b2d0(param_1 + 0x122,0), cVar6 != '\0')) {
LAB_004ae748:
    cVar6 = FUN_004065a0();
    if (cVar6 == '\0') {
      FUN_00406500(1);
    ...
    iVar7 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    if ((0 < iVar7) && (cVar6 = FUN_0040b330(param_1 + 0x122,0), cVar6 != '\0')) goto LAB_004ae748;
  }
  piVar1 = param_1 + 0xed2;
  cVar6 = FUN_0040b490(piVar2,piVar1);
  if (((cVar6 != '\0') && (cVar6 = FUN_0040b490(piVar1,param_1 + 0xf5b), cVar6 != '\0')) ||
