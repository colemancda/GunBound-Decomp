...

{
  ...
  *unaff_FS_OFFSET = &local_c;
  ...
  FUN_0040b180(local_1588,local_1574,8);
  local_4 = 1;
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  ...
  uVar11 = FUN_0040aca0(local_15a0,local_112c,param_1 + 0x488);
  local_4 = 2;
  ...
  uVar11 = FUN_0040aca0(local_1588,local_1574,local_159c + 0x6ac);
  local_4 = 4;
  FUN_0040b180(uVar11,local_112c,8);
  local_4._0_1_ = 5;
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_00456014:
      ...
      if ((local_15a5 == '\0') &&
        ...
        FUN_0040a5f0(local_1598,local_1350,param_2);
        local_4 = 6;
        EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        ...
        if (iVar13 < 0x14) {
LAB_004560f2:
          FUN_0040a5f0(iVar12,local_89c,param_2);
          local_4 = 8;
          bVar3 = true;
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar13 = PeekPacketChecksumState();
          ...
          if (iVar13 < 0x14) {
            ...
            FUN_0040a5f0(iVar12,local_454,param_2);
            local_4 = 9;
            bVar3 = true;
            bVar2 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          ...
          FUN_0040a5f0(iVar12,local_ac0,param_2);
      ...
      LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      if (iVar13 == 0) {
        FUN_0040b180(iVar12 + 0x6ac,local_ce4,8);
        local_4 = 10;
        FUN_0040b180(iVar12 + 0x488,local_f08,8);
        local_4._0_1_ = 0xb;
        EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        iVar13 = PeekPacketChecksumState();
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
      ...
      iVar16 = local_15a4;
      if ((((-1 < iVar13) && (iVar13 < *(int *)(&DAT_006a7720 + DAT_005b3484))) && (-1 < local_15b4)
          ) && ((local_15b4 < *(int *)(&DAT_006a7724 + DAT_005b3484) &&
                (*(char *)(*(int *)(&DAT_006a7720 + DAT_005b3484) * local_15b4 +
    ...
    if (0 < local_1584) {
      ...
      do {
        ...
        if ((local_15a5 == '\0') &&
          ...
          local_15b0[0] = FUN_0040a5f0(local_1598,local_ac0,param_2);
          local_4 = 0xc;
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_00456a3c:
            local_15b0[0] = FUN_0040a5f0(iVar13,local_f08,param_2);
            local_4 = 0xe;
            bVar6 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            local_15b0[0] = PeekPacketChecksumState();
            ...
            local_15b0[0] = FUN_0040a5f0(iVar13,local_1350,param_2);
        ...
        if (iVar16 == 0) {
          ...
          local_4 = 0x10;
          local_15b0[0] = FUN_0040b180(iVar13 + 0x488,local_678,8);
          local_4._0_1_ = 0x11;
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar16 = PeekPacketChecksumState();
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        ...
        iVar14 = local_15a4;
        if ((((-1 < iVar16) && (iVar16 < *(int *)(&DAT_006a7720 + DAT_005b3484))) &&
            (-1 < local_15a4)) &&
           ((local_15a4 < *(int *)(&DAT_006a7724 + DAT_005b3484) &&
            (*(char *)(local_15a4 * *(int *)(&DAT_006a7720 + DAT_005b3484) +
                       *(int *)(&DAT_006a773c + DAT_005b3484) + iVar16) != '\0')))) {
