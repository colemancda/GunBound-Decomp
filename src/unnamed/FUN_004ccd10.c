  ...
  if (local_715 == '\0') {
    ...
    do {
      ...
      if (1 < iVar7) {
        ...
        iVar6 = uVar8 + 0xae15;
        iVar7 = iVar6;
        pcVar10 = (char *)FUN_0043dc70(&DAT_00796eec,0x274);
  ...
  *(undefined1 *)(param_1 + 0x468) = 0;
  ...
  if (*pcVar10 != '\0') {
    *pcVar10 = '\0';
    ...
    uVar9 = FUN_0043dc70(&DAT_00796eec,iVar11 + 1000);
    ...
    uVar8 = (uint)(iVar6 * 100) / uVar8;
    uVar9 = FUN_0043dc70(&DAT_00796eec,iVar12 + 1000);
    pcVar10 = (char *)FUN_0043dc70(&DAT_00796eec,0xbbd);
