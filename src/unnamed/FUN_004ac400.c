 ...
 * recovered.  The first peek (0x4ac44a) reads the return value of the
 ...
 * (`imul eax,eax,0x224`) to index the six-cell guard table at 0xe9f3b8,
...

{
  ...
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar1 = PeekPacketChecksumState((void *)(&DAT_00e9f3b8 + uIndex * 0x224));
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  local_4 = 0xffffffff;
