  ...
  case 0x10:
    ...
    if (((cVar1 == '\0') && (cVar1 = FUN_004065a0(), cVar1 != '\x01')) &&
      ...
      if (*(uint *)(g_clientContext + 0x44e24) < 100) {
        ...
        pcVar8 = (char *)FUN_0043dc70(&DAT_00796eec,700);
        ...
        pcVar13 = local_40f4;
        pcVar8 = (char *)FUN_0043dc70(&DAT_00796eec,60000);
        ...
        if (*(int *)(param_1 + 0x44c) == 3) {
          ...
          *(undefined1 *)(param_1 + 0x32b54) = 0;
          ...
          if (*(char *)(*(int *)(param_1 + 0x450) * 9 + 0x2d54c + iVar9 + param_1) == '\0') {
            pcVar13 = (char *)FUN_0043dc70(&DAT_00796eec,0xea67);
          }
          else {
            pcVar13 = (char *)FUN_0043dc70(&DAT_00796eec,0xea66);
          }
        ...
        if ((uVar4 & 8) == 0) {
          if ((uVar4 & 4) == 0) {
            if ((uVar4 & 2) == 0) {
              ...
              pcVar13 = local_40f4;
              pcVar8 = (char *)FUN_0043dc70(&DAT_00796eec,0x2c4);
              _sprintf((char *)(param_1 + 0x32854),pcVar8,pcVar13);
              iVar3 = FUN_0040a4d0(local_40dc);
              iVar9 = FUN_0040a4d0(&DAT_00e9ba40);
              iVar9 = (iVar3 * 6) / iVar9;
              pcVar13 = (char *)FUN_0043dc70(&DAT_00796eec,0x2c5);
              ...
              *(undefined1 *)(param_1 + 0x329d4) = 0;
              pcVar8 = (char *)FUN_0043dc70(&DAT_00796eec,0x2c7);
        ...
        if ((iVar9 >> 0x1c & 2U) == 0) {
          ...
          *(uint *)(param_1 + 0x32c58) = (iVar9 >> 0x10 & 0xfU) << 1;
          ...
          if (*(int *)(param_1 + 0x32c58) == 6) {
            ...
            FUN_0040a4d0(iVar3);
            iVar9 = FUN_00426570();
            uVar4 = FUN_0040a4d0(iVar9 + 0x22c);
          ...
          *(int *)(param_1 + 0x32cdc) = iVar9;
          ...
          FUN_0040a4d0(iVar9 + 0x22c);
          if (extraout_AH_00 < '\0') {
            local_4518._0_3_ = CONCAT12(DAT_00555a16,DAT_00555a14);
          }
          else {
            local_4518._0_3_ = CONCAT12(DAT_00555a1a,DAT_00555a18);
          }
          FUN_0040a4d0(iVar3);
          iVar9 = FUN_00426570();
          iVar9 = FUN_0040a4d0(iVar9 + 0x22c);
  ...
  case 0x1a:
    ...
    if ((((cVar1 == '\0') && (cVar1 = FUN_004065a0(), cVar1 != '\x01')) &&
      ...
      if ((cVar1 == '\0') &&
        ...
        pcVar13 = local_40f4;
        pcVar8 = (char *)FUN_0043dc70(&DAT_00796eec,0x2c9);
        _sprintf((char *)(param_1 + 0x32854),pcVar8,pcVar13);
        *(undefined1 *)(param_1 + 0x328d4) = 0;
        pcVar8 = (char *)FUN_0043dc70(&DAT_00796eec,0x2ca);
        ...
        *(undefined1 *)(param_1 + 0x329d4) = 0;
        pcVar8 = (char *)FUN_0043dc70(&DAT_00796eec,0x2cb);
        pcVar13 = (char *)(param_1 + 0x32a54);
        do {
          cVar1 = *pcVar8;
          pcVar8 = pcVar8 + 1;
    ...
    break;
  case 0x32:
    iVar3 = FUN_0040a4d0(param_1 + 0x325b0);
    if (iVar3 == 1) {
      ...
      *(undefined4 *)(iVar3 + 0x44d0) = 6;
      ...
      uVar12 = FUN_0040a4d0(param_1 + 0x3054c);
      iVar3 = DAT_007934e8;
...
LAB_00446d2b:
      ...
      *(undefined1 *)(param_1 + 0x32f90) = 0;
      ...
      if (iVar3 == 2) {
        ...
        uVar12 = FUN_0040a8c0(uVar12,local_1e5c,uVar7);
        local_4._0_1_ = 8;
        EncodeChecksumState(uVar12);
        local_4._0_1_ = 7;
        FUN_0040a2a0();
        ...
        *(undefined4 *)(DAT_007934e8 + 0x44d0) = 6;
        if (cVar1 == '\0') {
          ...
          *(int *)(iVar3 + 0x44d0) = *(int *)(iVar3 + 0x44d0) + 4;
          ...
          local_4._0_1_ = 9;
          uVar7 = FUN_0040a4d0(&DAT_00e9ba40);
          uVar12 = FUN_0040a8c0(uVar12,local_26ec,uVar7);
          local_4._0_1_ = 10;
          uVar12 = FUN_0040a4d0(uVar12);
          iVar3 = DAT_007934e8;
          *(undefined4 *)(*(int *)(DAT_007934e8 + 0x44d0) + 0x4d0 + DAT_007934e8) = uVar12;
          ...
          *(undefined2 *)(iVar9 + 0x4d4) = 0x6021;
          FUN_0040a4d0(iVar3);
          iVar9 = FUN_00426570();
          uVar12 = FUN_0040a4d0(iVar9 + 0x22c);
          iVar9 = DAT_007934e8;
          *(undefined4 *)(*(int *)(DAT_007934e8 + 0x44d0) + 0x4d0 + DAT_007934e8) = uVar12;
          *(int *)(iVar9 + 0x44d0) = *(int *)(iVar9 + 0x44d0) + 4;
          FUN_0040a4d0(iVar3);
          iVar3 = FUN_00426570();
          uVar12 = FUN_0040a4d0(iVar3 + 8);
          iVar3 = DAT_007934e8;
          *(undefined4 *)(*(int *)(DAT_007934e8 + 0x44d0) + 0x4d0 + DAT_007934e8) = uVar12;
          *(int *)(iVar3 + 0x44d0) = *(int *)(iVar3 + 0x44d0) + 4;
          ...
          local_4._0_1_ = 0xb;
          uVar7 = FUN_0040a4d0(&DAT_00e9ba40);
          uVar12 = FUN_0040a8c0(uVar12,local_22a4,uVar7);
          local_4._0_1_ = 0xc;
          uVar12 = FUN_0040a4d0(uVar12);
          iVar3 = DAT_007934e8;
          *(undefined4 *)(*(int *)(DAT_007934e8 + 0x44d0) + 0x4d0 + DAT_007934e8) = uVar12;
...
LAB_00446f6d:
  ...
  case 0x3d:
    ...
    puVar11 = &local_4518;
    pcVar13 = (char *)FUN_0043dc70(&DAT_00796eec,0xea69);
