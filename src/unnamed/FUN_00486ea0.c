...

{
  ...
  *unaff_FS_OFFSET = &uStack_c;
  pcVar14 = EnterCriticalSection_exref;
  ...
  if (cVar1 != '\0') {
    ...
    iVar3 = PeekPacketChecksumState();
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    if ((iVar3 * 2 <= param_1[0xfe7]) || (cVar1 = FUN_004065a0(), cVar1 != '\0')) {
      ...
      if (cVar1 != '\0') {
        ...
        iVar3 = PeekPacketChecksumState();
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        if ((-1 < iVar3) && (iVar3 < *(int *)(&DAT_006a7720 + DAT_005b3484))) {
          pcVar7 = (char *)(*(int *)(&DAT_006a773c + DAT_005b3484) + iVar3);
          ...
          if (0 < *(int *)(&DAT_006a7724 + DAT_005b3484)) {
            ...
            } while ((int)local_ae4 < *(int *)(&DAT_006a7724 + DAT_005b3484));
          }
        }
...
LAB_0048780a:
        ...
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        FUN_00436070(&DAT_006a7f70 + DAT_005b3484,uVar5,local_ae4);
      ...
      if (iVar3 == 4) {
        ...
        if (local_ae4 == (undefined4 *)0x0) {
          ...
          FUN_00454dc0(local_ae4,0x186a9);
    ...
    if ((cVar1 != '\0') &&
       (cVar1 = PacketChecksumNotEquals(piVar17,*(int *)(&DAT_006a7720 + DAT_005b3484) + -1),
       cVar1 != '\0')) {
      cVar1 = PacketChecksumNotEquals(param_1 + 0x45e,0xfffffeed);
      if ((cVar1 != '\0') &&
         (cVar1 = PacketChecksumNotEquals
                            (param_1 + 0x45e,*(int *)(&DAT_006a7724 + DAT_005b3484) + -1),
         cVar1 != '\0')) {
        uVar5 = FUN_0040a5f0(piVar17,auStack_ac4,8);
        puStack_8 = (undefined1 *)0x0;
        FUN_0040a4d0(param_1 + 0x45e);
        FUN_0040a4d0(uVar5);
        iVar3 = FUN_004e43d0();
        puStack_8 = (undefined1 *)0xffffffff;
        FUN_0040a2a0();
        ...
        uVar5 = FUN_0040a6e0(piVar17,auStack_ac4,8);
        ...
        FUN_0040a2a0();
        FUN_0040a4d0(param_1 + 0x45e);
        FUN_0040a4d0(piVar17);
        iVar3 = FUN_004e4340();
        if (iVar3 != 10000) {
          uVar5 = FUN_0040a6e0(param_1 + 0x45e,auStack_ac4,8);
          ...
          uVar5 = FUN_0040a5f0(param_1 + 0x45e,auStack_ac4,8);
    ...
    uVar5 = FUN_0040a4d0(param_1 + 0x45e);
    uVar6 = FUN_0040a4d0(param_1 + 0x3d5);
  ...
  if (iStack_ab4 != 0) {
    FUN_0040a240();
    FUN_0040b540(&uStack_ad0);
    pcVar14 = EnterCriticalSection_exref;
    pcVar16 = LeaveCriticalSection_exref;
  }
  FUN_0040b180(param_1 + 0x99,auStack_ac8,8);
  ...
  if (cVar2 == '\0') {
    ...
    uVar5 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_690,4);
    uStack_1c = 0x13;
    FUN_0040aca0(param_1[0x3d2] + 0x38,auStack_46c,uVar5);
    uStack_1c = 0x14;
    (*pcVar14)(&DAT_005a9068);
    PeekPacketChecksumState();
    PeekPacketChecksumState();
    (*pcVar16)(&DAT_005a9068);
    if (cVar20 == '\0') {
      uVar5 = FUN_0040a8c0(param_1[0x3d2] + 0x25c,auStack_8bc,4);
      uStack_24 = 0x15;
      uVar5 = FUN_0040aba0(param_1[0x3d2] + 0x38,&fStack_ae0,uVar5);
      uStack_24 = 0x16;
      uVar23 = 0xf0;
      cVar1 = FUN_0040b490(uVar5,iVar3);
      cVar20 = '\0';
...
LAB_00488365:
    ...
    if (cVar20 != '\0') {
      ...
      if (iVar4 + 1 < 3) {
        uVar5 = FUN_0040a500(param_1 + 0x122,auStack_250);
        uStack_24 = 0x17;
        EncodeChecksumState(uVar5);
        uStack_24 = 0xffffffff;
        FUN_0040a2a0();
  ...
  if ((char)((uint)iVar3 >> 0x18) == '\0') {
    ...
    PeekPacketChecksumState();
    (*pcVar16)(&DAT_005a9068);
    cVar1 = FUN_0040b330(param_1 + 0x3d5,0xfffffc18);
...
LAB_00488574:
  ...
  if (cVar1 != '\0') {
    ...
    (*pcVar16)(&DAT_005a9068);
    iVar3 = DAT_005b3484;
    piVar17 = (int *)(&DAT_006a7708 + DAT_005b3484);
    cVar1 = FUN_004065a0();
    if ((cVar1 == '\0') && ((&DAT_006a7758)[iVar3] != '\0')) {
      if (((&DAT_006a7736)[iVar3] == '\x01') &&
         ((uVar23 = iVar4 - *(int *)(&DAT_006a7714 + iVar3) >> 0x1f,
          200 < (int)((iVar4 - *(int *)(&DAT_006a7714 + iVar3) ^ uVar23) - uVar23) ||
          (uVar23 = iVar8 - *(int *)(&DAT_006a7710 + iVar3) >> 0x1f,
          300 < (int)((iVar8 - *(int *)(&DAT_006a7710 + iVar3) ^ uVar23) - uVar23))))) {
...
LAB_00487a8c:
    if (bVar18) {
      ...
      if (cVar1 == '\0') {
        ...
        uVar19 = 100;
        uVar6 = 0;
        FUN_004065a0(uVar5,0,100,0xff,iVar8,0);
...
LAB_00487d3f:
        ...
        cVar1 = FUN_004e4fe0(&DAT_006a7708 + DAT_005b3484,&uStack_ad0,&fStack_ad4,2,1,1);
        if (cVar1 != '\0') {
          uStack_8a4 = 0;
          uStack_ab0 = 0;
          EncodeOutgoingPacketField(0);
          ...
          FUN_004065a0(uVar5,uVar6,uVar19,uVar21,iVar8,uVar22);
          FUN_00432320((char)param_1[0xf],1,1,uVar5,uVar6,uVar19,uVar21,iVar8,uVar22);
...
LAB_00487dd6:
  *(undefined1 *)(param_1 + 5) = 1;
  ...
  PeekPacketChecksumState();
  (*pcVar16)(&DAT_005a9068);
  cVar1 = FUN_00406610(CONCAT13(iVar3 != 4,unaff_EBX));
  if (cVar1 != '\0') {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    uVar5 = PeekPacketChecksumState();
    EncodeOutgoingPacketField(uVar5);
...
LAB_0048812f:
  ...
  if (((char)((uint)unaff_EDI >> 0x18) == '\0') ||
     (cVar1 = FUN_0040b490(param_1 + 0xed2,param_1 + 0xf5b), cVar1 == '\0')) {
    EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    iVar3 = PeekPacketChecksumState();
    iVar4 = PeekPacketChecksumState();
    (*pcVar16)(&DAT_005a9068);
  ...
  iVar3 = DAT_005b3484;
  pbVar15 = (byte *)(DAT_005b3484 + 0x62143);
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  iVar4 = _rand();
  *pbVar15 = (byte)iVar4;
  iVar4 = _rand();
