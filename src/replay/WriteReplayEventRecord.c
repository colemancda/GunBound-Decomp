  ...
  case 0x1030:
    ...
    if ((g_currentGameState != 0xb) || (((int)puVar26 < 1 && (puVar26 != (undefined4 *)0xfffffffd)))
      ...
      *(undefined1 *)((int)puVar24 + 2) = 0;
      pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,6000);
      pcVar13 = pcVar7;
      do {
        cVar4 = *pcVar13;
        pcVar13 = pcVar13 + 1;
      ...
      switch(puVar26) {
      case (undefined4 *)0x0:
        pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x1772);
        pcVar13 = pcVar7;
        do {
          cVar4 = *pcVar13;
          pcVar13 = pcVar13 + 1;
      ...
      case (undefined4 *)0xfffffffc:
        pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x1776);
        pcVar13 = pcVar7;
        do {
          cVar4 = *pcVar13;
          pcVar13 = pcVar13 + 1;
      ...
      case (undefined4 *)0xfffffffd:
        pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x1775);
        pcVar13 = pcVar7;
        do {
          cVar4 = *pcVar13;
          pcVar13 = pcVar13 + 1;
      ...
      case (undefined4 *)0xfffffffe:
        pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x1774);
        pcVar13 = pcVar7;
        do {
          cVar4 = *pcVar13;
          pcVar13 = pcVar13 + 1;
      ...
      case (undefined4 *)0xffffffff:
        pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x1773);
        pcVar13 = pcVar7;
        do {
          cVar4 = *pcVar13;
          pcVar13 = pcVar13 + 1;
        ...
        break;
      default:
        pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x1771);
        pcVar13 = pcVar7;
        do {
          cVar4 = *pcVar13;
          pcVar13 = pcVar13 + 1;
      ...
      if (bVar2 != 0x20) {
        pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x1777);
        pcVar13 = pcVar7;
        do {
          cVar4 = *pcVar13;
          pcVar13 = pcVar13 + 1;
        ...
        if ((bVar2 == 0x54) && (pbVar22[5] == 0x48)) {
          pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x177a);
          pcVar13 = pcVar7;
          do {
            cVar4 = *pcVar13;
            pcVar13 = pcVar13 + 1;
        ...
        if (*pbVar1 == 0x46) {
          if (pbVar22[5] == 0x4d) {
            pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x1778);
            pcVar13 = pcVar7;
            do {
              cVar4 = *pcVar13;
              pcVar13 = pcVar13 + 1;
          ...
          if ((*pbVar1 == 0x46) && (pbVar22[5] == 0x44)) {
            pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x1779);
            pcVar13 = pcVar7;
            do {
              cVar4 = *pcVar13;
              pcVar13 = pcVar13 + 1;
      ...
      if (pbVar22[6] != 0) {
        pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x177b);
        pcVar13 = pcVar7;
        do {
          cVar4 = *pcVar13;
          pcVar13 = pcVar13 + 1;
        ...
        *(undefined1 *)((int)puVar26 + 2) = 0;
        ...
        puVar26 = local_d60;
        pcVar13 = (char *)FUN_0043dc70(&DAT_00796eec,0x177c);
      ...
      if (uVar6 != 0) {
        pcVar7 = (char *)FUN_0043dc70(&DAT_00796eec,0x177e);
        pcVar13 = pcVar7;
        do {
          cVar4 = *pcVar13;
          pcVar13 = pcVar13 + 1;
        ...
        pcVar13 = (char *)FUN_0043dc70(&DAT_00796eec,0x177f);
