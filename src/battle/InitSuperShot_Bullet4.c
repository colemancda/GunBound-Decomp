/* InitSuperShot_Bullet4 - 0x004accf0 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_004accf0).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x5565f8.
 *
...
undefined4 * InitSuperShot_Bullet4(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_005565f8;
  regEsi[0xfe8] = 0xffffffff;
  return regEsi;
}
