/* Mobile09_Destructor - 0x0047f2c0 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  The mobile-type 09 destructor.  Its
 * whole body is the MSVC derived-destructor pattern - install this type's own
 * vtable, then chain to the base:
 *     *this = &PTR_FUN_005560f0;
 *     CMobile_BaseDestructor(this);
 * 0x5560f0 is the vtable the census already labels with this type's
...
void Mobile09_Destructor(undefined4 *regEax)

{
  *regEax = &PTR_FUN_005560f0;
