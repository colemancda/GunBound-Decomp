/* InitSuperShot_Bullet16 - 0x00467a50 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_00467a50).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x555d74.
 *
...
undefined4 InitSuperShot_Bullet16(void)
