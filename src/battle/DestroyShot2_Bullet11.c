/* DestroyShot2_Bullet11 - 0x004731a0 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_00555f38;   install this class's own vtable
...
void DestroyShot2_Bullet11(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00555f38;
