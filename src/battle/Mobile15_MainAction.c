/* Mobile15_MainAction - 0x00466fd0 in the original binary.
 *
 * RENAMED (2026-08-18, from FUN_00466fd0): the mobile's vtable-slot-7 weapon-fire
...
void __thiscall Mobile15_MainAction(int param_1,undefined4 param_2,int param_3)
...
LAB_004670c9:
    ...
    SpawnPrimaryShot(*(undefined1 *)(param_1 + 8),local_1e0c,0xf,0,*(int *)(param_1 + 0xae2c) != 0,uVar7
...
LAB_004673e8:
      ...
      uVar6 = PeekChecksumStateUnderLock(uVar6);
      uVar7 = PeekChecksumStateUnderLock(uVar7);
      SpawnPrimaryShot(*(undefined1 *)(param_1 + 8),local_1e08,0xf,1,*(int *)(param_1 + 0xae2c) != 0,
...
LAB_00467235:
    ...
    uVar6 = PeekChecksumStateUnderLock(uVar6);
    uVar7 = PeekChecksumStateUnderLock(uVar7);
    SpawnPrimaryShot(*(undefined1 *)(param_1 + 8),local_1e08,0xf,1,*(int *)(param_1 + 0xae2c) != 0,uVar7
                 ,uVar6,uVar9,uVar8,uVar3,uVar5);
...
LAB_0046735a:
  ...
  case 8:
    ...
    uVar5 = EncodeChecksumPairDiff(param_1 + 0xb30,local_1be0,param_1 + 0x5620);
    local_4 = 6;
    uVar6 = EncodeChecksumPairSum(param_1 + 0x90c,local_89c,param_1 + 0x53fc);
  ...
  case 10:
    if (param_3 == 2) {
      ...
      uVar6 = PeekChecksumStateUnderLock(uVar6);
      uVar7 = PeekChecksumStateUnderLock(uVar7);
      SpawnSuperShot(*(undefined1 *)(param_1 + 8),0,0xf,*(int *)(param_1 + 0xae2c) != 0,uVar7,uVar6,
      ...
      if (param_3 != 6) {
        if (param_3 == 10) {
          ...
          uVar5 = PeekChecksumStateUnderLock(puVar11);
          uVar6 = EncodeChecksumPairDiff(param_1 + 0xb30,local_1350,param_1 + 0x5eb0);
          local_4 = 0xc;
          uVar7 = EncodeChecksumPairSum(param_1 + 0x90c,local_1798,param_1 + 0x5c8c);
          uVar12 = 1;
          ...
          uVar6 = PeekChecksumStateUnderLock(uVar6);
          uVar7 = PeekChecksumStateUnderLock(uVar7);
          SpawnSuperShot(*(undefined1 *)(param_1 + 8),2,0xf,
      ...
      uVar5 = PeekChecksumStateUnderLock(puVar11);
      uVar6 = EncodeChecksumPairDiff(param_1 + 0xb30,local_ac0,param_1 + 0x5eb0);
      local_4 = 10;
      uVar7 = EncodeChecksumPairSum(param_1 + 0x90c,local_f08,param_1 + 0x5c8c);
      uVar12 = 1;
      ...
      uVar6 = PeekChecksumStateUnderLock(uVar6);
      uVar7 = PeekChecksumStateUnderLock(uVar7);
      SpawnSuperShot(*(undefined1 *)(param_1 + 8),1,0xf,
                   CONCAT31((int3)((uint)*(int *)(param_1 + 0xae2c) >> 8),
