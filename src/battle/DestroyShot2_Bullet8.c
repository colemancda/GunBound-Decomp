/* DestroyShot2_Bullet8 - 0x004a7040 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_00556524;   install this class's own vtable
...
void DestroyShot2_Bullet8(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00556524;
