/* Mobile11_Destructor - 0x004aed20 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  The mobile-type 11 destructor.  Its
 * whole body is the MSVC derived-destructor pattern - install this type's own
 * vtable, then chain to the base:
 *     *this = &PTR_FUN_00556640;
 *     CMobile_BaseDestructor(this);
 * 0x556640 is the vtable the census already labels with this type's
...
void Mobile11_Destructor(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00556640;
