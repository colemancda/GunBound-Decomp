/* InitShot1_Bullet12 - 0x004b17b0 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_004b17b0).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x556680.
 *
...
undefined4 * InitShot1_Bullet12(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  regEsi[0xfe7] = 0;
  regEsi[0x1028] = 0;
  *regEsi = &PTR_FUN_00556680;
  return regEsi;
}
