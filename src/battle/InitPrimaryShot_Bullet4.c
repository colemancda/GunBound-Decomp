/* InitPrimaryShot_Bullet4 - 0x004a2a70 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_004a2a70).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x5564d0.
 *
 ...
 * cell at the file's one argless PeekPacketChecksumState() call: param_1+0x41cc, the ctor's just-seeded cell re-read into the following Encode - InitShot2_Bullet7's shape.
 */
#include "ghidra_types.h"


undefined4 * InitPrimaryShot_Bullet4(undefined4 *param_1)
