/* InitShot2_Bullet3 - 0x00493340 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_00493340).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x5563a8.
 *
...
undefined4 * InitShot2_Bullet3(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_005563a8;
