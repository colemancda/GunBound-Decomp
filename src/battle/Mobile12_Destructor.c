/* Mobile12_Destructor - 0x00471fc0 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  The mobile-type 12 destructor.  Its
 * whole body is the MSVC derived-destructor pattern - install this type's own
 * vtable, then chain to the base:
 *     *this = &PTR_FUN_00555f18;
 *     CMobile_BaseDestructor(this);
 * 0x555f18 is the vtable the census already labels with this type's
...
void Mobile12_Destructor(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00555f18;
