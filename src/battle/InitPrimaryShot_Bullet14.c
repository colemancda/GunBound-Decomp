/* InitPrimaryShot_Bullet14 - 0x0046fad0 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_0046fad0).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x555ea8.
 *
...
undefined4 * InitPrimaryShot_Bullet14(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_00555ea8;
  regEsi[0xfe7] = 0;
  return regEsi;
}
