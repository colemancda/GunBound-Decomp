/* DestroySuperShot_Bullet10 - 0x0044f040 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_00555b18;   install this class's own vtable
...
void DestroySuperShot_Bullet10(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00555b18;
