/* InitShot2_Bullet11 - 0x00473160 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_00473160).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x555f38.
 *
...
undefined4 * InitShot2_Bullet11(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_00555f38;
  return regEsi;
}
