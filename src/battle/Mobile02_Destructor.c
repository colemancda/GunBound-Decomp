/* Mobile02_Destructor - 0x0048d1e0 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  The mobile-type 02 destructor.  Its
 * whole body is the MSVC derived-destructor pattern - install this type's own
 * vtable, then chain to the base:
 *     *this = &PTR_FUN_005562a8;
 *     CMobile_BaseDestructor(this);
 * 0x5562a8 is the vtable the census already labels with this type's
...
void Mobile02_Destructor(undefined4 *regEax)

{
  *regEax = &PTR_FUN_005562a8;
