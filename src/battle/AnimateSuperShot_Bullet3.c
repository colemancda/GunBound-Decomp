/* AnimateSuperShot_Bullet3 - 0x0048d110 in the original binary.
 *
 ...
 * cell at both argless PeekPacketChecksumState() calls: AnimateProjectileTick's shape - object cells beside the already-fixed +0x3920/+0x3d6c Encodes.
 */
#include "ghidra_types.h"


void __fastcall AnimateSuperShot_Bullet3(int *param_1)

{
  ...
  if (cVar1 != '\0') {
    ...
    /* FIXED (2026-07-15): dropped `self` arg - angr-confirmed at 0x48d158
  ...
  if (iVar2 + 1 == 5) {
    ...
    /* FIXED (2026-07-15): dropped `self` arg - angr-confirmed at 0x48d191
