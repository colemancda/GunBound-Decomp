/* Mobile05_Destructor - 0x00454290 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  The mobile-type 05 destructor.  Its
 * whole body is the MSVC derived-destructor pattern - install this type's own
 * vtable, then chain to the base:
 *     *this = &PTR_FUN_00555c14;
 *     CMobile_BaseDestructor(this);
 * 0x555c14 is the vtable the census already labels with this type's
...
void Mobile05_Destructor(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00555c14;
