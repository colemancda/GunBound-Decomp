  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  if (cVar4 == '\0') {
    ...
    if (iStack_ab0 != 0) {
      ...
      TreeLowerBound(apuStack_ae0,&g_valueGuardMap);
      param_1 = piStack_ae8;
    }
...
LAB_0047479a:
    ...
    LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
    ApplyBlastDamage(uStack_aec,puStack_b04,0,local_ae4,iVar5 / iStack_af4,uVar8,(char)param_1[0xf]);
    EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
    ...
    SpawnBlastEffect(puStack_b04,iImpactX,(char)param_1[0xf],7,0,uVar18,uVar8,uVar19,uVar20,uVar21);
  }
  EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
...
LAB_00474cdd:
        ...
        cVar4 = FUN_004e4fe0(iVar6 - iVar11,&DAT_006a7708 + g_clientContext,&uStack_aec,&local_ae4,2,1,1,iVar12);
        if (cVar4 != '\0') {
          uStack_8a4 = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField((void *)auStack_ac4, 0);
...
LAB_00474d7e:
  *(undefined1 *)(piStack_ae8 + 5) = 1;
  ...
  ApplyCraterExcavation(uStack_aec,local_ae4,uVar21,uVar20,uVar19,apuStack_ae0[0],uVar18,uVar8,
                 (int)(&DAT_006a7708 + g_clientContext),(int)iCraterX,(int)iStack_ad8);
  ...
  apuStack_ae0[0] = (undefined4 *)PeekPacketChecksumState((void *)(piVar9 + 0x3d5));
  LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  SpawnFlameEffect(piVar9[2] + 1,apuStack_ae0[0],uVar8,piVar9[0xe25],piVar9 + 0xe26);
  EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
