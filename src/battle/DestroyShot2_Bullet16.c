/* DestroyShot2_Bullet16 - 0x004aafc0 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_005565ac;   install this class's own vtable
...
void DestroyShot2_Bullet16(undefined4 *regEax)

{
  *regEax = &PTR_FUN_005565ac;
