/* InitShot1_Bullet7 - 0x0044c900 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_0044c900).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x555aa4.
 *
...
undefined4 * InitShot1_Bullet7(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_00555aa4;
  return regEsi;
}
