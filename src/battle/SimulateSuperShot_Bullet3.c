...
LAB_0048bc2e:
        ...
        if ((cVar1 == '\0') && (iVar5 = FUN_004511b0(local_15b8,(int)(&DAT_006a7f88 + g_clientContext)), iVar5 != 0)) {
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          iVar5 = _rand();
        ...
        cVar1 = HitTestMobilesAndJewels(local_15bc,(int)(&DAT_006a7f88 + g_clientContext),local_15b8);
        iVar3 = local_15b4;
        if (cVar1 != '\0') {
...
LAB_0048c664:
        ...
        cVar1 = PeekPacketChecksumBool((byte *)(local_15b4 + 0x3918));
        if ((cVar1 == '\0') && (iVar3 = FUN_004511b0(iVar3,(int)(&DAT_006a7f88 + g_clientContext)), iVar3 != 0)) {
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          iVar3 = _rand();
          *pbVar11 = (byte)iVar3;
          iVar3 = _rand();
        ...
        cVar1 = HitTestMobilesAndJewels(local_15b8,(int)(&DAT_006a7f88 + g_clientContext),local_15c4);
        iVar3 = local_15b4;
        if (cVar1 != '\0') {
