/* SimulateShot_Bullet7n_9s_7p_9p - 0x0049aeb0 in the original binary.
 *
 ...
 * (local_1574 / local_1350 / local_89c / local_ce4 / local_454 /
 * local_112c / local_230 / local_ac0 / local_f08 / local_678).  The
 * block-head peek pairs and the lone Encodes use frame[0x40] = the C's
 * local_1598 = param_1 + 0x15c0; like SimulateShot2_Bullet11 this
 * variant reads the destination cells directly at 0x49b6b1/0x49b6cf and
 * mirror (`[esp+0x24] + 0x6ac` / `+ 0x488` = param_1+0x1ab / +0x122).
 * The two four-Encode groups write param_1 + 0x10/0x99/0x3d5/0x45e.
 */
...
void __thiscall SimulateShot_Bullet7n_9s_7p_9p(int param_1,int param_2)

{
  ...
  *unaff_FS_OFFSET = &local_c;
  ...
  if ((*(int *)(local_1574 + 0x14)) != 0) {
    ...
    TreeLowerBound(local_1588,&DAT_00793770);
  }
  ...
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  local_1580[0] = PeekPacketChecksumState((void *)(local_1574));
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  ...
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar11 = PeekPacketChecksumState((void *)(local_1350));
  local_1588[0] = uVar11;
  LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
    ...
    if (0 < (int)local_15a8[0]) {
      ...
      do {
        ...
        if ((!bVar2) && (iVar19 = FUN_004510f0(local_15ac), iVar19 != 0)) {
          ...
          local_4 = 6;
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar19 = PeekPacketChecksumState((void *)(local_89c));
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          if (iVar19 < 0x14) {
LAB_0049b2e9:
            ...
            bVar4 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            iVar19 = PeekPacketChecksumState((void *)(local_ce4));
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            if (iVar19 < 0x14) {
              uVar10 = 0x14;
            }
            ...
            bVar5 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            iVar19 = PeekPacketChecksumState((void *)(local_112c));
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          ...
          local_4 = 6;
          if ((bVar5) && (bVar5 = false, (*(int *)(local_112c + 0x14)) != 0)) {
            ScrambleChecksumGuardBytes();
            TreeLowerBound(local_1588,&DAT_00793770);
          }
          local_4 = 0xffffffff;
        ...
        if ((cVar9 == '\0') && (iVar18 = FUN_004511b0(local_15ac,(int)(&DAT_006a7f88 + g_clientContext)), iVar18 != 0)) {
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar18 = _rand();
        ...
        EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        iVar18 = PeekPacketChecksumState((void *)(local_1598));
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        uVar11 = local_15ac;
        if (iVar18 == 0) {
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar18 = PeekPacketChecksumState((void *)(param_1 + 0x1ab));
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar19 = PeekPacketChecksumState((void *)(param_1 + 0x122));
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          uVar11 = local_15ac;
        ...
        if ((((-1 < (int)uVar11) && ((int)uVar11 < *(int *)(&g_nCameraBoundX + g_clientContext))) &&
          ...
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          EncodeOutgoingPacketField((void *)(param_1 + 0x99), local_15a0 << 8);
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          EncodeOutgoingPacketField((void *)(param_1 + 0x3d5), local_15b0);
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          EncodeOutgoingPacketField((void *)(param_1 + 0x45e), local_15a0);
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar18 = _rand();
...
LAB_0049bfbb:
          ...
          *(byte *)(param_1 + 0xf46) = bVar12 | bVar17;
          ...
          if (DAT_0079352a != '\0') {
            ...
            (&g_abBroadcastEventBuffer)[g_dwBroadcastEventCursor] = *(undefined1 *)(param_1 + 8);
            puVar1 = (uint *)(&DAT_00e9aacd + g_dwBroadcastEventCursor);
            g_dwBroadcastEventCursor = g_dwBroadcastEventCursor + 1;
            *puVar1 = local_15b0;
            puVar1 = (uint *)(&DAT_00e9aad0 + g_dwBroadcastEventCursor);
    ...
    if (0 < iVar18) {
      ...
      do {
        ...
        if ((!bVar2) && (iVar13 = FUN_004510f0(local_15b0), iVar14 = local_1598, iVar13 != 0)) {
          ...
          local_4 = 10;
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          local_15a8[0] = PeekPacketChecksumState((void *)(local_230));
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
...
LAB_0049b9fa:
            ...
            bVar7 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            local_15a8[0] = PeekPacketChecksumState((void *)(local_ac0));
            LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            if ((int)local_15a8[0] < 0x14) {
              uVar10 = 0x14;
            }
              ...
              bVar6 = true;
              EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
              uVar10 = PeekPacketChecksumState((void *)(local_f08));
              LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
            }
          }
          else {
          ...
          uVar11 = (*(int *)(local_ac0 + 0x14));
          local_4 = 0xb;
          if ((bVar7) && (bVar7 = false, (*(int *)(local_ac0 + 0x14)) != 0)) {
            ScrambleChecksumGuardBytes();
            local_15a8[0] = uVar11;
            TreeLowerBound(local_1580,&DAT_00793770);
          }
          uVar11 = (*(int *)(local_678 + 0x14));
          local_4 = 10;
          if ((bVar8) && (bVar8 = false, (*(int *)(local_678 + 0x14)) != 0)) {
            ScrambleChecksumGuardBytes();
            local_15a8[0] = uVar11;
            TreeLowerBound(local_1580,&DAT_00793770);
          }
        ...
        cVar9 = PeekPacketChecksumBool((byte *)(param_1 + 0x3918));
        if ((cVar9 == '\0') && (iVar14 = FUN_004511b0(local_15b0,(int)(&DAT_006a7f88 + g_clientContext)), iVar14 != 0)) {
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          iVar14 = _rand();
        ...
        EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        iVar14 = PeekPacketChecksumState((void *)(local_1598));
        LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
        uVar11 = local_15b0;
        if (iVar14 == 0) {
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          ...
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          local_15a8[0] = PeekPacketChecksumState((void *)(param_1 + 0x122));
          LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
          uVar11 = local_15b0;
