/* InitSuperShot_Bullet12 - 0x004ae370 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_004ae370).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x55661c.
 *
...
undefined4 * InitSuperShot_Bullet12(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_0055661c;
  regEsi[0xfe7] = 0;
  return regEsi;
}
