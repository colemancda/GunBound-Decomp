/* Mobile04_Destructor - 0x00489570 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  The mobile-type 04 destructor.  Its
 * whole body is the MSVC derived-destructor pattern - install this type's own
 * vtable, then chain to the base:
 *     *this = &PTR_FUN_00556264;
 *     CMobile_BaseDestructor(this);
 * 0x556264 is the vtable the census already labels with this type's
...
void Mobile04_Destructor(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00556264;
