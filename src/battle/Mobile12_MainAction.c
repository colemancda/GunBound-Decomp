/* Mobile12_MainAction - 0x00471fd0 in the original binary.
 *
 * RENAMED (2026-08-18, from FUN_00471fd0): the mobile's vtable-slot-7 weapon-fire
 ...
 *
 * DROPPED-ARG FIX (2026-08-11): all 38 argless PeekChecksumStateUnderLock()
 * calls now pass their guarded-cell pointer, recovered from
 * tools/underlock_push_sites.json + per-site disasm of the original. In
 * this degraded decompile Ghidra modeled each original `push` as a raw
 * stack-slot store: the `puStack_/uStack_/iStack_ = 0x4xxxxx` artifact
 * right before each call is the call's own return-address push
 * (value = call site + 5), and the store to the adjacent slot (retaddr
 * slot + 4) just before it is the pushed cell itself. Every site was
 * matched to its original call address that way and now passes that
 * slot variable (mirroring the file's pre-existing with-arg idiom, e.g.
...
void __thiscall Mobile12_MainAction(int param_1,undefined4 param_2,int param_3)

{
  ...
  *unaff_FS_OFFSET = &local_c;
  ...
  default:
    ...
    if (g_soundAvailable != '\0') {
      if (iVar2 != -1) {
        ...
        (**(code **)(**(int **)(g_soundChannels + iVar2 * 4) + 0xc))();
      }
      if (iVar2 == 0) {
        DAT_00793568 = 0;
      }
  ...
  case 5:
    ...
    uVar7 = PeekChecksumStateUnderLock(puStack_4d48);
    puStack_4d48 = (undefined *)0x4720ae;
    cVar3 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfbe));
    if (cVar3 == '\x01') {
LAB_004720c9:
      local_4d34 = 0;
    }
      ...
      cVar3 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfc1));
      local_4d34 = 8;
    ...
    iStack_4d50 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfcd));
    iStack_4d58 = param_1 + 0x7864;
    uStack_4d5c = 0x472160;
    uStack_4d54 = uVar4;
    iStack_4d58 = PeekChecksumStateUnderLock(iStack_4d58);
    uStack_4d60 = 0x472167;
    uStack_4d5c = uVar8;
    uStack_4d5c = PeekChecksumStateUnderLock(uStack_4d5c);
    uStack_4d64 = 0x47216e;
    uStack_4d60 = uVar9;
    uStack_4d60 = PeekChecksumStateUnderLock(uStack_4d60);
    uStack_4d68 = 0x472179;
    uStack_4d64 = uVar10;
    uVar11 = PeekChecksumStateUnderLock(uStack_4d64);
...
LAB_00472811:
      ...
      uStack_4d64 = uVar5;
      uStack_4d64 = PeekChecksumStateUnderLock(uStack_4d64);
      ...
      uStack_4d68 = PeekChecksumStateUnderLock(puStack_4d7c);
...
LAB_0047299f:
      ...
      iStack_4d84 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfcd));
      iStack_4d90 = 0x472a12;
      iStack_4d8c = iVar1;
      uStack_4d88 = uVar4;
      iStack_4d8c = PeekChecksumStateUnderLock(iStack_4d8c);
      uStack_4d94 = 0x472a19;
      iStack_4d90 = iVar2;
      iStack_4d90 = PeekChecksumStateUnderLock(iStack_4d90);
      uStack_4d94 = uStack_4d60;
      uStack_4d98 = 0x472a24;
      uStack_4d94 = PeekChecksumStateUnderLock(uStack_4d94);
      uStack_4d98 = uStack_4d5c;
      uStack_4d9c = 0x472a2f;
      uStack_4d98 = PeekChecksumStateUnderLock(uStack_4d98);
      ...
      uStack_4d9c = PeekChecksumStateUnderLock(puStack_4db0);
...
LAB_00472abf:
      ...
      iStack_4db8 = iVar1;
      uStack_4d94 = EncodeChecksumDeltaSub();
      puStack_4db0 = (undefined *)0x1;
      puStack_4db4 = auStack_2d68;
      uStack_6c = 0x17;
      iStack_4db8 = iVar2;
      iStack_4d90 = EncodeChecksumDeltaSub();
      ...
      uStack_4d88 = EncodeChecksumPairDiff();
      ...
      iStack_4d8c = EncodeChecksumPairSum();
      ...
      iStack_4db8 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfcd));
      uVar7 = uVar4;
      uVar8 = PeekChecksumStateUnderLock(uStack_4d94);
      ...
      uVar7 = PeekChecksumStateUnderLock(puVar12);
      cVar3 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfbe));
      if (cVar3 == '\x01') {
LAB_00472c47:
        uVar8 = 3;
      ...
      uVar9 = EncodeChecksumDeltaSub(iVar1,auStack_1834,10);
      uStack_a0 = 0x1b;
      uVar10 = EncodeChecksumDeltaSub(iVar2,auStack_1c7c,2);
      SUBFIELD(uStack_a0,0,undefined1) = 0x1c;
      uVar5 = EncodeChecksumPairDiff(param_1 + 0xb30,auStack_20c4,param_1 + 0x5a68);
...
LAB_00472523:
      ...
      uStack_6c = 9;
      iStack_4db8 = iVar2;
      iStack_4d90 = EncodeChecksumDeltaAdd();
      puStack_4db0 = (undefined *)(param_1 + 0x5a68);
...
LAB_004726ab:
      ...
      uVar9 = EncodeChecksumDeltaSub(iVar1,auStack_1610,10);
      uStack_a0 = 0xd;
      uVar10 = EncodeChecksumDeltaAdd(iVar2,auStack_2b78,2);
      SUBFIELD(uStack_a0,0,undefined1) = 0xe;
      uVar5 = EncodeChecksumPairDiff(param_1 + 0xb30,&iStack_4db8,param_1 + 0x5a68);
...
LAB_00472eec:
        ...
        cVar3 = InitChecksumSeed();
        if (cVar3 == '\0') {
          puStack_4d48 = &DAT_007949c8;
          puStack_4d4c = (undefined1 *)0x472eff;
          puStack_4d48 = (undefined *)PeekChecksumStateUnderLock(puStack_4d48);
...
LAB_00472e11:
    ...
    uVar7 = EncodeChecksumPairDiff();
    puStack_4d48 = (undefined *)(param_1 + 0x53fc);
    puStack_4d4c = local_1350;
    iStack_4d50 = param_1 + 0x90c;
    local_4 = 0x1f;
    uStack_4d54 = 0x472e56;
    uVar8 = EncodeChecksumPairSum();
    ...
    puStack_4d4c = (undefined1 *)PeekChecksumStateUnderLock(puStack_4d4c);
    iStack_4d50 = param_1 + 0x4d90;
    uStack_4d54 = 0x472e83;
    iStack_4d50 = PeekChecksumStateUnderLock(iStack_4d50);
    iStack_4d58 = 0x472e8a;
    uStack_4d54 = uVar7;
    uStack_4d54 = PeekChecksumStateUnderLock(uStack_4d54);
