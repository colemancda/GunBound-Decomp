/* DestroyShot1_Bullet7 - 0x0044c940 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_00555aa4;   install this class's own vtable
...
void DestroyShot1_Bullet7(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00555aa4;
