/* Mobile00_Destructor - 0x0044e910 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  The mobile-type 00 destructor.  Its
 * whole body is the MSVC derived-destructor pattern - install this type's own
 * vtable, then chain to the base:
 *     *this = &PTR_FUN_00555af8;
 *     CMobile_BaseDestructor(this);
 * 0x555af8 is the vtable the census already labels with this type's
...
void Mobile00_Destructor(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00555af8;
