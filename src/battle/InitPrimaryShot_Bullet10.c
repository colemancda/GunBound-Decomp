/* InitPrimaryShot_Bullet10 - 0x004812d0 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_004812d0).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x556160.
 *
...
undefined4 * InitPrimaryShot_Bullet10(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_00556160;
  return regEsi;
}
