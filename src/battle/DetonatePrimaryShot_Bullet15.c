/* DetonatePrimaryShot_Bullet15 - 0x0047b2f0 in the original binary.
 *
 * RENAMED (2026-08-16, from FUN_0047b2f0): CProjectile virtual slot 6
 * (DetonateProjectile, base impl 0x4572b0) override for mobile type 14's
 * shot 1 AND shot 2 (one class for both, textures bullet15n/bullet15s);
 * vtable 0x556058, ctor InitPrimaryShot_Bullet15 reached only through
 * SpawnPrimaryShot's case 14. Type/role CONFIRMED via vtable geometry
 ...
 * Same skeleton as the FUN_0047de50 / DetonateSuperShot_Bullet10 pair (this=EBP,
 ...
 * 0x47b530/0x47b553) to FUN_0047fad0 instead of the three-cell FUN_0047c3f0 call.
 * Line-for-line twin of FUN_00481320.  See FUN_0047de50.c for the derivation.
 */
#include "ghidra_types.h"


/* WARNING: Removing unreachable block (ram,0x0047b393) */

void __fastcall DetonatePrimaryShot_Bullet15(int *param_1)
...
LAB_0047b4f8:
  ...
  if (cVar5 == '\0') {
     ...
     * (same structure as DetonateSuperShot_Bullet10.c, confirmed identical via
  ...
  if ((cVar20 == '\0') || (cVar5 = CompareChecksumPair(param_1 + 0xed2,param_1 + 0xf5b), cVar5 == '\0')) {
    ...
    if ((cVar5 == '\0') ||
       ((cVar5 = CompareChecksumExceeds(param_1 + 0xed2,param_1 + 0xf5b), cVar5 == '\0' ||
        (param_1[0xed1] < 6)))) goto LAB_0047bdb8;
  }
  iVar8 = g_clientContext;
...
LAB_0047bdb8:
  *unaff_FS_OFFSET = uStack_28;
  return;
joined_r0x0047b3d1:
  if ((*(byte *)(param_1 + 0xf) & 0x80000007) < uVar12) goto LAB_0047b3df;
