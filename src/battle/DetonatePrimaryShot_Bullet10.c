/* DetonatePrimaryShot_Bullet10 - 0x00481320 in the original binary.
 *
 ...
 * cell at all 26 argless PeekPacketChecksumState() calls (worklist 26).
 * Same skeleton as the DetonateSuperShot_Bullet15 / DetonateSuperShot_Bullet10 pair (this=EBP,
 * projectile cells param_1+0x10/0x99/0x122/0x1ab/0x234/0x3d5/0x45e/
 * 0xe48/0xed2, guarded cell POINTER g_clientContext+0x5b85c, chained
 * EncodeChecksumDeltaShr returns captured in pvDelta / kept in local_ad0,
 * X/Y cell pointers parked in frame[0x18]/frame[0x20] for the tail),
 * minus one peek: the found-node block hands X/Y (this+0x1178/+0xf54,
 * 0x481560/0x481583) to FUN_0047fad0 instead of the three-cell FUN_0047c3f0 call.
 * Line-for-line twin of DetonatePrimaryShot_Bullet15.  See DetonateSuperShot_Bullet15.c for the derivation.
 */
...
void __fastcall DetonatePrimaryShot_Bullet10(int *param_1)

{
   ...
   * the `PeekPacketChecksumState();` call below (line ~302) so it can be
  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  local_ad0 = (int *)0x0;
  /* FIXED (2026-07-15): dropped `self` arg - angr-confirmed at 0x481370
   * (`lea edi,[ebp+0x40]` at 0x481354, ebp = this file's own param_1,
  ...
  /* FIXED (2026-07-15): dropped `self` arg - angr-confirmed at 0x4813ac
   * (`lea edi,[ebp+0x264]` at 0x481387) the cell is param_1+0x99
   * (scaled), the same cell EncodeChecksumDeltaShr(param_1 + 0x99, ...)
   * below already addresses. See
   * tools/encodeoutgoingpacketfield_sites.json. */
  EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  local_ac8 = PeekPacketChecksumState((void *)(param_1 + 0x99));
...
LAB_00481528:
  ...
  if (cVar5 == '\0') {
     ...
     * 0x481842 (`lea edi,[ebp+0xf54]` at 0x48183c): cell = param_1+0x3d5
     * (scaled). Note: per JSON this is listed as "site3" in address
     * order (call_addr 0x481625, edi = dword ptr [esp+0x14]) but that
     ...
     * structure as DetonateSuperShot_Bullet10.c, confirmed via objdump at this
    ...
    uStack_c = 3;
    /* FIXED (2026-07-15): dropped `self` arg - angr-confirmed at
     * 0x4818c7 (`mov edi,dword ptr [esp+0x20]`, that stack slot was
    ...
    if (cVar7 == '\0') {
      ...
      EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
      uVar12 = PeekPacketChecksumState((void *)(param_1 + 0x122));
      (*pcVar17)(&g_valueGuardLock);
      ...
      if (cVar7 == '\0') {
        ...
        uStack_10 = 6;
        uVar10 = EncodeChecksumPairSum(param_1[0x3d2] + 0x38,auStack_acc,uVar10);
        uStack_10 = 7;
        bVar4 = true;
        bVar3 = true;
...
LAB_00481a4d:
    ...
    if (cVar5 == '\0') {
      ...
      if (((cVar5 != '\0') ||
          ...
          )) || (cVar5 = PacketChecksumLessThan(uVar10,0xfffffc18), cVar5 != '\0')) goto LAB_00481c0c;
    }
    else {
LAB_00481c0c:
  ...
  *(undefined1 *)(param_1 + 5) = 1;
  if (iVar8 != 0) {
    ...
    LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
    FUN_0047fad0(uVar11,uVar10,(char)param_1[0xfe7],param_1[2],(int *)iVar8);
    pcVar18 = (code *)EnterCriticalSection;
  }
   ...
   * isn't lost. */
  uVar19 = PeekPacketChecksumState((void *)(g_clientContext + 0x5b85c));
  ...
  if (cVar5 != '\0') {
    ...
    /* FIXED (2026-07-15): dropped `self` arg - angr-confirmed at
     * 0x481625 (`mov edi,dword ptr [esp+0x14]`) that stack slot holds
...
joined_r0x00481401:
  ...
  if (uVar12 == (*(byte *)(param_1 + 0xf) & 0x80000007)) {
    ...
    local_4 = 0;
    pvDelta = EncodeChecksumDeltaShr(param_1 + 0x10,local_89c,8);
    SUBFIELD(local_4,0,undefined1) = 1;
    EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
    local_ad0 = (int *)PeekPacketChecksumState((void *)(local_ad0));
    LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
    EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
    uVar10 = PeekPacketChecksumState((void *)(pvDelta));
    LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
