/* DetonateSuperShot_Bullet7 - 0x00499ef0 in the original binary.
 *
 * RENAMED (2026-08-16, from FUN_00499ef0): CProjectile virtual slot 6
 * (DetonateProjectile, base impl 0x4572b0) override for mobile type 6's
 * super shot (texture bullet7p; vtable 0x556424, ctor InitSuperShot_Bullet7 reached
 * only through SpawnSuperShot's case 6). Type/role CONFIRMED via vtable
 ...
 *
 * DROPPED-CELL FIX (2026-08-16, CValueGuard sweep): recovered the cell at
 * all 9 remaining 1-arg EncodeOutgoingPacketField() calls (the peeks were
 * done in an earlier pass).  this=ESI: param_1 + 0x10 / 0x99 / 0x3d5 /
 * 0x45e / 0xe48.  The four `Encode(...,0)` initialisers target the two
 * stack cells frame[0x40] = auStack_ac4 and frame[0x264] = auStack_8a0;
 * block order was matched by the SyncOutgoingChecksumField landmarks the
 * C keeps (the block that syncs auStack_ac4 owns the pair whose second
 ...
 * out into a callee.  DetonateSuperShot_Bullet2_8_11, DetonateSuperShot_Bullet7 and DetonateSuperShot_Bullet3_5_14 are
 ...
 * flip task must size+declare it (0x224) first.
 */
#include "ghidra_types.h"


void __fastcall DetonateSuperShot_Bullet7(int *param_1)

{
  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  EncodeOutgoingPacketField((void *)(param_1 + 0x99), iVar4 + iVar3);
  LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  (**(code **)(*param_1 + 0x14))(8);
  ...
  if (cVar2 == '\0') {
    ...
    if (iStack_ab4 != 0) {
      ...
      TreeLowerBound(&piStack_ad4,&g_valueGuardMap);
      pcVar13 = (code *)LeaveCriticalSection;
    }
...
LAB_0049a03a:
    ...
    LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
    ApplyBlastDamage(uStack_ad8,puStack_af0,0,uStack_adc,iVar3 / local_ae4,uVar6,(char)param_1[0xf]);
    EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
    ...
    SpawnBlastEffect(puStack_af0,iImpactX,(char)param_1[0xf],7,0,uVar17,uVar6,uVar18,uVar19,uVar20);
  }
  EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  ...
  if (iVar4 == 4) {
    ...
    while (uVar10 < 0x186ab) {
      if (uVar10 == 0x186aa) {
        ...
        bVar16 = true;
        piStack_ad4 = piVar15;
        if (piVar15[2] == 0) goto LAB_0049a2b5;
        break;
      }
...
LAB_0049a57d:
        ...
        cVar2 = FUN_004e4fe0(iVar4 - iVar8,&DAT_006a7708 + g_clientContext,&uStack_ad8,&uStack_adc,2,1,1,iVar9);
        if (cVar2 != '\0') {
          auStack_8a4[0] = 0;
          iStack_ab0 = 0;
          EncodeOutgoingPacketField((void *)(auStack_ac4), 0);
...
LAB_0049a61e:
  *(undefined1 *)(param_1 + 5) = 1;
  ...
  if (cVar2 != '\0') {
    ...
    EncodeOutgoingPacketField((void *)(param_1 + 0xe48), uVar6);
    LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  }
  EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  ...
  if ((iVar4 <= iVar3) || (cVar2 = CompareChecksumPair(param_1 + 0xed2,param_1 + 0xf5b), cVar2 == '\0')) {
    ...
    if ((iVar3 <= iVar4) ||
       ((cVar2 = CompareChecksumExceeds(param_1 + 0xed2,param_1 + 0xf5b), cVar2 == '\0' ||
        (param_1[0xed1] < 6)))) goto LAB_0049ae89;
  }
  iVar3 = g_clientContext;
