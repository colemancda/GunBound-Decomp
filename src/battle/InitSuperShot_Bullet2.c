/* InitSuperShot_Bullet2 - 0x0048d8c0 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_0048d8c0).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x5562c8.
 *
...
undefined4 * InitSuperShot_Bullet2(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_005562c8;
  return regEsi;
}
