/* DeleteShot2_Bullet2 - 0x004a4810 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  slot 0, the scalar-deleting destructor of the Shot2_Bullet2 class's
 * vtable.  The class was already fixed by a slot UNIQUE to that vtable (see
 * the InitShot2_Bullet2 / DestroyShot2_Bullet2 notes); this slot's role comes from the
...
void * __thiscall DeleteShot2_Bullet2(void *param_1,int param_2)
