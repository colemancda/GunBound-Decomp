/* InitShot1_Bullet9_16 - 0x0046e550 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_0046e550).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x555e88.
 *
...
undefined4 * InitShot1_Bullet9_16(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_00555e88;
  return regEsi;
}
