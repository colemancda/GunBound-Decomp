/* DeleteShot2_Bullet13 - 0x0049e5b0 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  slot 0, the scalar-deleting destructor of the Shot2_Bullet13 class's
 * vtable.  The class was already fixed by a slot UNIQUE to that vtable (see
 * the InitShot2_Bullet13 / DestroyShot2_Bullet13 notes); this slot's role comes from the
...
void * __thiscall DeleteShot2_Bullet13(void *param_1,int param_2)
