/* DestroyShot1_Bullet8 - 0x00482540 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_005561a8;   install this class's own vtable
...
void DestroyShot1_Bullet8(undefined4 *regEax)

{
  *regEax = &PTR_FUN_005561a8;
