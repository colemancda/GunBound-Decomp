/* InitSuperShot_Bullet10 - 0x0044f000 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_0044f000).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x555b18.
 *
...
undefined4 * InitSuperShot_Bullet10(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_00555b18;
  return regEsi;
}
