/* InitSuperShot_Bullet9 - 0x004907d0 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_004907d0).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x556360.
 *
...
undefined4 * InitSuperShot_Bullet9(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_00556360;
  return regEsi;
}
