...

{
  ...
  if ((((impactX < 0) || (*(int *)(&g_nCameraBoundX + g_clientContext) <= impactX)) || (impactY < 0)
    ...
    *(undefined4 *)(terrainCtx + 0x854) = 0xffffffff;
    ...
    ;
    if (iVar3 == 0) {
      CarveTerrainCrater(impactX,impactY,param_4,param_1,terrainCtx);
...
LAB_004e4ac8:
      ...
      CarveTerrainCrater(impactX,impactY,param_5,param_2,terrainCtx);
      ...
      *(int *)(terrainCtx + 0x854) = impactY - param_2 / 2;
      ...
      CarveTerrainCrater(impactX,impactY,param_6,param_3,terrainCtx);
