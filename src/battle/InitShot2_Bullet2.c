/* InitShot2_Bullet2 - 0x004a46f0 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_004a46f0).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x5564f0.
 *
 ...
 * cell at the file's one argless PeekPacketChecksumState() call: param_1+0x42d4, the ctor's just-seeded cell - InitShot2_Bullet7's shape.
 */
#include "ghidra_types.h"


undefined4 * InitShot2_Bullet2(undefined4 *param_1)

{
  ...
  *(undefined1 *)(param_1 + 0x124f) = 0;
  ...
  EnterCriticalSection((LPCRITICAL_SECTION)&DAT_005a9068);
  uVar1 = PeekPacketChecksumState((void *)((int)param_1 + 0x42d4));
