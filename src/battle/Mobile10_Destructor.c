/* Mobile10_Destructor - 0x00475e30 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  The mobile-type 10 destructor.  Its
 * whole body is the MSVC derived-destructor pattern - install this type's own
 * vtable, then chain to the base:
 *     *this = &PTR_FUN_00555f7c;
 *     CMobile_BaseDestructor(this);
 * 0x555f7c is the vtable the census already labels with this type's
...
void Mobile10_Destructor(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00555f7c;
