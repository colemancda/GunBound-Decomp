/* DestroySuperShot_Bullet9 - 0x00490810 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_00556360;   install this class's own vtable
...
void DestroySuperShot_Bullet9(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00556360;
