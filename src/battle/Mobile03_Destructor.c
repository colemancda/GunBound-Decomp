/* Mobile03_Destructor - 0x004b31e0 in the original binary.
 *
 * NAMED 2026-08-19 (was a FUN_ name).  The mobile-type 03 destructor.  Its
 * whole body is the MSVC derived-destructor pattern - install this type's own
 * vtable, then chain to the base:
 *     *this = &PTR_FUN_005566a0;
 *     CMobile_BaseDestructor(this);
 * 0x5566a0 is the vtable the census already labels with this type's
...
void Mobile03_Destructor(undefined4 *regEax)

{
  *regEax = &PTR_FUN_005566a0;
