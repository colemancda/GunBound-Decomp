...

{
  ...
  *unaff_FS_OFFSET = &local_c;
  ...
  case 5:
    ...
    cVar4 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfbe));
    if ((cVar4 == '\x01') || (cVar4 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfc1)), cVar4 == '\x01')) {
      uVar7 = 0;
    }
    else {
      uVar7 = 8;
    ...
    SpawnPrimaryShot(*(undefined1 *)(param_1 + 8),uVar7,3,0,*(int *)(param_1 + 0xae2c) != 0,uVar9,uVar8,
...
LAB_004b3445:
      ...
      cVar4 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfc1));
      local_19cc = 8;
    ...
    uVar8 = PeekChecksumStateUnderLock(uVar8);
    SpawnPrimaryShot(*(undefined1 *)(param_1 + 8),local_19cc,3,1,
                 CONCAT31((int3)((uint)*(int *)(param_1 + 0xae2c) >> 8),
                          *(int *)(param_1 + 0xae2c) != 0),uVar8,uVar7,uVar10,uVar9,uVar5,uVarPB, uVar6, 3);
    uStack_38 = 2;
    ScrubChecksumGuard();
...
LAB_004b356f:
    ...
    uVar8 = PeekChecksumStateUnderLock(uVar8);
    uVar9 = PeekChecksumStateUnderLock(uVar9);
    SpawnPrimaryShot(*(undefined1 *)(param_1 + 8),uVar6,3,1,
                 CONCAT31((int3)((uint)*(int *)(param_1 + 0xae2c) >> 8),
                          *(int *)(param_1 + 0xae2c) != 0),uVar9,uVar8,uVar11,uVar10,uVar7,uVarPB, uVar5, 3);
    uStack_6c = 4;
    ScrubChecksumGuard();
...
LAB_004b368d:
    ...
    SpawnPrimaryShot(*(undefined1 *)(param_1 + 8),uVar6,3,1,
                 CONCAT31((int3)((uint)*(int *)(param_1 + 0xae2c) >> 8),
                          *(int *)(param_1 + 0xae2c) != 0),uVar9,uVar7,uVar11,uVar10,uVar8,uVarPB, uVar5, 3);
    local_4 = 6;
    ScrubChecksumGuard();
    local_4 = 0xffffffff;
    ScrubChecksumGuard();
...
joined_r0x004b376c:
    ...
    cVar4 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfbe));
    if ((cVar4 == '\0') && (cVar4 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfc1)), cVar4 == '\0')) {
LAB_004b38c8:
  ...
  case 8:
    ...
    uVar7 = PeekChecksumStateUnderLock(uVar7);
    SpawnItemProjectile(*(undefined1 *)(param_1 + 8),uVar5,uVar7,uVar6,uVar9,uVar8,uVar12);
    local_4 = 8;
    ScrubChecksumGuard();
    local_4 = 0xffffffff;
    ScrubChecksumGuard();
  ...
  case 10:
    if (param_3 == 6) {
      ...
      uVar14 = 1;
      local_4 = 0xb;
      uVar9 = PeekPacketChecksumBool((byte *)(param_1 + 0xbfcd));
      uVar10 = PeekChecksumStateUnderLock(param_1 + 0x7864);
      uVar11 = PeekChecksumStateUnderLock(param_1 + 0x4d90);
      uVar7 = PeekChecksumStateUnderLock(uVar7);
      uVar8 = PeekChecksumStateUnderLock(uVar8);
      SpawnSuperShot(*(undefined1 *)(param_1 + 8),0,3,*(int *)(param_1 + 0xae2c) != 0,uVar8,uVar7,
