/* DestroyShot1_Bullet12 - 0x004b1800 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_00556680;   install this class's own vtable
...
void DestroyShot1_Bullet12(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00556680;
