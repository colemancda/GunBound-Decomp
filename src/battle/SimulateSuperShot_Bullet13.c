/* SimulateSuperShot_Bullet13 - 0x004857f0 in the original binary.
 *
 * RENAMED (2026-08-16, from FUN_004857f0): CProjectile virtual slot 5
 * (SimulateProjectileFrame, base impl 0x455cc0) override for mobile type
 * 12's super shot (texture bullet13p; vtable 0x55620c, ctor InitSuperShot_Bullet13
 * reached only through SpawnSuperShot's case 12). Type/role CONFIRMED via
 ...
 * EncodeOutgoingPacketField() calls (38 sites).  KEY FACT established
 * here and reusable across the whole guard family: the delta/pair
 * helpers (0x40a5f0 DeltaAdd, 0x40b180 DeltaShr, 0x40aca0 PairDiff, ...)
 * return their SECOND argument - the caller's stack scratch cell - not
 * their destination (epilogue `mov eax,esi` where ESI is the arg2 object
 * whose +0x14/+0x220 fields the C then tests).  So every Peek that
 * follows one of them reads that scratch buffer, and the cell can be
 * spelled with the C's own local: local_1574 / local_112c / local_f08 /
 * local_454 / local_89c / local_1350 / local_ce4 / local_ac0 /
 * local_230 / local_678.  The two per-copy peeks at 0x485fb8/0x485fed
 * (and mirrors) read frame[0x40], loaded once in the loop preheader at
 * 0x485b4e = the C's local_1598 = param_1+0x15c0; that is also the cell
 * of the Encode at 0x485cd9 / mirror.  The four-Encode groups write the
 * projectile's own position cells param_1+0x10/0x99/0x3d5/0x45e (EBX =
 * frame[0x30] = `this`, spilled at 0x485822).
 */
...
void __thiscall SimulateSuperShot_Bullet13(int param_1,int param_2)

{
  ...
  *unaff_FS_OFFSET = &local_c;
  ...
  iVar9 = PeekPacketChecksumState((void *)(local_1574));
  LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  local_4 = 0xffffffff;
  local_15bc = (*(int *)(local_1574 + 0x14));
  ...
  local_4 = 1;
  EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  local_159c = PeekPacketChecksumState((void *)(local_1574));
  LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  local_4 = 0xffffffff;
  local_15bc = (*(int *)(local_1574 + 0x14));
  if ((*(int *)(local_1574 + 0x14)) != 0) {
  ...
  LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
  local_4 = 4;
  local_15bc = (*(int *)(local_112c + 0x14));
  if ((*(int *)(local_112c + 0x14)) != 0) {
    ScrambleChecksumGuardBytes(*(int *)(local_112c + 0x14),&g_valueGuardKeyTable);
    TreeLowerBound(local_15b0,&g_valueGuardMap);
  }
  ...
  if (iVar13 < local_15bc) {
    ...
    if (0 < local_15b0[0]) {
      ...
      do {
        ...
        if ((local_15b1 == '\0') && (iVar11 = FUN_004510f0(local_15c0,(int)(&DAT_006a7f88 + g_clientContext)), iVar11 != 0)) {
          EncodeChecksumDeltaAdd(iVar9,local_f08,param_2);
          local_4 = 6;
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          iVar11 = PeekPacketChecksumState((void *)(local_f08));
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          if (iVar11 < 0x14) {
LAB_00485c3d:
            ...
            bVar3 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
            iVar11 = PeekPacketChecksumState((void *)(local_454));
            LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
            if (iVar11 < 0x14) {
              uVar10 = 0x14;
            }
            ...
            bVar4 = true;
            EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
            iVar11 = PeekPacketChecksumState((void *)(local_1350));
            LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
            if (iVar11 < 0x65) goto LAB_00485c3d;
            uVar10 = 100;
          }
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          EncodeOutgoingPacketField((void *)(local_1598), uVar10);
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          local_4 = 8;
          if ((bVar2) && (bVar2 = false, (*(int *)(local_89c + 0x14)) != 0)) {
            ScrambleChecksumGuardBytes();
            TreeLowerBound(local_1594,&g_valueGuardMap);
          }
          local_4 = 7;
          if ((bVar3) && (bVar3 = false, (*(int *)(local_454 + 0x14)) != 0)) {
            ScrambleChecksumGuardBytes();
            TreeLowerBound(local_1594,&g_valueGuardMap);
          }
          local_4 = 6;
          if ((bVar4) && (bVar4 = false, (*(int *)(local_1350 + 0x14)) != 0)) {
            ScrambleChecksumGuardBytes();
            TreeLowerBound(local_1594,&g_valueGuardMap);
          }
          local_4 = 0xffffffff;
        ...
        if (cVar8 != '\0') {
          iVar11 = FUN_00451030(local_15a4,(int)(&DAT_006a7f88 + g_clientContext));
        ...
        EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
        local_1580[0] = PeekPacketChecksumState((void *)(local_1598));
        LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
        ...
        if (local_15b2 != 0) {
          ...
          local_4 = 0xb;
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          local_1580[0] = PeekPacketChecksumState((void *)(local_ce4));
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          local_1594[0] = PeekPacketChecksumState((void *)(local_ac0));
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          FUN_00436bd0(iVar11 - local_1594[0],local_15b8 - local_1580[0],
                       *(undefined4 *)(iVar9 + 0x1e50));
          local_4 = 10;
          local_1594[0] = (*(int *)(local_ac0 + 0x14));
          ...
          local_4 = 0xffffffff;
          local_1594[0] = (*(int *)(local_ce4 + 0x14));
        ...
        if (iVar11 < 0) {
LAB_0048631a:
          iVar13 = *(int *)(&g_nCameraBoundX + g_clientContext) + -1;
          iVar12 = iVar13;
          if (iVar11 <= iVar13) {
            iVar12 = iVar11;
          }
          ...
          iVar11 = *(int *)(&g_nCameraBoundY + g_clientContext) + -1;
          iVar12 = iVar11;
          if (iVar9 <= iVar11) {
            iVar12 = iVar9;
          }
          ...
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          iVar9 = local_15a8;
          EncodeOutgoingPacketField((void *)(param_1 + 0x10), local_15c0 << 8);
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          EncodeOutgoingPacketField((void *)(param_1 + 0x99), local_15b8 << 8);
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          EncodeOutgoingPacketField((void *)(param_1 + 0x3d5), local_15c0);
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          ...
          *(byte *)(iVar9 + 0xf47) = bVar15 + *(char *)(iVar9 + 0xf45) + -0x34;
          ...
          if (DAT_0079352a != '\0') {
            uVar10 = 0xf004;
LAB_00486469:
            QueueBroadcastEvent(uVar10,(int)&g_replayContext);
            (&g_abBroadcastEventBuffer)[g_dwBroadcastEventCursor] = *(undefined1 *)(iVar9 + 8);
...
LAB_00486e6e:
        ...
        if (((*(int *)(&g_nCameraBoundX + g_clientContext) + -1 < iVar11) || (iVar9 < -0x113)) ||
           (*(int *)(&g_nCameraBoundY + g_clientContext) + -1 < iVar9)) goto LAB_0048631a;
...
LAB_0048661d:
            ...
            if (local_15b0[0] < 0x14) {
              ...
              bVar5 = true;
              EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
              uVar10 = PeekPacketChecksumState((void *)(local_ce4));
              LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
            }
          }
          else {
          ...
          iVar9 = (*(int *)(local_f08 + 0x14));
          local_4 = 0xc;
          if ((bVar7) && (bVar7 = false, (*(int *)(local_f08 + 0x14)) != 0)) {
            ScrambleChecksumGuardBytes();
            local_15b0[0] = iVar9;
            TreeLowerBound(local_1580,&g_valueGuardMap);
          }
          iVar9 = (*(int *)(local_1350 + 0x14));
          local_4 = 0xffffffff;
        ...
        cVar8 = DecodeGuardedBool();
        if (cVar8 != '\0') {
          iVar11 = FUN_00451030(local_15c0,(int)(&DAT_006a7f88 + g_clientContext));
          *(int *)(iVar9 + 0xf48) = iVar11;
          if (iVar11 != 0) {
            *(undefined4 *)(iVar9 + 0xf50) = 0;
            EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
        ...
        cVar8 = PeekPacketChecksumBool();
        if ((cVar8 == '\0') && (iVar11 = FUN_004511b0(local_15c0,(int)(&DAT_006a7f88 + g_clientContext)), iVar11 != 0)) {
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          iVar11 = _rand();
          *pbVar18 = (byte)iVar11;
          iVar11 = _rand();
        ...
        EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
        uVar10 = PeekPacketChecksumState((void *)(local_1598));
        LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
        FUN_00436dc0(local_15c0,local_15a4,uVar10);
        EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
        iVar11 = PeekPacketChecksumState((void *)(local_1598));
        local_15b2 = iVar11 == 0;
        LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
        if (local_15b2 != 0) {
          ...
          local_4 = 0x11;
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          iVar11 = PeekPacketChecksumState((void *)(local_230));
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
          EnterCriticalSection((LPCRITICAL_SECTION)&g_valueGuardLock);
...
LAB_00486cde:
          ...
          iVar9 = *(int *)(&g_nCameraBoundY + g_clientContext) + -1;
          iVar12 = iVar9;
          if (iVar11 <= iVar9) {
            iVar12 = iVar11;
          }
...
LAB_00486e42:
        ...
        if ((((iVar9 < *(int *)(&g_nCameraBoundX + g_clientContext)) && (-1 < iVar11)) &&
            (iVar11 < *(int *)(&g_nCameraBoundY + g_clientContext))) &&
           (*(char *)(iVar11 * *(int *)(&g_nCameraBoundX + g_clientContext) +
        ...
        if (((*(int *)(&g_nCameraBoundX + g_clientContext) + -1 < iVar9) || (iVar11 < -0x113)) ||
           (*(int *)(&g_nCameraBoundY + g_clientContext) + -1 < iVar11)) goto LAB_00486cde;
        local_1588 = local_1588 + param_2;
