/* DestroyShot2_Bullet9 - 0x004654f0 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_00555d14;   install this class's own vtable
...
void DestroyShot2_Bullet9(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00555d14;
