/* InitShot2_Bullet7 - 0x00495c20 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_00495c20).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x5563d0.
 *
...
undefined4 * InitShot2_Bullet7(undefined4 *param_1)
