/* DestroyPrimaryShot_Bullet10 - 0x00481310 in the original binary.
 *
 ...
 *     *this = &PTR_FUN_00556160;   install this class's own vtable
...
void DestroyPrimaryShot_Bullet10(undefined4 *regEax)

{
  *regEax = &PTR_FUN_00556160;
