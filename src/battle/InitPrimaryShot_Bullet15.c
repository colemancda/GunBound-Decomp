/* InitPrimaryShot_Bullet15 - 0x0047b2a0 in the original binary.
 *
 * NAMED 2026-08-19 (was FUN_0047b2a0).  Constructor for one per-weapon PROJECTILE
 * class: it delegates to InitProjectile(this, 0x186a2) - class id 100002,
 * stamped at object +0x4 - and installs vtable 0x556058.
 *
...
undefined4 * InitPrimaryShot_Bullet15(undefined4 *regEsi)

{
  InitProjectile(regEsi,0x186a2);
  *regEsi = &PTR_FUN_00556058;
  return regEsi;
}
