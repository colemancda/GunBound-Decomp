/* RijndaelSetKey - 0x004f48b0 in the original binary.
 *
 * Textbook Rijndael/AES key expansion: Rcon table at 0x54cb00, the
 * Te/SBox tables at 0x54eb78/0x54ef78/0x54f378/0x54f778 (+ inverse
 * tables at 0x550b78..), key length validated 16/24/32 bytes - the
 * key-schedule half of the network crypto (EncodeCipherBlock/
 * DecodeCipherBlock family). NAMED (2026-07-18).
 *
