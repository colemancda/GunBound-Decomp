/* EncodeChecksumDeltaShr - 0x0040b180 in the original binary.
 *
 ...
 * func_addr 0x40b180): first two calls' self is local_21c's address
 * minus 0x14, third call's self is param_2.
 */
#include "ghidra_types.h"


int EncodeChecksumDeltaShr(undefined4 param_1,int param_2,int param_3)
