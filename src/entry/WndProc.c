  ...
  if (param_2 < 0x106) {
    if (param_2 == 0x105) {
      ...
      if (param_2 == 7) {
         ...
         * that window may not exist yet (*(g_sharedTextInputControl+4) NULL/garbage), and
         ...
         * window. */
        if (g_sharedTextInputControl != 0) {
          HWND focusTarget = *(HWND *)(g_sharedTextInputControl + 4);
