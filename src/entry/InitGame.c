  ...
  if (iVar1 == 0) {
    ...
    if (DAT_007934c8 == iVar1) {
      ...
      if (DAT_007934c8 == iVar1) {
        ...
        LoadSpriteSet(&g_spriteRegistry,500,"numfont.img");
        LoadSpriteSet(&g_spriteRegistry,600,"b_scroll_bar.img");
        LoadSpriteSet(&g_spriteRegistry,0x259,"b_scroll_up.img");
        LoadSpriteSet(&g_spriteRegistry,0x25a,"b_scroll_down.img");
        LoadSpriteSet(&g_spriteRegistry,0x262,"b_scroll_bar2.img");
        LoadSpriteSet(&g_spriteRegistry,0x263,"b_scroll_up2.img");
        LoadSpriteSet(&g_spriteRegistry,0x264,"b_scroll_down2.img");
        LoadSpriteSet(&g_spriteRegistry,700,"buddy_back.img");
        LoadSpriteSet(&g_spriteRegistry,0x2bd,"b_buddy_plus.img");
        LoadSpriteSet(&g_spriteRegistry,0x2be,"b_buddy_del.img");
        LoadSpriteSet(&g_spriteRegistry,0x2bf,"b_buddy_exit.img");
        LoadSpriteSet(&g_spriteRegistry,0x2c6,"buddy_window_back.img");
        LoadSpriteSet(&g_spriteRegistry,0x2c7,"b_buddywindow_exittalk.img");
        LoadSpriteSet(&g_spriteRegistry,0x2c8,"b_buddywindow_friendplus.img");
        LoadSpriteSet(&g_spriteRegistry,0x2c9,"b_buddywindow_friendclose.img");
        LoadSpriteSet(&g_spriteRegistry,0x2ca,"b_buddywindow_delyes.img");
        LoadSpriteSet(&g_spriteRegistry,0x2cb,"b_buddywindow_delno.img");
        LoadSpriteSet(&g_spriteRegistry,800,"report_back.img");
        LoadSpriteSet(&g_spriteRegistry,0x321,"b_report_confirm.img");
        LoadSpriteSet(&g_spriteRegistry,0x322,"b_report_exit.img");
        LoadSpriteSet(&g_spriteRegistry,0x323,"b_report_close.img");
        LoadSpriteSet(&g_spriteRegistry,900,"error_back.img");
        LoadSpriteSet(&g_spriteRegistry,0x385,"b_error_confirm.img");
        LoadSpriteSet(&g_spriteRegistry,0x38e,"info.img");
        LoadSpriteSet(&g_spriteRegistry,0x398,"waitmessage.img");
        LoadSpriteSet(&g_spriteRegistry,0,"cursor.img");
        AppendPersistentButtonName(&DAT_0067ec70 + g_clientContext,(char *)"cursor");
        LoadSpriteSet(&g_spriteRegistry,1,"errordialog.img");
        LoadSpriteSet(&g_spriteRegistry,2,"b_error_confirm.img");
        LoadSpriteSet(&g_spriteRegistry,3,"waitmessage.img");
        LoadSpriteSet(&g_spriteRegistry,0x32,"numberfont.img");
        LoadSpriteSet(&g_spriteRegistry,0x33,"buddymode.img");
        LoadSpriteSet(&g_spriteRegistry,0x34,"icon.img");
        LoadSpriteSet(&g_spriteRegistry,100,"rank1.img");
        LoadSpriteSet(&g_spriteRegistry,0x65,"rank2.img");
        LoadSpriteSet(&g_spriteRegistry,0x6e,"info.img");
        LoadSpriteSet(&g_spriteRegistry,200,"b_gamelist_buddyup.img");
        LoadSpriteSet(&g_spriteRegistry,0xc9,"b_gamelist_buddydown.img");
        LoadSpriteSet(&g_spriteRegistry,0xca,"b_gamelist_channelup.img");
        LoadSpriteSet(&g_spriteRegistry,0xcb,"b_gamelist_channeldown.img");
        LoadSpriteSet(&g_spriteRegistry,0xcc,"b_buddy_up.img");
        LoadSpriteSet(&g_spriteRegistry,0xcd,"b_buddy_down.img");
        LoadSpriteSet(&g_spriteRegistry,0xce,"b_buddy_exit.img");
        LoadSpriteSet(&g_spriteRegistry,300,"avataimsi.img");
        LoadSpriteSet(&g_spriteRegistry,400,"presentmode.img");
        LoadSpriteSet(&g_spriteRegistry,1000000,"buddy2.img");
        LoadSpriteSet(&g_spriteRegistry,2000000,"b_buddy2_addfriend1.img");
        LoadSpriteSet(&g_spriteRegistry,0x1e8483,"b_buddy2_close.img");
        LoadSpriteSet(&g_spriteRegistry,0x1e8484,"b_buddy2_yes.img");
        LoadSpriteSet(&g_spriteRegistry,0x1e8485,"b_buddy2_no.img");
        LoadSpriteSet(&g_spriteRegistry,0x1e8486,"b_buddy2_exit.img");
        LoadSpriteSet(&g_spriteRegistry,0x1e8487,"b_buddy2_up.img");
        LoadSpriteSet(&g_spriteRegistry,0x1e8488,"b_buddy2_down.img");
        LoadSpriteSet(&g_spriteRegistry,0x1e8489,"b_buddy2_addfriend2.img");
        LoadSpriteSet(&g_spriteRegistry,0x1e848a,"b_buddy2_deletefriend.img");
        LoadSpriteSet(&g_spriteRegistry,0x1e848b,"b_buddy2_exit2.img");
        LoadSpriteSet(&g_spriteRegistry,1100000,"reportmode.img");
        LoadSpriteSet(&g_spriteRegistry,2100000,"b_report_exit.img");
        LoadSpriteSet(&g_spriteRegistry,0x200b21,"b_report_report.img");
        LoadSpriteSet(&g_spriteRegistry,0x200b22,"b_report_cancel.img");
        LoadSpriteSet(&g_spriteRegistry,0x200b23,"b_report_close.img");
        ...
        WorkerThread_Start(DAT_00e9c334);
