...
public:
    ...
    void Mobile13_MainAction(int animEvent, int subType);  /* 0x46d070 */
    void Mobile15_MainAction(int animEvent, int subType);  /* 0x466fd0 */
    void Mobile14_MainAction(int animEvent, int subType);  /* 0x47ab90 */
    void Mobile11_MainAction(int animEvent, int subType);  /* 0x4aed30 */
    void Mobile10_MainAction(int animEvent, int subType);  /* 0x475e40 */
    ...
    void Mobile03_MainAction(int animEvent, int subType);  /* 0x4b31f0 */
    void Mobile02_MainAction(int animEvent, int subType);  /* 0x48d1f0 */
