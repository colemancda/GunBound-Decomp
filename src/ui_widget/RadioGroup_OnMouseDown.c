/* RadioGroup_OnMouseDown - 0x00505430 in the original binary.
 *
...
char __thiscall RadioGroup_OnMouseDown(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  cVar1 = Widget_OnMouseDown(param_2,param_3);
  if (cVar1 != '\0') {
    uVar3 = 0xffffffff;
    uVar2 = 0;
