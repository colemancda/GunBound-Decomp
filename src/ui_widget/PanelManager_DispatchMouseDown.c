/* PanelManager_DispatchMouseDown - 0x00507ea0 in the original binary.
 *
 * CUIPanelManager WM_LBUTTONDOWN dispatch (via FUN_0050f060 + focus
 * reset). Named 2026-07-18 (WndProc case 0x201).
 *
