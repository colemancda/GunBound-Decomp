/* PanelManager_DispatchMouseUp - 0x0050f1b0 in the original binary.
 *
 * CUIPanelManager WM_LBUTTONUP dispatch: walks the panel list and calls
 * each panel's mouse-up virtual. Named 2026-07-18 (WndProc case 0x202).
 *
