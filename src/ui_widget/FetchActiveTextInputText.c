 ...
 * VALUE (same g_sharedTextInputControl-style pointer CommitActiveTextInput/
 ...
 * `State11_InBattle_HandleMouseInput.c`) load `eax = g_sharedTextInputControl`
 ...
 * 4 sites wired with `g_sharedTextInputControl` and each site's own destination buffer
