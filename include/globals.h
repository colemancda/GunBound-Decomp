...
#define DAT_00e55cf4 (*(uint32_t*)(&g_replayContext+0x14))
#define DAT_00e55d58 (*(uint8_t*)(&g_replayContext+0x78))
#define DAT_00e55e18 (*(uint8_t*)(&g_replayContext+0x138))
#define _DAT_00e55e18 DAT_00e55e18
#define DAT_00e55e1c (*(uint8_t*)(&g_replayContext+0x13c))
#define _DAT_00e55e1c DAT_00e55e1c
#define DAT_00e55e20 (*(uint32_t*)(&g_replayContext+0x140))
#define DAT_00e55e28 (*(uint8_t*)(&g_replayContext+0x148))
#define _DAT_00e55e28 DAT_00e55e28
#define DAT_00e55e3c (*(uint8_t*)(&g_replayContext+0x15c))
#define DAT_00e560a0 (*(uint8_t*)(&g_replayContext+0x3c0))
#define _DAT_00e560a0 DAT_00e560a0
#define DAT_00e560a4 (*(uint8_t*)(&g_replayContext+0x3c4))
#define _DAT_00e560a4 DAT_00e560a4
#define DAT_00e560a8 (*(uint8_t*)(&g_replayContext+0x3c8))
#define _DAT_00e560a8 DAT_00e560a8
#define DAT_00e560ac (*(uint8_t*)(&g_replayContext+0x3cc))
#define _DAT_00e560ac DAT_00e560ac
#define DAT_00e98ab8 (*(uint8_t*)(&g_replayContext+0x42dd8))
#define DAT_00e98abc (*(uint8_t*)(&g_replayContext+0x42ddc))
#define _DAT_00e98abc DAT_00e98abc
#define DAT_00e98ac0 (*(uint32_t*)(&g_replayContext+0x42de0))
#define DAT_00e9aac0 (*(uint8_t*)(&g_replayContext+0x44de0))
#define DAT_00e9aac4 (*(uint8_t*)(&g_replayContext+0x44de4))
#define _DAT_00e9aac4 DAT_00e9aac4
#define DAT_00e9aac8 (*(uint8_t*)(&g_replayContext+0x44de8))
#define _DAT_00e9aac8 DAT_00e9aac8
#define DAT_00e9aacd (*(uint8_t*)(&g_replayContext+0x44ded))
#define DAT_00e9aace (*(uint8_t*)(&g_replayContext+0x44dee))
#define DAT_00e9aad0 (*(uint8_t*)(&g_replayContext+0x44df0))
#define DAT_00e9aad1 (*(uint8_t*)(&g_replayContext+0x44df1))
#define DAT_00e9aad2 (*(uint8_t*)(&g_replayContext+0x44df2))
#define DAT_00e9aad6 (*(uint8_t*)(&g_replayContext+0x44df6))
#define DAT_00e9aada (*(uint8_t*)(&g_replayContext+0x44dfa))
#define DAT_00e9aadc (*(uint8_t*)(&g_replayContext+0x44dfc))
#define DAT_00e9aae0 (*(uint8_t*)(&g_replayContext+0x44e00))
#define DAT_00e9aae4 (*(uint8_t*)(&g_replayContext+0x44e04))
#define DAT_00e9acd0 (*(uint8_t*)(&g_replayContext+0x44ff0))
#define _DAT_00e9acd0 DAT_00e9acd0
#define DAT_00e9af10 (*(uint8_t*)(&g_replayContext+0x45230))
#define DAT_00e9af14 (*(uint32_t*)(&g_replayContext+0x45234))
#define DAT_00e9af18 (*(uint8_t*)(&g_replayContext+0x45238))
...
#define DAT_00e9b1c8 (*(uint8_t*)(&g_replayContext+0x454e8))
#define _DAT_00e9b1c8 DAT_00e9b1c8
#define DAT_00e9b1cc (*(uint8_t*)(&g_replayContext+0x454ec))
#define _DAT_00e9b1cc DAT_00e9b1cc
#define DAT_00e9b1d0 (*(uint8_t*)(&g_replayContext+0x454f0))
#define _DAT_00e9b1d0 DAT_00e9b1d0
#define DAT_00e9b1d4 (*(uint8_t*)(&g_replayContext+0x454f4))
#define _DAT_00e9b1d4 DAT_00e9b1d4
#define DAT_00e9b1d8 (*(uint8_t*)(&g_replayContext+0x454f8))
...
extern const char s_b_store_dry_00555690[];
extern const char s_b_store_event01_005556bc[];
extern const char s_b_store_event02_005556ac[];
extern const char s_b_store_exit_00555778[];
extern const char s_b_store_exitem_00555718[];
extern const char s_b_store_flag_00555728[];
extern const char s_b_store_gift_00555680[];
extern const char s_b_store_glasse_00555738[];
extern const char s_b_store_puton_00555708[];
extern const char s_b_store_sell_0055569c[];
extern const char s_b_store_up_005556f0[];
extern const char s_b_storewindow_confirm_00555a8c[];
extern const char s_b_storewindow_no_0055566c[];
